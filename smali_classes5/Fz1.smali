...
.method public static j(Ljava/nio/ByteBuffer;III)Landroid/graphics/Bitmap;
    .locals 1
    .param p0    # Ljava/nio/ByteBuffer;
        .annotation build Landroidx/annotation/RecentlyNonNull;
        .end annotation
    ...
    invoke-static {p0, v0}, LFz1;->k(Ljava/nio/ByteBuffer;Z)Ljava/nio/ByteBuffer;
    ...
    invoke-static {p0, p1, p2}, LFz1;->m([BII)[B
    ...
    invoke-static {p0, p3, p1, p2}, LFz1;->l(Landroid/graphics/Bitmap;III)Landroid/graphics/Bitmap;
...
.method public static k(Ljava/nio/ByteBuffer;Z)Ljava/nio/ByteBuffer;
    .locals 6
    .param p0    # Ljava/nio/ByteBuffer;
        .annotation build Landroidx/annotation/RecentlyNonNull;
        .end annotation
...
.method public static l(Landroid/graphics/Bitmap;III)Landroid/graphics/Bitmap;
    .locals 7
...
.method public static final n(Landroid/media/Image$Plane;II[BII)V
    .locals 7
...
.method public d(Landroid/media/Image;I)Landroid/graphics/Bitmap;
    ...
    invoke-static {p1, p2, v0, v1}, LFz1;->l(Landroid/graphics/Bitmap;III)Landroid/graphics/Bitmap;
...
.method public e(LgE1;Z)Ljava/nio/ByteBuffer;
    .locals 18
    .param p1    # LgE1;
        .annotation build Landroidx/annotation/RecentlyNonNull;
        .end annotation
    ...
    invoke-virtual/range {p1 .. p1}, LgE1;->e()Ljava/nio/ByteBuffer;
    ...
    invoke-static {v1, v0}, LFz1;->k(Ljava/nio/ByteBuffer;Z)Ljava/nio/ByteBuffer;
    ...
    invoke-virtual {v3, v0, v1, v2}, LFz1;->i([Landroid/media/Image$Plane;II)Ljava/nio/ByteBuffer;
    ...
    invoke-static {v0}, LFz1;->a(Ljava/nio/ByteBuffer;)Ljava/nio/ByteBuffer;
...
.method public f(LgE1;)Landroid/graphics/Bitmap;
    .locals 3
    .param p1    # LgE1;
        .annotation build Landroidx/annotation/RecentlyNonNull;
        .end annotation
    ...
    invoke-static {v0, v1, v2, p1}, LFz1;->j(Ljava/nio/ByteBuffer;III)Landroid/graphics/Bitmap;
    ...
    invoke-virtual {p0, v0, v1, v2}, LFz1;->i([Landroid/media/Image$Plane;II)Ljava/nio/ByteBuffer;
    ...
    invoke-virtual {p0, v0, v1, v2, p1}, LFz1;->h(Ljava/nio/ByteBuffer;III)Landroid/graphics/Bitmap;
    ...
    invoke-static {v0, v1, v2, p1}, LFz1;->l(Landroid/graphics/Bitmap;III)Landroid/graphics/Bitmap;
...
.method public h(Ljava/nio/ByteBuffer;III)Landroid/graphics/Bitmap;
    .locals 0
    .param p1    # Ljava/nio/ByteBuffer;
        .annotation build Landroidx/annotation/RecentlyNonNull;
        .end annotation
    ...
    invoke-virtual {p0, p1}, LFz1;->b(Ljava/nio/ByteBuffer;)[B

    move-result-object p1

    invoke-static {p1, p2, p3}, LFz1;->m([BII)[B
    ...
    invoke-static {p1, p4, p2, p3}, LFz1;->l(Landroid/graphics/Bitmap;III)Landroid/graphics/Bitmap;
...
.method public i([Landroid/media/Image$Plane;II)Ljava/nio/ByteBuffer;
    .locals 12
    ...
    invoke-static/range {v5 .. v10}, LFz1;->n(Landroid/media/Image$Plane;II[BII)V
    ...
    invoke-static/range {v0 .. v5}, LFz1;->n(Landroid/media/Image$Plane;II[BII)V
