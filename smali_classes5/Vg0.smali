...
.method public static constructor <clinit>()V
    ...
    sput-object v0, LVg0;->a:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method public static a(Landroid/content/Context;Lcom/google/firebase/messaging/c;Ljava/lang/String;Landroid/content/pm/PackageManager;)Landroid/app/PendingIntent;
    ...
    invoke-static {p2, p1, p3}, LVg0;->f(Ljava/lang/String;Lcom/google/firebase/messaging/c;Landroid/content/pm/PackageManager;)Landroid/content/Intent;
    ...
    invoke-static {p1}, LVg0;->q(Lcom/google/firebase/messaging/c;)Z
    ...
    :cond_1
    invoke-static {}, LVg0;->g()I

    move-result p1

    const/high16 p3, 0x40000000    # 2.0f

    invoke-static {p3}, LVg0;->l(I)I
...
.method public static b(Landroid/content/Context;Lcom/google/firebase/messaging/c;)Landroid/app/PendingIntent;
    .locals 2
    ...
    invoke-static {p0, p1}, LVg0;->c(Landroid/content/Context;Landroid/content/Intent;)Landroid/app/PendingIntent;
...
.method public static d(Landroid/content/Context;Lcom/google/firebase/messaging/c;)LVg0$a;
    .locals 9
    ...
    invoke-static {v0, v1}, LVg0;->j(Landroid/content/pm/PackageManager;Ljava/lang/String;)Landroid/os/Bundle;
    ...
    invoke-static {p0, v0, v8}, LVg0;->k(Landroid/content/Context;Ljava/lang/String;Landroid/os/Bundle;)Ljava/lang/String;
    ...
    invoke-static/range {v2 .. v8}, LVg0;->e(Landroid/content/Context;Ljava/lang/String;Lcom/google/firebase/messaging/c;Ljava/lang/String;Landroid/content/res/Resources;Landroid/content/pm/PackageManager;Landroid/os/Bundle;)LVg0$a;
...
.method public static e(Landroid/content/Context;Ljava/lang/String;Lcom/google/firebase/messaging/c;Ljava/lang/String;Landroid/content/res/Resources;Landroid/content/pm/PackageManager;Landroid/os/Bundle;)LVg0$a;
    .locals 2

    new-instance v0, LqC2$e;

    invoke-direct {v0, p0, p3}, LqC2$e;-><init>(Landroid/content/Context;Ljava/lang/String;)V

    const-string p3, "gcm.n.title"

    invoke-virtual {p2, p4, p1, p3}, Lcom/google/firebase/messaging/c;->n(Landroid/content/res/Resources;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v0, p3}, LqC2$e;->s(Ljava/lang/CharSequence;)LqC2$e;
    ...
    invoke-virtual {v0, p3}, LqC2$e;->r(Ljava/lang/CharSequence;)LqC2$e;

    new-instance v1, LqC2$c;

    invoke-direct {v1}, LqC2$c;-><init>()V

    invoke-virtual {v1, p3}, LqC2$c;->a(Ljava/lang/CharSequence;)LqC2$c;

    move-result-object p3

    invoke-virtual {v0, p3}, LqC2$e;->I(LqC2$h;)LqC2$e;
    ...
    invoke-static {p5, p4, p1, p3, p6}, LVg0;->m(Landroid/content/pm/PackageManager;Landroid/content/res/Resources;Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)I

    move-result p3

    invoke-virtual {v0, p3}, LqC2$e;->G(I)LqC2$e;

    invoke-static {p1, p2, p4}, LVg0;->n(Ljava/lang/String;Lcom/google/firebase/messaging/c;Landroid/content/res/Resources;)Landroid/net/Uri;

    move-result-object p3

    if-eqz p3, :cond_2

    invoke-virtual {v0, p3}, LqC2$e;->H(Landroid/net/Uri;)LqC2$e;

    :cond_2
    invoke-static {p0, p2, p1, p5}, LVg0;->a(Landroid/content/Context;Lcom/google/firebase/messaging/c;Ljava/lang/String;Landroid/content/pm/PackageManager;)Landroid/app/PendingIntent;

    move-result-object p1

    invoke-virtual {v0, p1}, LqC2$e;->q(Landroid/app/PendingIntent;)LqC2$e;

    invoke-static {p0, p2}, LVg0;->b(Landroid/content/Context;Lcom/google/firebase/messaging/c;)Landroid/app/PendingIntent;

    move-result-object p1

    if-eqz p1, :cond_3

    invoke-virtual {v0, p1}, LqC2$e;->w(Landroid/app/PendingIntent;)LqC2$e;

    :cond_3
    const-string p1, "gcm.n.color"

    invoke-virtual {p2, p1}, Lcom/google/firebase/messaging/c;->p(Ljava/lang/String;)Ljava/lang/String;

    move-result-object p1

    invoke-static {p0, p1, p6}, LVg0;->h(Landroid/content/Context;Ljava/lang/String;Landroid/os/Bundle;)Ljava/lang/Integer;
    ...
    invoke-virtual {v0, p0}, LqC2$e;->p(I)LqC2$e;
    ...
    invoke-virtual {v0, p0}, LqC2$e;->m(Z)LqC2$e;
    ...
    invoke-virtual {v0, p0}, LqC2$e;->A(Z)LqC2$e;
    ...
    invoke-virtual {v0, p0}, LqC2$e;->K(Ljava/lang/CharSequence;)LqC2$e;
    ...
    invoke-virtual {v0, p0}, LqC2$e;->D(I)LqC2$e;
    ...
    invoke-virtual {v0, p0}, LqC2$e;->M(I)LqC2$e;
    ...
    invoke-virtual {v0, p0}, LqC2$e;->B(I)LqC2$e;
    ...
    invoke-virtual {v0, p1}, LqC2$e;->F(Z)LqC2$e;

    invoke-virtual {p0}, Ljava/lang/Long;->longValue()J

    move-result-wide p3

    invoke-virtual {v0, p3, p4}, LqC2$e;->N(J)LqC2$e;
    ...
    invoke-virtual {v0, p0}, LqC2$e;->L([J)LqC2$e;
    ...
    invoke-virtual {v0, p4, p1, p0}, LqC2$e;->z(III)LqC2$e;

    :cond_b
    invoke-static {p2}, LVg0;->i(Lcom/google/firebase/messaging/c;)I

    move-result p0

    invoke-virtual {v0, p0}, LqC2$e;->v(I)LqC2$e;

    new-instance p0, LVg0$a;

    invoke-static {p2}, LVg0;->o(Lcom/google/firebase/messaging/c;)Ljava/lang/String;

    move-result-object p1

    invoke-direct {p0, v0, p1, p3}, LVg0$a;-><init>(LqC2$e;Ljava/lang/String;I)V
...
.method public static g()I
    ...
    sget-object v0, LVg0;->a:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method public static m(Landroid/content/pm/PackageManager;Landroid/content/res/Resources;Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)I
    ...
    invoke-static {p1, v0}, LVg0;->p(Landroid/content/res/Resources;I)Z
    ...
    invoke-static {p1, p3}, LVg0;->p(Landroid/content/res/Resources;I)Z
