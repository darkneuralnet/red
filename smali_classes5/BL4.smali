...
.method private constructor <init>()V
    ...
    iput-object v0, p0, LBL4;->a:Ljava/lang/String;

    iput-object v0, p0, LBL4;->b:Ljava/lang/Boolean;

    iput-object v0, p0, LBL4;->c:Ljava/lang/Boolean;

    new-instance v0, Ljava/util/ArrayDeque;

    invoke-direct {v0}, Ljava/util/ArrayDeque;-><init>()V

    iput-object v0, p0, LBL4;->d:Ljava/util/Queue;

    return-void
.end method

.method public static declared-synchronized b()LBL4;
    .locals 2
    ...
    invoke-direct {v1}, LBL4;-><init>()V

    sput-object v1, LBL4;->e:LBL4;
...
.method public final a(Landroid/content/Context;Landroid/content/Intent;)I
    ...
    invoke-virtual {p0, p1, p2}, LBL4;->f(Landroid/content/Context;Landroid/content/Intent;)Ljava/lang/String;
    ...
    :cond_2
    :try_start_0
    invoke-virtual {p0, p1}, LBL4;->e(Landroid/content/Context;)Z

    move-result v0

    if-eqz v0, :cond_3

    invoke-static {p1, p2}, LqF5;->e(Landroid/content/Context;Landroid/content/Intent;)Landroid/content/ComponentName;
...
.method public c()Landroid/content/Intent;
    ...
    iget-object v0, p0, LBL4;->d:Ljava/util/Queue;
...
.method public d(Landroid/content/Context;)Z
    ...
    iget-object v0, p0, LBL4;->c:Ljava/lang/Boolean;
    ...
    iput-object p1, p0, LBL4;->c:Ljava/lang/Boolean;

    :cond_1
    iget-object p1, p0, LBL4;->b:Ljava/lang/Boolean;
    ...
    :cond_2
    iget-object p1, p0, LBL4;->c:Ljava/lang/Boolean;
...
.method public e(Landroid/content/Context;)Z
    ...
    iget-object v0, p0, LBL4;->b:Ljava/lang/Boolean;
    ...
    iput-object p1, p0, LBL4;->b:Ljava/lang/Boolean;
...
.method public final declared-synchronized f(Landroid/content/Context;Landroid/content/Intent;)Ljava/lang/String;
    ...
    :try_start_0
    iget-object v0, p0, LBL4;->a:Ljava/lang/String;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    :goto_1
    iget-object p1, p0, LBL4;->a:Ljava/lang/String;
    :try_end_1
...
.method public g(Landroid/content/Context;Landroid/content/Intent;)I
    ...
    invoke-virtual {p0, p1, p2}, LBL4;->a(Landroid/content/Context;Landroid/content/Intent;)I
