...
.method public constructor <init>(LUp0;Lp93;)V
    ...
    iput-object p1, p0, Ljl0;->b:LUp0;

    iput-object p2, p0, Ljl0;->c:Lp93;

    return-void
.end method

.method public static synthetic a(Ljl0;Ljava/lang/String;Z)V
    .locals 0

    invoke-virtual {p0, p1, p2}, Ljl0;->f(Ljava/lang/String;Z)V
...
# virtual methods
.method public b()LkZ2;
    .locals 5

    invoke-virtual {p0}, Ljl0;->d()V

    iget-object v0, p0, Ljl0;->b:LUp0;

    const-string v1, "com.paypal.otc.config.file"

    invoke-virtual {v0, v1}, LUp0;->d(Ljava/lang/String;)Ljava/lang/String;
    ...
    :goto_1
    :try_start_0
    invoke-virtual {p0, v0}, Ljl0;->c(Ljava/lang/String;)LkZ2;
    ...
    :catch_0
    :try_start_1
    invoke-virtual {p0, v1}, Ljl0;->c(Ljava/lang/String;)LkZ2;
    ...
    invoke-virtual {p0, v1, v2}, Ljl0;->f(Ljava/lang/String;Z)V
...
.method public final c(Ljava/lang/String;)LkZ2;
    .locals 2
    ...
    invoke-virtual {v0, v1}, Lgl0;->e(Lorg/json/JSONObject;)LkZ2;
...
.method public d()V
    ...
    iput-object v0, p0, Ljl0;->d:Ljava/util/Date;

    iget-object v0, p0, Ljl0;->c:Lp93;

    new-instance v1, Ljl0$a;

    invoke-direct {v1, p0}, Ljl0$a;-><init>(Ljl0;)V

    const-string v2, "https://www.paypalobjects.com/webstatic/otc/otc-config.android.json"

    invoke-virtual {v0, v2, v1}, LOs1;->a(Ljava/lang/String;LWs1;)V
...
.method public final e()Z
    ...
    iget-object v1, p0, Ljl0;->b:LUp0;

    const-string v2, "com.paypal.otc.config.lastUpdated.timestamp"

    const-wide/16 v3, 0x0

    invoke-virtual {v1, v2, v3, v4}, LUp0;->c(Ljava/lang/String;J)J
    ...
    iget-object v2, p0, Ljl0;->d:Ljava/util/Date;
    ...
    :goto_0
    iget-object v2, p0, Ljl0;->b:LUp0;

    const-string v5, "com.paypal.otc.config.isDefault"

    invoke-virtual {v2, v5, v4}, LUp0;->a(Ljava/lang/String;Z)Z
...
.method public final f(Ljava/lang/String;Z)V
    ...
    invoke-virtual {v0, v1, p1}, LUp0;->f(Ljava/lang/String;Ljava/lang/String;)V

    iget-object p1, p0, Ljl0;->b:LUp0;
    ...
    invoke-virtual {p1, v2, v0, v1}, LUp0;->e(Ljava/lang/String;J)V

    iget-object p1, p0, Ljl0;->b:LUp0;

    const-string v0, "com.paypal.otc.config.isDefault"

    invoke-virtual {p1, v0, p2}, LUp0;->g(Ljava/lang/String;Z)V
