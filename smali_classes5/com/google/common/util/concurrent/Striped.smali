...
.field private static final READ_WRITE_LOCK_SUPPLIER:Lk85;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lk85<",
...
.field private static final WEAK_SAFE_READ_WRITE_LOCK_SUPPLIER:Lk85;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lk85<",
            "Ljava/util/concurrent/locks/ReadWriteLock;",
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lcom/google/common/util/concurrent/Striped;->READ_WRITE_LOCK_SUPPLIER:Lk85;
    ...
    sput-object v0, Lcom/google/common/util/concurrent/Striped;->WEAK_SAFE_READ_WRITE_LOCK_SUPPLIER:Lk85;
...
.method public static custom(ILk85;)Lcom/google/common/util/concurrent/Striped;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<",
    ...
    invoke-direct {v0, p0, p1, v1}, Lcom/google/common/util/concurrent/Striped$CompactStriped;-><init>(ILk85;Lcom/google/common/util/concurrent/Striped$1;)V

    return-object v0
.end method

.method private static lazy(ILk85;)Lcom/google/common/util/concurrent/Striped;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<",
    ...
    invoke-direct {v0, p0, p1}, Lcom/google/common/util/concurrent/Striped$SmallLazyStriped;-><init>(ILk85;)V
    ...
    invoke-direct {v0, p0, p1}, Lcom/google/common/util/concurrent/Striped$LargeLazyStriped;-><init>(ILk85;)V
...
.method public static lazyWeakLock(I)Lcom/google/common/util/concurrent/Striped;
    ...
    invoke-static {p0, v0}, Lcom/google/common/util/concurrent/Striped;->lazy(ILk85;)Lcom/google/common/util/concurrent/Striped;
...
.method public static lazyWeakReadWriteLock(I)Lcom/google/common/util/concurrent/Striped;
    ...
    sget-object v0, Lcom/google/common/util/concurrent/Striped;->WEAK_SAFE_READ_WRITE_LOCK_SUPPLIER:Lk85;
...
.method public static lock(I)Lcom/google/common/util/concurrent/Striped;
    ...
    invoke-static {p0, v0}, Lcom/google/common/util/concurrent/Striped;->custom(ILk85;)Lcom/google/common/util/concurrent/Striped;
...
.method public static readWriteLock(I)Lcom/google/common/util/concurrent/Striped;
    ...
    sget-object v0, Lcom/google/common/util/concurrent/Striped;->READ_WRITE_LOCK_SUPPLIER:Lk85;
...
.method public bulkGet(Ljava/lang/Iterable;)Ljava/lang/Iterable;
    ...
    invoke-static {p1, v0}, LwO1;->h(Ljava/lang/Iterable;Ljava/lang/Class;)[Ljava/lang/Object;
