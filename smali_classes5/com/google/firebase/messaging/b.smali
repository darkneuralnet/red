...
.method public static a()Z
    ...
    invoke-virtual {v2}, Lf31;->h()Landroid/content/Context;
...
.method public static b(LZm2$b;Landroid/content/Intent;)LZm2;
    .locals 4
    ...
    invoke-virtual {v0, v1}, LZm2$a;->m(I)LZm2$a;

    invoke-virtual {v0, p0}, LZm2$a;->e(LZm2$b;)LZm2$a;

    invoke-static {p1}, Lcom/google/firebase/messaging/b;->f(Landroid/os/Bundle;)Ljava/lang/String;

    move-result-object p0

    invoke-virtual {v0, p0}, LZm2$a;->f(Ljava/lang/String;)LZm2$a;

    invoke-static {}, Lcom/google/firebase/messaging/b;->m()Ljava/lang/String;

    move-result-object p0

    invoke-virtual {v0, p0}, LZm2$a;->i(Ljava/lang/String;)LZm2$a;

    sget-object p0, LZm2$d;->c:LZm2$d;

    invoke-virtual {v0, p0}, LZm2$a;->k(LZm2$d;)LZm2$a;

    invoke-static {p1}, Lcom/google/firebase/messaging/b;->k(Landroid/os/Bundle;)LZm2$c;

    move-result-object p0

    invoke-virtual {v0, p0}, LZm2$a;->h(LZm2$c;)LZm2$a;
    ...
    invoke-virtual {v0, p0}, LZm2$a;->g(Ljava/lang/String;)LZm2$a;
    ...
    invoke-virtual {v0, p0}, LZm2$a;->l(Ljava/lang/String;)LZm2$a;
    ...
    invoke-virtual {v0, p0}, LZm2$a;->c(Ljava/lang/String;)LZm2$a;
    ...
    invoke-virtual {v0, p0}, LZm2$a;->b(Ljava/lang/String;)LZm2$a;
    ...
    invoke-virtual {v0, p0}, LZm2$a;->d(Ljava/lang/String;)LZm2$a;
    ...
    invoke-virtual {v0, p0, p1}, LZm2$a;->j(J)LZm2$a;
...
.method public static f(Landroid/os/Bundle;)Ljava/lang/String;
    ...
    invoke-static {p0}, Lcom/google/firebase/installations/a;->o(Lf31;)Lcom/google/firebase/installations/a;
...
.method public static k(Landroid/os/Bundle;)LZm2$c;
    .locals 0
    ...
    sget-object p0, LZm2$c;->e:LZm2$c;

    goto :goto_0

    :cond_0
    sget-object p0, LZm2$c;->c:LZm2$c;
...
.method public static v(Landroid/content/Intent;)V
    ...
    sget-object v0, LZm2$b;->c:LZm2$b;

    invoke-static {}, Lcom/google/firebase/messaging/FirebaseMessaging;->j()LQm5;

    move-result-object v1

    invoke-static {v0, p0, v1}, Lcom/google/firebase/messaging/b;->w(LZm2$b;Landroid/content/Intent;LQm5;)V

    :cond_1
    return-void
.end method

.method public static w(LZm2$b;Landroid/content/Intent;LQm5;)V
    .locals 4
    ...
    :cond_0
    invoke-static {p0, p1}, Lcom/google/firebase/messaging/b;->b(LZm2$b;Landroid/content/Intent;)LZm2;
    ...
    sget-object v3, LYm2;->a:LBm5;

    invoke-interface {p2, p1, v1, v2, v3}, LQm5;->a(Ljava/lang/String;Ljava/lang/Class;LCT0;LBm5;)LNm5;

    move-result-object p1

    invoke-static {}, Lan2;->b()Lan2$a;

    move-result-object p2

    invoke-virtual {p2, p0}, Lan2$a;->b(LZm2;)Lan2$a;

    invoke-virtual {p2}, Lan2$a;->a()Lan2;
    ...
    invoke-interface {p1, p0}, LNm5;->a(LTW0;)V
    :try_end_0
...
.method public static x(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    invoke-virtual {p1, v1}, Lf31;->g(Ljava/lang/Class;)Ljava/lang/Object;
    ...
    invoke-interface {p1, v1, p0, v0}, LC8;->a(Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)V
...
.method public static y(Landroid/os/Bundle;)V
    ...
    invoke-virtual {v0, v3}, Lf31;->g(Ljava/lang/Class;)Ljava/lang/Object;
    ...
    invoke-interface {v0, v1, v2, p0}, LC8;->b(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V
    ...
    invoke-interface {v0, v1, p0, v2}, LC8;->a(Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)V
