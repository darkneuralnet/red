...
.field private static final DEFAULT_TRANSFORM:LBm5;
...
# instance fields
.field private final transport:LNm5;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "LNm5<",
            "Lcom/google/firebase/crashlytics/internal/model/CrashlyticsReport;",
...
.field private final transportTransform:LBm5;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "LBm5<",
            "Lcom/google/firebase/crashlytics/internal/model/CrashlyticsReport;",
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lcom/google/firebase/crashlytics/internal/send/DataTransportCrashlyticsReportSender;->DEFAULT_TRANSFORM:LBm5;

    return-void
.end method

.method public constructor <init>(LNm5;LBm5;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lcom/google/firebase/crashlytics/internal/send/DataTransportCrashlyticsReportSender;->transport:LNm5;

    iput-object p2, p0, Lcom/google/firebase/crashlytics/internal/send/DataTransportCrashlyticsReportSender;->transportTransform:LBm5;
...
.method public static create(Landroid/content/Context;)Lcom/google/firebase/crashlytics/internal/send/DataTransportCrashlyticsReportSender;
    ...
    invoke-direct {v0, v1, v2}, LJZ;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v1}, LCT0;->b(Ljava/lang/String;)LCT0;

    move-result-object v1

    sget-object v2, Lcom/google/firebase/crashlytics/internal/send/DataTransportCrashlyticsReportSender;->DEFAULT_TRANSFORM:LBm5;

    const-string v3, "FIREBASE_CRASHLYTICS_REPORT"

    invoke-interface {p0, v3, v0, v1, v2}, LQm5;->a(Ljava/lang/String;Ljava/lang/Class;LCT0;LBm5;)LNm5;

    move-result-object p0

    new-instance v0, Lcom/google/firebase/crashlytics/internal/send/DataTransportCrashlyticsReportSender;

    invoke-direct {v0, p0, v2}, Lcom/google/firebase/crashlytics/internal/send/DataTransportCrashlyticsReportSender;-><init>(LNm5;LBm5;)V
...
.method public sendReport(Lcom/google/firebase/crashlytics/internal/common/CrashlyticsReportWithSessionId;)Lcom/google/android/gms/tasks/Task;
    ...
    iget-object v2, p0, Lcom/google/firebase/crashlytics/internal/send/DataTransportCrashlyticsReportSender;->transport:LNm5;

    invoke-static {v0}, LTW0;->f(Ljava/lang/Object;)LTW0;

    move-result-object v0

    new-instance v3, LUB0;

    invoke-direct {v3, v1, p1}, LUB0;-><init>(Lcom/google/android/gms/tasks/TaskCompletionSource;Lcom/google/firebase/crashlytics/internal/common/CrashlyticsReportWithSessionId;)V

    invoke-interface {v2, v0, v3}, LNm5;->b(LTW0;Lhn5;)V
