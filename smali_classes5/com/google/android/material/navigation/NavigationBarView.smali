...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    sget-object v2, LqF3;->NavigationBarView:[I

    const/4 v0, 0x2

    new-array v5, v0, [I

    sget v7, LqF3;->NavigationBarView_itemTextAppearanceInactive:I

    const/4 v8, 0x0

    aput v7, v5, v8

    sget v9, LqF3;->NavigationBarView_itemTextAppearanceActive:I
    ...
    invoke-direct {p3, v6, p4, v0}, Las2;-><init>(Landroid/content/Context;Ljava/lang/Class;I)V

    iput-object p3, p0, Lcom/google/android/material/navigation/NavigationBarView;->a:Las2;
    ...
    invoke-virtual {p1, p4}, Lcom/google/android/material/navigation/NavigationBarPresenter;->c(Lcom/google/android/material/navigation/NavigationBarMenuView;)V
    ...
    invoke-virtual {p1, v0, p3}, Lcom/google/android/material/navigation/NavigationBarPresenter;->i(Landroid/content/Context;Landroidx/appcompat/view/menu/e;)V

    sget p1, LqF3;->NavigationBarView_itemIconTint:I
    ...
    invoke-virtual {p2, p1}, LEi5;->c(I)Landroid/content/res/ColorStateList;
    ...
    :goto_0
    sget p1, LqF3;->NavigationBarView_itemIconSize:I

    invoke-virtual {p0}, Landroid/widget/FrameLayout;->getResources()Landroid/content/res/Resources;

    move-result-object v0

    sget v1, LDz3;->mtrl_navigation_bar_item_default_icon_size:I

    invoke-virtual {v0, v1}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result v0

    invoke-virtual {p2, p1, v0}, LEi5;->f(II)I

    move-result p1

    invoke-virtual {p0, p1}, Lcom/google/android/material/navigation/NavigationBarView;->setItemIconSize(I)V

    invoke-virtual {p2, v7}, LEi5;->s(I)Z

    move-result p1

    if-eqz p1, :cond_1

    invoke-virtual {p2, v7, v8}, LEi5;->n(II)I
    ...
    :cond_1
    invoke-virtual {p2, v9}, LEi5;->s(I)Z

    move-result p1

    if-eqz p1, :cond_2

    invoke-virtual {p2, v9, v8}, LEi5;->n(II)I
    ...
    :cond_2
    sget p1, LqF3;->NavigationBarView_itemTextColor:I
    ...
    :cond_4
    invoke-virtual {p0, v6}, Lcom/google/android/material/navigation/NavigationBarView;->d(Landroid/content/Context;)Lwg2;
    ...
    :cond_5
    sget p1, LqF3;->NavigationBarView_elevation:I
    ...
    invoke-virtual {p2, p1, v8}, LEi5;->f(II)I
    ...
    :cond_6
    sget p1, LqF3;->NavigationBarView_backgroundTint:I

    invoke-static {v6, p2, p1}, Lug2;->a(Landroid/content/Context;LEi5;I)Landroid/content/res/ColorStateList;
    ...
    sget p1, LqF3;->NavigationBarView_labelVisibilityMode:I

    const/4 v0, -0x1

    invoke-virtual {p2, p1, v0}, LEi5;->l(II)I

    move-result p1

    invoke-virtual {p0, p1}, Lcom/google/android/material/navigation/NavigationBarView;->setLabelVisibilityMode(I)V

    sget p1, LqF3;->NavigationBarView_itemBackground:I

    invoke-virtual {p2, p1, v8}, LEi5;->n(II)I
    ...
    :cond_7
    sget p1, LqF3;->NavigationBarView_itemRippleColor:I
    ...
    :goto_1
    sget p1, LqF3;->NavigationBarView_menu:I
    ...
    invoke-virtual {p0, p1}, Lcom/google/android/material/navigation/NavigationBarView;->l(I)V
...
.method public final c()V
    ...
    invoke-static {p0, v0}, LkD5;->a(Landroid/view/View;LkD5$e;)V

    return-void
.end method

.method public final d(Landroid/content/Context;)Lwg2;
    .locals 3
    ...
    :cond_0
    invoke-virtual {v0, p1}, Lwg2;->L(Landroid/content/Context;)V
...
.method public g()Landroid/view/Menu;
    ...
    iget-object v0, p0, Lcom/google/android/material/navigation/NavigationBarView;->a:Las2;
...
.method public i()Landroidx/appcompat/view/menu/j;
    .locals 1
...
.method public j()Lcom/google/android/material/navigation/NavigationBarPresenter;
    .locals 1
...
.method public k()I
    ...
    invoke-virtual {v0}, Lcom/google/android/material/navigation/NavigationBarMenuView;->l()I
...
.method public l(I)V
    ...
    invoke-virtual {p0}, Lcom/google/android/material/navigation/NavigationBarView;->h()Landroid/view/MenuInflater;

    move-result-object v0

    iget-object v2, p0, Lcom/google/android/material/navigation/NavigationBarView;->a:Las2;
...
.method public setItemRippleColor(Landroid/content/res/ColorStateList;)V
    ...
    invoke-virtual {p1}, Lcom/google/android/material/navigation/NavigationBarMenuView;->h()Landroid/graphics/drawable/Drawable;
    ...
    :cond_2
    invoke-static {p1}, Lcr4;->a(Landroid/content/res/ColorStateList;)Landroid/content/res/ColorStateList;
...
.method public setLabelVisibilityMode(I)V
    ...
    invoke-virtual {v0}, Lcom/google/android/material/navigation/NavigationBarMenuView;->i()I
