...
.method public b()V
    ...
    iget-object v0, p0, Lcom/facebook/login/GetTokenLoginMethodHandler;->c:LQi1;

    if-eqz v0, :cond_0

    invoke-virtual {v0}, Lyj3;->b()V
    ...
    iput-object v1, p0, Lcom/facebook/login/GetTokenLoginMethodHandler;->c:LQi1;
...
.method public n(Lcom/facebook/login/LoginClient$Request;)I
    ...
    invoke-direct {v0, v1, v2}, LQi1;-><init>(Landroid/content/Context;Ljava/lang/String;)V

    iput-object v0, p0, Lcom/facebook/login/GetTokenLoginMethodHandler;->c:LQi1;
    ...
    iget-object p1, p0, Lcom/facebook/login/GetTokenLoginMethodHandler;->c:LQi1;

    invoke-virtual {p1, v0}, Lyj3;->f(Lyj3$b;)V
...
.method public p(Lcom/facebook/login/LoginClient$Request;Landroid/os/Bundle;)V
    ...
    :cond_1
    invoke-virtual {p0, p1, p2}, Lcom/facebook/login/GetTokenLoginMethodHandler;->o(Lcom/facebook/login/LoginClient$Request;Landroid/os/Bundle;)V
    ...
    :cond_5
    invoke-virtual {p1, p2}, Lcom/facebook/login/LoginClient$Request;->p(Ljava/util/Set;)V
...
.method public q(Lcom/facebook/login/LoginClient$Request;Landroid/os/Bundle;)V
    ...
    sget-object v0, LJ1;->e:LJ1;

    invoke-virtual {p1}, Lcom/facebook/login/LoginClient$Request;->a()Ljava/lang/String;

    move-result-object p1

    invoke-static {p2, v0, p1}, Lcom/facebook/login/LoginMethodHandler;->c(Landroid/os/Bundle;LJ1;Ljava/lang/String;)Lcom/facebook/AccessToken;
