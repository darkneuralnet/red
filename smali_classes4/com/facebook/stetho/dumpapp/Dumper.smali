...
.field private final mParser:Lrg0;
...
.method public constructor <init>(Ljava/lang/Iterable;)V
    ...
    invoke-direct {p0, p1, v0}, Lcom/facebook/stetho/dumpapp/Dumper;-><init>(Ljava/lang/Iterable;Lrg0;)V

    return-void
.end method

.method public constructor <init>(Ljava/lang/Iterable;Lrg0;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p2, p0, Lcom/facebook/stetho/dumpapp/Dumper;->mParser:Lrg0;
...
.method private doDump(Ljava/io/InputStream;Ljava/io/PrintStream;Ljava/io/PrintStream;[Ljava/lang/String;)I
    ...
    iget-object v0, p0, Lcom/facebook/stetho/dumpapp/Dumper;->mParser:Lrg0;

    iget-object v1, p0, Lcom/facebook/stetho/dumpapp/Dumper;->mGlobalOptions:Lcom/facebook/stetho/dumpapp/GlobalOptions;

    iget-object v1, v1, Lcom/facebook/stetho/dumpapp/GlobalOptions;->options:LCY2;

    const/4 v2, 0x1

    invoke-interface {v0, v1, p4, v2}, Lrg0;->a(LCY2;[Ljava/lang/String;Z)Lqg0;

    move-result-object p4

    iget-object v0, p0, Lcom/facebook/stetho/dumpapp/Dumper;->mGlobalOptions:Lcom/facebook/stetho/dumpapp/GlobalOptions;

    iget-object v0, v0, Lcom/facebook/stetho/dumpapp/GlobalOptions;->optionHelp:LqY2;

    invoke-virtual {v0}, LqY2;->h()Ljava/lang/String;

    move-result-object v0

    invoke-virtual {p4, v0}, Lqg0;->d(Ljava/lang/String;)Z
    ...
    iget-object v0, v0, Lcom/facebook/stetho/dumpapp/GlobalOptions;->optionListPlugins:LqY2;
    ...
    :cond_1
    invoke-virtual {p4}, Lqg0;->c()Ljava/util/List;
    ...
    invoke-direct {p0, p1, p2, p3, p4}, Lcom/facebook/stetho/dumpapp/Dumper;->dumpPluginOutput(Ljava/io/InputStream;Ljava/io/PrintStream;Ljava/io/PrintStream;Lqg0;)V
...
.method private dumpPluginOutput(Ljava/io/InputStream;Ljava/io/PrintStream;Ljava/io/PrintStream;Lqg0;)V
    .locals 7
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/facebook/stetho/dumpapp/DumpException;
    ...
    iget-object v4, p0, Lcom/facebook/stetho/dumpapp/Dumper;->mParser:Lrg0;
    ...
    invoke-direct/range {v0 .. v5}, Lcom/facebook/stetho/dumpapp/DumperContext;-><init>(Ljava/io/InputStream;Ljava/io/PrintStream;Ljava/io/PrintStream;Lrg0;Ljava/util/List;)V
...
.method private dumpUsage(Ljava/io/PrintStream;)V
    ...
    :try_start_0
    invoke-virtual {v0}, Lir1;->f()I

    move-result v2

    iget-object p1, p0, Lcom/facebook/stetho/dumpapp/Dumper;->mGlobalOptions:Lcom/facebook/stetho/dumpapp/GlobalOptions;

    iget-object v3, p1, Lcom/facebook/stetho/dumpapp/GlobalOptions;->options:LCY2;

    invoke-virtual {v0}, Lir1;->d()I

    move-result v4

    invoke-virtual {v0}, Lir1;->c()I

    move-result v5

    move-object v1, v6

    invoke-virtual/range {v0 .. v5}, Lir1;->g(Ljava/io/PrintWriter;ILCY2;II)V
    :try_end_0
