...
.method public static createNodeInfoFromView(Landroid/view/View;)LX1;
    .locals 1
    ...
    invoke-static {p0, v0}, LyA5;->k0(Landroid/view/View;LX1;)V
...
.method public static getActions(Landroid/view/View;)Ljava/lang/String;
    ...
    invoke-static {p0}, Lcom/facebook/stetho/inspector/elements/android/AccessibilityNodeInfoWrapper;->createNodeInfoFromView(Landroid/view/View;)LX1;
    ...
    invoke-virtual {v2}, LX1$a;->c()Ljava/lang/CharSequence;
...
.method public static getDescription(Landroid/view/View;)Ljava/lang/CharSequence;
    ...
    invoke-static {v5, v6}, LyA5;->k0(Landroid/view/View;LX1;)V

    invoke-static {v6, v5}, Lcom/facebook/stetho/common/android/AccessibilityUtil;->isSpeakingNode(LX1;Landroid/view/View;)Z

    move-result v7

    if-eqz v7, :cond_4

    invoke-static {v6, v5}, Lcom/facebook/stetho/common/android/AccessibilityUtil;->isAccessibilityFocusable(LX1;Landroid/view/View;)Z
...
.method public static getFocusableReasons(Landroid/view/View;)Ljava/lang/String;
    ...
    :try_start_0
    invoke-static {v0}, Lcom/facebook/stetho/common/android/AccessibilityUtil;->hasText(LX1;)Z

    move-result v1

    invoke-virtual {v0}, LX1;->D()Z

    move-result v2

    invoke-static {v0, p0}, Lcom/facebook/stetho/common/android/AccessibilityUtil;->hasNonActionableSpeakingDescendants(LX1;Landroid/view/View;)Z

    move-result v3

    invoke-static {v0}, Lcom/facebook/stetho/common/android/AccessibilityUtil;->isActionableForAccessibility(LX1;)Z
    ...
    :cond_3
    :try_start_4
    invoke-static {v0, p0}, Lcom/facebook/stetho/common/android/AccessibilityUtil;->isTopLevelScrollItem(LX1;Landroid/view/View;)Z
...
.method public static getIgnored(Landroid/view/View;)Z
    ...
    invoke-static {v3}, LyA5;->E(Landroid/view/View;)I
    ...
    :cond_3
    :try_start_1
    invoke-static {v0, p0}, Lcom/facebook/stetho/common/android/AccessibilityUtil;->isAccessibilityFocusable(LX1;Landroid/view/View;)Z
    ...
    :cond_4
    :try_start_2
    invoke-static {v0, p0}, Lcom/facebook/stetho/common/android/AccessibilityUtil;->isSpeakingNode(LX1;Landroid/view/View;)Z
    ...
    :cond_6
    :try_start_3
    invoke-static {v0, p0}, Lcom/facebook/stetho/common/android/AccessibilityUtil;->hasFocusableAncestor(LX1;Landroid/view/View;)Z
...
.method public static getIgnoredReasons(Landroid/view/View;)Ljava/lang/String;
    ...
    invoke-static {v2}, LyA5;->E(Landroid/view/View;)I
