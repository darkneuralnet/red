...
# static fields
.field public static volatile g:LpX7;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, LpX7;->a:Landroid/content/Context;

    new-instance p1, LSL7;

    invoke-direct {p1, p0}, LSL7;-><init>(LpX7;)V

    iput-object p1, p0, LpX7;->d:LSL7;
    ...
    invoke-direct {p1}, LO57;-><init>()V

    iput-object p1, p0, LpX7;->c:LO57;

    return-void
.end method

.method public static b(Landroid/content/Context;)LpX7;
    .locals 2

    invoke-static {p0}, Lcom/google/android/gms/common/internal/Preconditions;->checkNotNull(Ljava/lang/Object;)Ljava/lang/Object;

    sget-object v0, LpX7;->g:LpX7;
    ...
    :try_start_0
    sget-object v1, LpX7;->g:LpX7;

    if-nez v1, :cond_0

    new-instance v1, LpX7;

    invoke-direct {v1, p0}, LpX7;-><init>(Landroid/content/Context;)V

    sput-object v1, LpX7;->g:LpX7;
    ...
    :cond_1
    :goto_0
    sget-object p0, LpX7;->g:LpX7;

    return-object p0
.end method

.method public static bridge synthetic e(LpX7;)Ljava/lang/Thread$UncaughtExceptionHandler;
    .locals 0

    iget-object p0, p0, LpX7;->f:Ljava/lang/Thread$UncaughtExceptionHandler;

    return-object p0
.end method

.method public static bridge synthetic f(LpX7;)Ljava/util/List;
    .locals 0

    iget-object p0, p0, LpX7;->b:Ljava/util/List;
...
.method public final a()Landroid/content/Context;
    ...
    iget-object v0, p0, LpX7;->a:Landroid/content/Context;
...
.method public final c()Lcom/google/android/gms/internal/gtm/zzav;
    ...
    iget-object v0, p0, LpX7;->e:Lcom/google/android/gms/internal/gtm/zzav;
    ...
    iget-object v1, p0, LpX7;->a:Landroid/content/Context;

    invoke-virtual {v1}, Landroid/content/Context;->getPackageManager()Landroid/content/pm/PackageManager;

    move-result-object v1

    iget-object v2, p0, LpX7;->a:Landroid/content/Context;
    ...
    :try_start_1
    iget-object v4, p0, LpX7;->a:Landroid/content/Context;
    ...
    iput-object v0, p0, LpX7;->e:Lcom/google/android/gms/internal/gtm/zzav;
...
.method public final j(Ljava/lang/Thread$UncaughtExceptionHandler;)V
    ...
    iput-object p1, p0, LpX7;->f:Ljava/lang/Thread$UncaughtExceptionHandler;

    return-void
.end method

.method public final k(LPc7;)V
    .locals 2

    invoke-virtual {p1}, LPc7;->l()Z
    ...
    invoke-virtual {v0}, LPc7;->i()V

    iget-object p1, p0, LpX7;->d:LSL7;

    new-instance v1, LgC7;

    invoke-direct {v1, p0, v0}, LgC7;-><init>(LpX7;LPc7;)V
