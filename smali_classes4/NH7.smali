...
.method public constructor <init>(Landroid/content/Context;LvE7;)V
    ...
    invoke-direct {v0, p1}, LwH7;-><init>(LQm5;)V

    invoke-direct {p2, v0}, LUT1;-><init>(LXt3;)V

    iput-object p2, p0, LNH7;->a:LXt3;
    ...
    invoke-direct {v0, p1}, LEH7;-><init>(LQm5;)V

    invoke-direct {p2, v0}, LUT1;-><init>(LXt3;)V

    iput-object p2, p0, LNH7;->b:LXt3;

    return-void
.end method

.method public static b(LvE7;LnG7;)LTW0;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p0}, LvE7;->a()I

    move-result p0

    invoke-virtual {p1}, LnG7;->a()I
    ...
    invoke-virtual {p1, p0, v1}, LnG7;->c(IZ)[B
...
.method public final a(LnG7;)V
    ...
    iget-object v0, p0, LNH7;->c:LvE7;

    invoke-virtual {v0}, LvE7;->a()I

    move-result v0

    if-nez v0, :cond_1

    iget-object v0, p0, LNH7;->a:LXt3;
    ...
    iget-object v1, p0, LNH7;->c:LvE7;

    invoke-static {v1, p1}, LNH7;->b(LvE7;LnG7;)LTW0;
