...
.field public static final b:LxG6;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "LxG6<",
            "Ljava/lang/Boolean;",
...
.field public static final g:LxG6;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "LxG6<",
            "Ljava/lang/Boolean;",
...
.field public static final h:LxG6;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "LxG6<",
            "Ljava/lang/Long;",
...
.field public static final i:LxG6;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "LxG6<",
            "Ljava/lang/Long;",
...
.field public static final j:LxG6;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "LxG6<",
            "Ljava/lang/Boolean;",
...
.field public static final k:LxG6;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "LxG6<",
            "Ljava/lang/Boolean;",
...
.field public static final l:LxG6;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "LxG6<",
            "Ljava/lang/Long;",
...
.field public static final m:LxG6;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "LxG6<",
            "Ljava/lang/Boolean;",
...
.field public static final n:LxG6;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "LxG6<",
            "Ljava/lang/Double;",
...
.method public static constructor <clinit>()V
    ...
    invoke-static {v1}, LbE6;->a(Ljava/lang/String;)Landroid/net/Uri;

    move-result-object v1

    invoke-direct {v0, v1}, LTF6;-><init>(Landroid/net/Uri;)V

    invoke-virtual {v0}, LTF6;->a()LTF6;
    ...
    invoke-virtual {v0, v1, v2, v3}, LTF6;->b(Ljava/lang/String;D)LxG6;

    move-result-object v1

    sput-object v1, Lig7;->a:LxG6;

    const-string v1, "getTokenRefactor__account_data_service_tokenAPI_usable"

    const/4 v4, 0x1

    invoke-virtual {v0, v1, v4}, LTF6;->d(Ljava/lang/String;Z)LxG6;

    move-result-object v1

    sput-object v1, Lig7;->b:LxG6;

    const-string v1, "getTokenRefactor__account_manager_timeout_seconds"

    const-wide/16 v5, 0x14

    invoke-virtual {v0, v1, v5, v6}, LTF6;->c(Ljava/lang/String;J)LxG6;

    move-result-object v1

    sput-object v1, Lig7;->c:LxG6;

    const-string v1, "getTokenRefactor__android_id_shift"

    const-wide/16 v7, 0x0

    invoke-virtual {v0, v1, v7, v8}, LTF6;->c(Ljava/lang/String;J)LxG6;

    move-result-object v1

    sput-object v1, Lig7;->d:LxG6;

    const-string v1, "getTokenRefactor__authenticator_logic_improved"

    const/4 v7, 0x0

    invoke-virtual {v0, v1, v7}, LTF6;->d(Ljava/lang/String;Z)LxG6;

    move-result-object v1

    sput-object v1, Lig7;->e:LxG6;
    ...
    invoke-static {v8}, Lhf7;->j([B)Lhf7;

    move-result-object v8

    sget-object v9, LUf7;->a:LUf7;

    invoke-virtual {v0, v1, v8, v9}, LTF6;->e(Ljava/lang/String;Ljava/lang/Object;LUf7;)LxG6;

    move-result-object v1

    sput-object v1, Lig7;->f:LxG6;
    :try_end_0
...
# virtual methods
.method public final zza()Lhf7;
    .locals 1

    sget-object v0, Lig7;->f:LxG6;

    invoke-virtual {v0}, LxG6;->b()Ljava/lang/Object;
