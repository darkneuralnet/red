...
.method public static constructor <clinit>()V
    ...
    sput-object v0, LUt5;->a:Landroid/graphics/PathMeasure;

    new-instance v0, Landroid/graphics/Path;

    invoke-direct {v0}, Landroid/graphics/Path;-><init>()V

    sput-object v0, LUt5;->b:Landroid/graphics/Path;

    new-instance v0, Landroid/graphics/Path;

    invoke-direct {v0}, Landroid/graphics/Path;-><init>()V

    sput-object v0, LUt5;->c:Landroid/graphics/Path;

    const/4 v0, 0x4

    new-array v0, v0, [F

    sput-object v0, LUt5;->d:[F
...
.method public static a(Landroid/graphics/Path;FFF)V
    ...
    sget-object v1, LUt5;->a:Landroid/graphics/PathMeasure;
    ...
    invoke-static {v3, v2}, LIn2;->f(FF)I

    move-result p2

    int-to-float v3, p2

    invoke-static {p1, v2}, LIn2;->f(FF)I
    ...
    :cond_6
    sget-object p2, LUt5;->b:Landroid/graphics/Path;
    ...
    sget-object v3, LUt5;->c:Landroid/graphics/Path;
    ...
    sget-object p1, LUt5;->c:Landroid/graphics/Path;
...
.method public static b(Landroid/graphics/Path;Lsn5;)V
    .locals 3

    if-eqz p1, :cond_1

    invoke-virtual {p1}, Lsn5;->j()Z
    ...
    invoke-virtual {p1}, Lsn5;->g()Lbw;

    move-result-object p1

    check-cast p1, Lp91;

    invoke-virtual {p1}, Lp91;->n()F
    ...
    invoke-static {p0, v0, v1, p1}, LUt5;->a(Landroid/graphics/Path;FFF)V
