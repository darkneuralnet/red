.class public final Lcom/adyen/checkout/components/model/payments/response/Threeds2Action$Companion$SERIALIZER$1;
...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        "com/adyen/checkout/components/model/payments/response/Threeds2Action$Companion$SERIALIZER$1",
        "Lcom/adyen/checkout/core/model/ModelObject$Serializer;",
        "Lcom/adyen/checkout/components/model/payments/response/Threeds2Action;",
        "deserialize",
        "jsonObject",
...
# virtual methods
.method public deserialize(Lorg/json/JSONObject;)Lcom/adyen/checkout/components/model/payments/response/Threeds2Action;
    .locals 4
    ...
    :try_start_0
    new-instance v0, Lcom/adyen/checkout/components/model/payments/response/Threeds2Action;
    ...
    const-string v3, "authorisationToken"
    ...
    invoke-direct {v0, v1, v2, v3}, Lcom/adyen/checkout/components/model/payments/response/Threeds2Action;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method public bridge synthetic deserialize(Lorg/json/JSONObject;)Lcom/adyen/checkout/core/model/ModelObject;
    ...
    invoke-virtual {p0, p1}, Lcom/adyen/checkout/components/model/payments/response/Threeds2Action$Companion$SERIALIZER$1;->deserialize(Lorg/json/JSONObject;)Lcom/adyen/checkout/components/model/payments/response/Threeds2Action;
...
.method public serialize(Lcom/adyen/checkout/components/model/payments/response/Threeds2Action;)Lorg/json/JSONObject;
    .locals 3
    ...
    invoke-virtual {p1}, Lcom/adyen/checkout/components/model/payments/response/Threeds2Action;->getToken()Ljava/lang/String;
    ...
    invoke-virtual {p1}, Lcom/adyen/checkout/components/model/payments/response/Threeds2Action;->getSubtype()Ljava/lang/String;
    ...
    invoke-virtual {p1}, Lcom/adyen/checkout/components/model/payments/response/Threeds2Action;->getAuthorisationToken()Ljava/lang/String;
...
.method public bridge synthetic serialize(Lcom/adyen/checkout/core/model/ModelObject;)Lorg/json/JSONObject;
    ...
    check-cast p1, Lcom/adyen/checkout/components/model/payments/response/Threeds2Action;

    invoke-virtual {p0, p1}, Lcom/adyen/checkout/components/model/payments/response/Threeds2Action$Companion$SERIALIZER$1;->serialize(Lcom/adyen/checkout/components/model/payments/response/Threeds2Action;)Lorg/json/JSONObject;
