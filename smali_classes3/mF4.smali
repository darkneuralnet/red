...
.method public constructor <init>(Lkotlin/reflect/KClass;)V
    ...
    iput-object p1, p0, LmF4;->a:Lkotlin/reflect/KClass;

    new-instance p1, Ljava/util/HashMap;

    invoke-direct {p1}, Ljava/util/HashMap;-><init>()V

    iput-object p1, p0, LmF4;->b:Ljava/util/HashMap;
...
.method public deserialize(Lcom/fasterxml/jackson/core/JsonParser;Lcom/fasterxml/jackson/databind/DeserializationContext;)Ljava/lang/Object;
    ...
    const-string v2, "node.fieldNames()"
    ...
    iget-object v2, p0, LmF4;->a:Lkotlin/reflect/KClass;

    invoke-interface {v2}, Lkotlin/reflect/KClass;->getSealedSubclasses()Ljava/util/List;
    ...
    iget-object v0, p0, LmF4;->b:Ljava/util/HashMap;
    ...
    invoke-virtual {p2, v5}, Lcom/fasterxml/jackson/databind/DeserializationContext;->constructType(Ljava/lang/Class;)Lcom/fasterxml/jackson/databind/JavaType;
    ...
    invoke-virtual {v6, p1}, Lcom/fasterxml/jackson/databind/DeserializationConfig;->initialize(Lcom/fasterxml/jackson/core/JsonParser;)V

    sget-object v6, Lcom/fasterxml/jackson/databind/deser/BeanDeserializerFactory;->instance:Lcom/fasterxml/jackson/databind/deser/BeanDeserializerFactory;

    invoke-virtual {v2, v5}, Lcom/fasterxml/jackson/databind/DeserializationConfig;->introspect(Lcom/fasterxml/jackson/databind/JavaType;)Lcom/fasterxml/jackson/databind/BeanDescription;
    ...
    instance-of v5, v2, Lcom/fasterxml/jackson/databind/deser/ResolvableDeserializer;

    if-eqz v5, :cond_2

    move-object v5, v2

    check-cast v5, Lcom/fasterxml/jackson/databind/deser/ResolvableDeserializer;
    ...
    :cond_3
    invoke-interface {v5, p2}, Lcom/fasterxml/jackson/databind/deser/ResolvableDeserializer;->resolve(Lcom/fasterxml/jackson/databind/DeserializationContext;)V

    :goto_2
    const-string v5, "instance.buildBeanDeseri\u2026r)?.resolve(ctxt)\n      }"
    ...
    const-string p2, "null cannot be cast to non-null type T of co.bird.android.persistence.common.impl.serialization.SealedClassDeserializer"
    ...
    iget-object v0, p0, LmF4;->a:Lkotlin/reflect/KClass;
