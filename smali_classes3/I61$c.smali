...
.method public a(Lv85;)V
    ...
    const-string v0, "DROP TABLE `fleet_list_vehicle`;"

    invoke-interface {p1, v0}, Lv85;->l1(Ljava/lang/String;)V

    const-string v0, "CREATE TABLE `fleet_list_vehicle` (\n  `vehicle_id` TEXT NOT NULL PRIMARY KEY,\n  `title` TEXT NOT NULL,\n  `icon` TEXT NOT NULL,\n  `icon_background_color` TEXT NOT NULL,\n  `caption` TEXT,\n  `notification` TEXT,\n  `complication` TEXT,\n  `action` TEXT,\n  `list` TEXT NOT NULL,\n  `fleet_id` TEXT NOT NULL\n);"

    invoke-interface {p1, v0}, Lv85;->l1(Ljava/lang/String;)V

    const-string v0, "CREATE INDEX `index_fleet_list_vehicle_fleet_id_list` ON `fleet_list_vehicle`(`fleet_id`, `list`)"
