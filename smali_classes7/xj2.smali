...
# direct methods
.method public constructor <init>(Landroid/content/Context;Lc55;LrG1;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lxj2;->c:Landroid/content/Context;

    iput-object p2, p0, Lxj2;->a:Lc55;

    iput-object p3, p0, Lxj2;->b:LrG1;
...
.method public final a(Landroid/content/Context;)Z
    ...
    invoke-virtual {p0, p1}, Lxj2;->g(Landroid/content/Context;)Z
...
.method public c(I)Lu43;
    ...
    iget-object v0, p0, Lxj2;->c:Landroid/content/Context;

    invoke-virtual {p0, v0}, Lxj2;->a(Landroid/content/Context;)Z
    ...
    invoke-virtual {p0, v0, p1}, Lxj2;->j(Landroid/content/Context;I)Lu43;
    ...
    invoke-direct {p1, v0, v1}, Lu43;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V
...
.method public final d(Ljava/lang/String;ZLjava/util/List;)Landroid/content/Intent;
    ...
    invoke-static {v1, v2}, Lzendesk/belvedere/i;->a(Ljava/lang/String;Ljava/lang/String;)V
...
.method public e(Landroid/content/Context;IILandroid/content/Intent;Ln00;Z)V
    .locals 24
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object v6, v0, Lxj2;->b:LrG1;

    invoke-virtual {v6, v2}, LrG1;->b(I)Lzendesk/belvedere/MediaResult;
    ...
    invoke-virtual {v6}, Lzendesk/belvedere/MediaResult;->i()Landroid/net/Uri;
    ...
    iget-object v13, v0, Lxj2;->a:Lc55;

    invoke-virtual {v6}, Lzendesk/belvedere/MediaResult;->i()Landroid/net/Uri;

    move-result-object v14

    invoke-virtual {v13, v1, v14, v12}, Lc55;->m(Landroid/content/Context;Landroid/net/Uri;I)V
    ...
    invoke-static {v1, v3}, Lc55;->j(Landroid/content/Context;Landroid/net/Uri;)Lzendesk/belvedere/MediaResult;
    ...
    invoke-virtual {v6}, Lzendesk/belvedere/MediaResult;->g()Landroid/net/Uri;

    move-result-object v15

    invoke-virtual {v6}, Lzendesk/belvedere/MediaResult;->f()Ljava/lang/String;
    ...
    invoke-virtual {v1}, Lzendesk/belvedere/MediaResult;->j()J
    ...
    :cond_2
    iget-object v1, v0, Lxj2;->b:LrG1;

    invoke-virtual {v1, v2}, LrG1;->a(I)V
    ...
    invoke-virtual {v0, v3}, Lxj2;->b(Landroid/content/Intent;)Ljava/util/List;
    ...
    iget-object v2, v0, Lxj2;->a:Lc55;

    invoke-static {v1, v2, v4, v3}, LO54;->c(Landroid/content/Context;Lc55;Ln00;Ljava/util/List;)V
    ...
    invoke-virtual {v4, v5}, Ln00;->internalSuccess(Ljava/lang/Object;)V
...
.method public f(ILjava/lang/String;ZLjava/util/List;)Lzendesk/belvedere/MediaIntent;
    ...
    invoke-virtual {p0, v0}, Lxj2;->h(Landroid/content/Context;)Z
    ...
    invoke-virtual {p0, p2, p3, p4}, Lxj2;->d(Ljava/lang/String;ZLjava/util/List;)Landroid/content/Intent;
...
.method public final g(Landroid/content/Context;)Z
    ...
    :goto_1
    invoke-virtual {p0, v0, p1}, Lxj2;->i(Landroid/content/Intent;Landroid/content/Context;)Z
...
.method public final h(Landroid/content/Context;)Z
    ...
    invoke-virtual {p0, v1, v2, v0}, Lxj2;->d(Ljava/lang/String;ZLjava/util/List;)Landroid/content/Intent;
...
.method public final j(Landroid/content/Context;I)Lu43;
    .locals 20
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v2, v1}, Lc55;->e(Landroid/content/Context;)Ljava/io/File;
    ...
    :cond_0
    iget-object v5, v0, Lxj2;->a:Lc55;

    invoke-virtual {v5, v1, v4}, Lc55;->i(Landroid/content/Context;Ljava/io/File;)Landroid/net/Uri;
    ...
    iget-object v3, v0, Lxj2;->a:Lc55;

    invoke-virtual {v3, v1, v15, v6, v7}, Lc55;->l(Landroid/content/Context;Landroid/content/Intent;Landroid/net/Uri;I)V

    const-string v13, "android.permission.CAMERA"

    invoke-static {v1, v13}, Lsf3;->a(Landroid/content/Context;Ljava/lang/String;)Z

    move-result v3

    if-eqz v3, :cond_2

    invoke-static {v1, v13}, Lsf3;->b(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    invoke-direct {v2, v3, v1}, Lu43;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V
