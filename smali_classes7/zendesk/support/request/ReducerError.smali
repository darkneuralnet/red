...
.method public bridge synthetic reduce(Ljava/lang/Object;Lg2;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, Lzendesk/support/request/ReducerError;->reduce(Lzendesk/support/request/StateError;Lg2;)Lzendesk/support/request/StateError;
...
.method public reduce(Lzendesk/support/request/StateError;Lg2;)Lzendesk/support/request/StateError;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v0}, Lzendesk/support/request/ActionFactory$ErrorAction;->getErrorResponse()LPW0;

    move-result-object v0

    invoke-interface {v0}, LPW0;->c()Z

    move-result v1

    if-eqz v1, :cond_0

    invoke-interface {v0}, LPW0;->getStatus()I
    ...
    invoke-virtual {p2}, Lzendesk/support/request/ActionFactory$ErrorAction;->getErrorResponse()LPW0;
