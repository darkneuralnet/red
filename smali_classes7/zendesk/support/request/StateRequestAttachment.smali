...
.method public static convert(Ljava/util/List;Ljava/util/Map;Lzendesk/support/request/StateIdMapper;)Lu43;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :cond_0
    invoke-static {v0, p2, p1}, Lzendesk/support/request/StateRequestAttachment;->convert(Ljava/util/List;Lzendesk/support/request/StateIdMapper;Ljava/util/Map;)Lu43;
...
.method public static convert(Ljava/util/List;Lzendesk/support/request/StateIdMapper;Ljava/util/Map;)Lu43;
    .locals 23
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v5}, Lzendesk/belvedere/MediaResult;->i()Landroid/net/Uri;
    ...
    invoke-static {v5}, LOd0;->i(Ljava/util/Collection;)Z
    ...
    :cond_7
    invoke-static {v2, v0}, Lu43;->a(Ljava/lang/Object;Ljava/lang/Object;)Lu43;
...
.method public static convert(Lzendesk/belvedere/MediaResult;)Lzendesk/support/request/StateRequestAttachment;
    ...
    invoke-virtual {p0}, Lzendesk/belvedere/MediaResult;->f()Ljava/lang/String;

    move-result-object v8

    invoke-virtual {p0}, Lzendesk/belvedere/MediaResult;->h()J

    move-result-wide v9

    invoke-virtual {p0}, Lzendesk/belvedere/MediaResult;->j()J
...
.method private static getMimeTypeForFile(Ljava/io/File;)Ljava/lang/String;
    ...
    invoke-static {p0}, LEn2;->b(Ljava/lang/String;)Ljava/lang/String;
