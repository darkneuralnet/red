...
.method private bindViews()V
    ...
    sget v0, LjC3;->message_composer_input_text:I
    ...
    sget v0, LjC3;->message_composer_attachments_indicator:I
    ...
    sget v0, LjC3;->message_composer_send_btn:I
...
.method private initAnimationsAndAdjustLeftMargin()V
    ...
    sget v1, LrC3;->zs_request_message_composer_animation_duration:I

    invoke-virtual {v0, v1}, Landroid/content/res/Resources;->getInteger(I)I

    move-result v1

    sget v2, LFz3;->zs_request_message_composer_collapsed_height:I

    invoke-virtual {v0, v2}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result v2

    sget v3, LFz3;->zs_request_message_composer_expanded_min_height:I

    invoke-virtual {v0, v3}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result v3

    sget v4, LFz3;->zs_request_message_composer_expanded_side_margin:I

    invoke-virtual {v0, v4}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result v4

    sget v5, LFz3;->zs_request_message_composer_collapsed_side_margin:I

    invoke-virtual {v0, v5}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result v5

    sget v6, LFz3;->zs_request_message_composer_expanded_top_padding:I

    invoke-virtual {v0, v6}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result v6

    sget v7, LFz3;->zs_request_message_composer_collapsed_top_padding:I

    invoke-virtual {v0, v7}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result v7

    sget v8, LFz3;->zs_request_message_composer_expanded_bottom_padding:I
    ...
    new-instance v8, LaX1;

    invoke-direct {v8}, LaX1;-><init>()V
...
.method private isExpanded()Z
    ...
    sget v1, LFz3;->zs_request_message_composer_collapsed_height:I
...
.method private updateAttachmentButtonPosition()V
    ...
    sget v2, LFz3;->zs_request_message_composer_collapsed_side_margin:I
...
.method private updateSendBtn(ZZ)V
    ...
    :cond_0
    sget v1, Lnz3;->zs_request_message_composer_send_btn_color_inactive:I
...
.method private viewInit(Landroid/content/Context;)V
    ...
    sget v0, LTD3;->zs_view_request_message_composer:I
...
.method public init(Lzendesk/belvedere/b;)V
    .locals 0

    iput-object p1, p0, Lzendesk/support/request/ViewMessageComposer;->imageStream:Lzendesk/belvedere/b;
...
.method public onClick(Landroid/view/View;)V
    ...
    iget-object p1, p0, Lzendesk/support/request/ViewMessageComposer;->imageStream:Lzendesk/belvedere/b;

    invoke-virtual {p1}, Lzendesk/belvedere/b;->P7()Lzendesk/belvedere/KeyboardHelper;

    move-result-object p1

    invoke-virtual {p1}, Lzendesk/belvedere/KeyboardHelper;->k()Landroid/widget/EditText;
...
.method public triggerStateUpdate()V
    ...
    iget-object v0, p0, Lzendesk/support/request/ViewMessageComposer;->imageStream:Lzendesk/belvedere/b;
