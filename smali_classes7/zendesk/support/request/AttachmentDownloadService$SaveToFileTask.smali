...
# direct methods
.method private constructor <init>(Lokhttp3/ResponseBody;Lzendesk/belvedere/MediaResult;LnP5;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p3, p0, Lzendesk/support/request/AttachmentDownloadService$SaveToFileTask;->callback:LnP5;

    return-void
.end method

.method public synthetic constructor <init>(Lokhttp3/ResponseBody;Lzendesk/belvedere/MediaResult;LnP5;Lzendesk/support/request/AttachmentDownloadService$1;)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lzendesk/support/request/AttachmentDownloadService$SaveToFileTask;-><init>(Lokhttp3/ResponseBody;Lzendesk/belvedere/MediaResult;LnP5;)V
...
.method public run()V
    ...
    invoke-static {v1}, LDH2;->f(Ljava/io/File;)LaS4;
    ...
    invoke-virtual {v2}, Lokhttp3/ResponseBody;->source()LoV;

    move-result-object v2

    invoke-interface {v1, v2}, LnV;->u2(LO15;)J
    :try_end_1
    ...
    invoke-static {v2, v3, v4}, Lh22;->e(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-direct {v2, v0}, LRW0;-><init>(Ljava/lang/String;)V
    :try_end_2
    ...
    :goto_1
    iget-object v1, p0, Lzendesk/support/request/AttachmentDownloadService$SaveToFileTask;->callback:LnP5;
    ...
    invoke-virtual {v1, v0}, LnP5;->onSuccess(Ljava/lang/Object;)V

    goto :goto_2

    :cond_0
    invoke-virtual {v1, v0}, LnP5;->onError(LPW0;)V
