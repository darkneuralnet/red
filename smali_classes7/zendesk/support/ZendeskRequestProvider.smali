...
.method public static synthetic access$1100(Lzendesk/support/ZendeskRequestProvider;Ljava/lang/String;Lzendesk/support/EndUserComment;LnP5;)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lzendesk/support/ZendeskRequestProvider;->addCommentInternal(Ljava/lang/String;Lzendesk/support/EndUserComment;LnP5;)V
...
.method public static synthetic access$300(Lzendesk/support/ZendeskRequestProvider;Lzendesk/support/CreateRequest;Lzendesk/core/AuthenticationType;Lzendesk/core/Identity;LnP5;)V
    .locals 0

    invoke-direct {p0, p1, p2, p3, p4}, Lzendesk/support/ZendeskRequestProvider;->internalCreateRequest(Lzendesk/support/CreateRequest;Lzendesk/core/AuthenticationType;Lzendesk/core/Identity;LnP5;)V
...
.method public static synthetic access$800(Lzendesk/support/ZendeskRequestProvider;Ljava/lang/String;Lzendesk/core/AuthenticationType;LnP5;)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lzendesk/support/ZendeskRequestProvider;->getAllRequestsInternal(Ljava/lang/String;Lzendesk/core/AuthenticationType;LnP5;)V

    return-void
.end method

.method public static synthetic access$900(LnP5;)V
    .locals 0

    invoke-static {p0}, Lzendesk/support/ZendeskRequestProvider;->answerCallbackOnConversationsDisabled(LnP5;)V

    return-void
.end method

.method private addCommentInternal(Ljava/lang/String;Lzendesk/support/EndUserComment;LnP5;)V
    .locals 2
    ...
    invoke-direct {v1, p0, p3, p1, p3}, Lzendesk/support/ZendeskRequestProvider$7;-><init>(Lzendesk/support/ZendeskRequestProvider;LnP5;Ljava/lang/String;LnP5;)V

    invoke-virtual {v0, p1, p2, v1}, Lzendesk/support/ZendeskRequestService;->addComment(Ljava/lang/String;Lzendesk/support/EndUserComment;LnP5;)V
...
.method private addServerTags(Lzendesk/support/CreateRequest;Lzendesk/support/SupportSdkSettings;)V
    ...
    invoke-static {v0}, LOd0;->b([Ljava/util/List;)Ljava/util/List;

    move-result-object p2

    invoke-static {p2}, LOd0;->i(Ljava/util/Collection;)Z
...
.method private static answerCallbackOnConversationsDisabled(LnP5;)V
    .locals 3
    ...
    invoke-virtual {p0, v0}, LnP5;->onError(LPW0;)V
...
.method private getAllRequestsInternal(Ljava/lang/String;Lzendesk/core/AuthenticationType;LnP5;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p0, p3, p3}, Lzendesk/support/ZendeskRequestProvider$3;-><init>(Lzendesk/support/ZendeskRequestProvider;LnP5;LnP5;)V
    ...
    :cond_1
    invoke-static {v1}, LOd0;->g(Ljava/util/Collection;)Z
    ...
    invoke-static {v1}, LZ55;->f(Ljava/util/List;)Ljava/lang/String;

    move-result-object p3

    invoke-virtual {p2, p3, p1, v2, v0}, Lzendesk/support/ZendeskRequestService;->getAllRequests(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;LnP5;)V
    ...
    invoke-virtual {p2, p1, v2, v0}, Lzendesk/support/ZendeskRequestService;->getAllRequests(Ljava/lang/String;Ljava/lang/String;LnP5;)V
...
.method private internalCreateRequest(Lzendesk/support/CreateRequest;Lzendesk/core/AuthenticationType;Lzendesk/core/Identity;LnP5;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p0, p4, p4}, Lzendesk/support/ZendeskRequestProvider$2;-><init>(Lzendesk/support/ZendeskRequestProvider;LnP5;LnP5;)V
    ...
    invoke-virtual {p3, p2, p1, v0}, Lzendesk/support/ZendeskRequestService;->createRequest(Ljava/lang/String;Lzendesk/support/CreateRequest;LnP5;)V
    ...
    invoke-virtual {p2, p3, p1, v0}, Lzendesk/support/ZendeskRequestService;->createRequest(Ljava/lang/String;Lzendesk/support/CreateRequest;LnP5;)V
...
.method public addComment(Ljava/lang/String;Lzendesk/support/EndUserComment;LnP5;)V
    ...
    invoke-direct/range {v1 .. v6}, Lzendesk/support/ZendeskRequestProvider$8;-><init>(Lzendesk/support/ZendeskRequestProvider;LnP5;Ljava/lang/String;Lzendesk/support/EndUserComment;LnP5;)V

    invoke-interface {v0, v7}, Lzendesk/support/SupportSettingsProvider;->getSettings(LnP5;)V

    return-void
.end method

.method public createRequest(Lzendesk/support/CreateRequest;LnP5;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v1, p0, p2, p1, p2}, Lzendesk/support/ZendeskRequestProvider$1;-><init>(Lzendesk/support/ZendeskRequestProvider;LnP5;Lzendesk/support/CreateRequest;LnP5;)V

    invoke-interface {v0, v1}, Lzendesk/support/SupportSettingsProvider;->getSettings(LnP5;)V

    return-void
.end method

.method public getAllRequests(LnP5;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p0, v0, p1}, Lzendesk/support/ZendeskRequestProvider;->getRequests(Ljava/lang/String;LnP5;)V
...
.method public getComments(Ljava/lang/String;LnP5;)V
    ...
    invoke-direct {v1, p0, p2, p1, p2}, Lzendesk/support/ZendeskRequestProvider$5;-><init>(Lzendesk/support/ZendeskRequestProvider;LnP5;Ljava/lang/String;LnP5;)V
...
.method public getCommentsSince(Ljava/lang/String;Ljava/util/Date;ZLnP5;)V
    ...
    invoke-direct/range {v1 .. v7}, Lzendesk/support/ZendeskRequestProvider$6;-><init>(Lzendesk/support/ZendeskRequestProvider;LnP5;Ljava/lang/String;Ljava/util/Date;ZLnP5;)V

    invoke-interface {v0, v8}, Lzendesk/support/SupportSettingsProvider;->getSettings(LnP5;)V

    return-void
.end method

.method public getRequest(Ljava/lang/String;LnP5;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v1, p0, p2, p1, p2}, Lzendesk/support/ZendeskRequestProvider$9;-><init>(Lzendesk/support/ZendeskRequestProvider;LnP5;Ljava/lang/String;LnP5;)V
...
.method public getRequests(Ljava/lang/String;LnP5;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v1, p0, p2, p1, p2}, Lzendesk/support/ZendeskRequestProvider$4;-><init>(Lzendesk/support/ZendeskRequestProvider;LnP5;Ljava/lang/String;LnP5;)V
...
.method public getTicketFormsById(Ljava/util/List;LnP5;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p2, p1}, LnP5;->onSuccess(Ljava/lang/Object;)V
    ...
    invoke-direct {v1, p0, p2, v0, p2}, Lzendesk/support/ZendeskRequestProvider$10;-><init>(Lzendesk/support/ZendeskRequestProvider;LnP5;Ljava/util/List;LnP5;)V

    invoke-interface {p1, v1}, Lzendesk/support/SupportSettingsProvider;->getSettings(LnP5;)V
...
.method public getUpdatesForDevice(LnP5;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v1, p0, p1}, Lzendesk/support/ZendeskRequestProvider$11;-><init>(Lzendesk/support/ZendeskRequestProvider;LnP5;)V
