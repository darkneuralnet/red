...
.method private getLegacyAccessToken()Lzendesk/core/AccessToken;
    ...
    invoke-direct {v1}, LGQ1;-><init>()V

    invoke-virtual {v1, v0}, LGQ1;->a(Ljava/lang/String;)LkQ1;

    move-result-object v0

    if-eqz v0, :cond_2

    invoke-virtual {v0}, LkQ1;->t()Z
    ...
    invoke-virtual {v0, v3}, LDQ1;->y(Ljava/lang/String;)LkQ1;
    ...
    invoke-static {v3, v4, v0, v1}, Lh22;->k(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;[Ljava/lang/Object;)V
...
.method private readLegacyAnonymousIdentity()Lzendesk/core/AnonymousIdentity;
    ...
    invoke-virtual {v3}, LkQ1;->o()Ljava/lang/String;
