...
.method public static j(Landroid/content/Context;Landroid/net/Uri;)Lzendesk/belvedere/MediaResult;
    .locals 26
...
.method public final b(Landroid/content/Context;Ljava/lang/String;)Ljava/io/File;
    ...
    invoke-virtual {p0, p1}, Lc55;->k(Landroid/content/Context;)Ljava/lang/String;
...
.method public d(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Ljava/io/File;
    ...
    :cond_0
    invoke-virtual {p0, p1, v1}, Lc55;->b(Landroid/content/Context;Ljava/lang/String;)Ljava/io/File;
    ...
    invoke-static {p1, p3}, Lzendesk/belvedere/i;->e(Ljava/lang/String;Ljava/lang/String;)V

    return-object p2

    :cond_1
    invoke-virtual {p0, p1, p3, p2}, Lc55;->a(Ljava/io/File;Ljava/lang/String;Ljava/lang/String;)Ljava/io/File;
...
.method public e(Landroid/content/Context;)Ljava/io/File;
    ...
    invoke-virtual {p0, p1, v0}, Lc55;->b(Landroid/content/Context;Ljava/lang/String;)Ljava/io/File;
    ...
    invoke-virtual {p0, p1, v0, v1}, Lc55;->a(Ljava/io/File;Ljava/lang/String;Ljava/lang/String;)Ljava/io/File;
...
.method public f(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;)Ljava/io/File;
    .locals 8
    ...
    :goto_0
    invoke-virtual {p0, p1, p3}, Lc55;->b(Landroid/content/Context;Ljava/lang/String;)Ljava/io/File;
    ...
    invoke-static {p1, p2}, Lzendesk/belvedere/i;->e(Ljava/lang/String;Ljava/lang/String;)V

    return-object v0

    :cond_1
    invoke-static {p1, p2}, Lc55;->g(Landroid/content/Context;Landroid/net/Uri;)Ljava/lang/String;
    ...
    invoke-static {p1, p2, v2}, Lc55;->c(Landroid/content/Context;Landroid/net/Uri;Z)Ljava/lang/String;

    move-result-object v0

    :cond_2
    invoke-virtual {p0, p3, v1, v0}, Lc55;->a(Ljava/io/File;Ljava/lang/String;Ljava/lang/String;)Ljava/io/File;
...
.method public h(Landroid/content/Context;)Ljava/lang/String;
    ...
    sget v0, LBE3;->belvedere_sdk_fpa_suffix_v2:I
...
.method public i(Landroid/content/Context;Ljava/io/File;)Landroid/net/Uri;
    .locals 4

    const-string v0, "Belvedere"

    invoke-virtual {p0, p1}, Lc55;->h(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-static {v0, p2, p1}, Lzendesk/belvedere/i;->c(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-static {v0, p1}, Lzendesk/belvedere/i;->b(Ljava/lang/String;Ljava/lang/String;)V
...
.method public l(Landroid/content/Context;Landroid/content/Intent;Landroid/net/Uri;I)V
    .locals 2
...
.method public m(Landroid/content/Context;Landroid/net/Uri;I)V
    .locals 0
