...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "source",
        "<init>",
        "(LoV;Ljava/nio/charset/Charset;)V",
        "okhttp"
    }
    k = 0x1
    mv = {
...
# direct methods
.method public constructor <init>(LoV;Ljava/nio/charset/Charset;)V
    .locals 0

    invoke-direct {p0}, Ljava/io/Reader;-><init>()V

    iput-object p1, p0, Lokhttp3/ResponseBody$BomAwareReader;->source:LoV;
...
.method public close()V
    ...
    :cond_0
    iget-object v0, p0, Lokhttp3/ResponseBody$BomAwareReader;->source:LoV;
...
.method public read([CII)I
    ...
    iget-object v1, p0, Lokhttp3/ResponseBody$BomAwareReader;->source:LoV;

    invoke-interface {v1}, LoV;->X2()Ljava/io/InputStream;

    move-result-object v1

    iget-object v2, p0, Lokhttp3/ResponseBody$BomAwareReader;->source:LoV;

    iget-object v3, p0, Lokhttp3/ResponseBody$BomAwareReader;->charset:Ljava/nio/charset/Charset;

    invoke-static {v2, v3}, Lokhttp3/internal/Util;->readBomAsCharset(LoV;Ljava/nio/charset/Charset;)Ljava/nio/charset/Charset;
