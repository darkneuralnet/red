...
.method public constructor <init>(LO15;)V
    ...
    invoke-interface {v0}, LoV;->S1()Ljava/lang/String;
    ...
    invoke-virtual {v2, v0}, Lokhttp3/Cache$Companion;->readInt$okhttp(LoV;)I
    ...
    invoke-direct {p0, v0}, Lokhttp3/Cache$Entry;->readCertificateList(LoV;)Ljava/util/List;
...
.method private final readCertificateList(LoV;)Ljava/util/List;
    .locals 7
    ...
    invoke-virtual {v0, p1}, Lokhttp3/Cache$Companion;->readInt$okhttp(LoV;)I
    ...
    invoke-interface {p1}, LoV;->S1()Ljava/lang/String;
    ...
    sget-object v6, LtZ;->e:LtZ$a;

    invoke-virtual {v6, v4}, LtZ$a;->a(Ljava/lang/String;)LtZ;
    ...
    :cond_1
    invoke-virtual {v5, v4}, LhV;->N(LtZ;)LhV;

    invoke-virtual {v5}, LhV;->X2()Ljava/io/InputStream;
...
.method private final writeCertList(LnV;Ljava/util/List;)V
    .locals 10
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p1, v0, v1}, LnV;->e0(J)LnV;

    move-result-object v0

    const/16 v1, 0xa

    invoke-interface {v0, v1}, LnV;->q0(I)LnV;
    ...
    invoke-static/range {v4 .. v9}, LtZ$a;->f(LtZ$a;[BIIILjava/lang/Object;)LtZ;

    move-result-object v3

    invoke-virtual {v3}, LtZ;->a()Ljava/lang/String;

    move-result-object v3

    invoke-interface {p1, v3}, LnV;->F1(Ljava/lang/String;)LnV;

    move-result-object v3

    invoke-interface {v3, v1}, LnV;->q0(I)LnV;
    :try_end_0
...
.method public final writeTo(Lokhttp3/internal/cache/DiskLruCache$Editor;)V
    ...
    invoke-virtual {p1, v0}, Lokhttp3/internal/cache/DiskLruCache$Editor;->newSink(I)LaS4;
    ...
    invoke-interface {p1, v3, v4}, LnV;->e0(J)LnV;
    ...
    invoke-interface {p1, v5}, LnV;->F1(Ljava/lang/String;)LnV;

    move-result-object v5

    invoke-interface {v5, v4}, LnV;->F1(Ljava/lang/String;)LnV;
    ...
    invoke-interface {v4, v5}, LnV;->F1(Ljava/lang/String;)LnV;

    move-result-object v4

    invoke-interface {v4, v2}, LnV;->q0(I)LnV;
    ...
    invoke-interface {p1, v5, v6}, LnV;->e0(J)LnV;
    ...
    invoke-interface {v3, v5}, LnV;->F1(Ljava/lang/String;)LnV;

    move-result-object v3

    invoke-interface {v3, v2}, LnV;->q0(I)LnV;
    ...
    invoke-interface {v0, v5, v6}, LnV;->e0(J)LnV;
    ...
    invoke-interface {v0, v3, v4}, LnV;->e0(J)LnV;
    ...
    invoke-interface {p1, v2}, LnV;->q0(I)LnV;
    ...
    invoke-direct {p0, p1, v0}, Lokhttp3/Cache$Entry;->writeCertList(LnV;Ljava/util/List;)V
