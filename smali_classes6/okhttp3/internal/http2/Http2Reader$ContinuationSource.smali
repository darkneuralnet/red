...
.method public constructor <init>(LoV;)V
    ...
    iput-object p1, p0, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;->source:LoV;
...
.method private final readContinuationHeader()V
    ...
    iget-object v1, p0, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;->source:LoV;

    invoke-static {v1}, Lokhttp3/internal/Util;->readMedium(LoV;)I
    ...
    iget-object v3, p0, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;->source:LoV;
    ...
    :cond_0
    iget-object v2, p0, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;->source:LoV;

    invoke-interface {v2}, LoV;->readInt()I
...
.method public read(LhV;J)J
    ...
    iget-object v0, p0, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;->source:LoV;

    iget v3, p0, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;->padding:I

    int-to-long v3, v3

    invoke-interface {v0, v3, v4}, LoV;->skip(J)V
    ...
    invoke-interface {v3, p1, p2, p3}, LO15;->read(LhV;J)J
