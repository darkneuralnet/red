...
.method public constructor <init>(Lokhttp3/internal/http2/Http2Connection$Builder;)V
    ...
    invoke-virtual {p1}, Lokhttp3/internal/http2/Http2Connection$Builder;->getSink$okhttp()LnV;

    move-result-object v4

    invoke-direct {v2, v4, v0}, Lokhttp3/internal/http2/Http2Writer;-><init>(LnV;Z)V
    ...
    invoke-virtual {p1}, Lokhttp3/internal/http2/Http2Connection$Builder;->getSource$okhttp()LoV;

    move-result-object v5

    invoke-direct {v4, v5, v0}, Lokhttp3/internal/http2/Http2Reader;-><init>(LoV;Z)V
...
.method public final pushDataLater$okhttp(ILoV;IZ)V
    .locals 11
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-interface {p2, v0, v1}, LoV;->b2(J)V

    invoke-interface {p2, v7, v0, v1}, LO15;->read(LhV;J)J
    ...
    new-instance v10, Lokhttp3/internal/http2/Http2Connection$pushDataLater$$inlined$execute$1;
    ...
    invoke-direct/range {v0 .. v9}, Lokhttp3/internal/http2/Http2Connection$pushDataLater$$inlined$execute$1;-><init>(Ljava/lang/String;ZLjava/lang/String;ZLokhttp3/internal/http2/Http2Connection;ILhV;IZ)V

    const-wide/16 p3, 0x0

    invoke-virtual {p2, v10, p3, p4}, Lokhttp3/internal/concurrent/TaskQueue;->schedule(Lokhttp3/internal/concurrent/Task;J)V
...
.method public final writeData(IZLhV;J)V
    .locals 9
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-virtual {p4, p2, p1, p3, v0}, Lokhttp3/internal/http2/Http2Writer;->data(ZILhV;I)V
    ...
    :goto_2
    invoke-virtual {v3, v5, p1, p3, v4}, Lokhttp3/internal/http2/Http2Writer;->data(ZILhV;I)V
