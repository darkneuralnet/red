...
.method public constructor <init>(LoV;Z)V
    .locals 6

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lokhttp3/internal/http2/Http2Reader;->source:LoV;

    iput-boolean p2, p0, Lokhttp3/internal/http2/Http2Reader;->client:Z

    new-instance v1, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;

    invoke-direct {v1, p1}, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;-><init>(LoV;)V
...
.method private final readData(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    iget-object v1, p0, Lokhttp3/internal/http2/Http2Reader;->source:LoV;
    ...
    iget-object p3, p0, Lokhttp3/internal/http2/Http2Reader;->source:LoV;

    invoke-interface {p1, v0, p4, p3, p2}, Lokhttp3/internal/http2/Http2Reader$Handler;->data(ZILoV;I)V

    iget-object p1, p0, Lokhttp3/internal/http2/Http2Reader;->source:LoV;
...
.method private final readGoAway(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    iget-object p4, p0, Lokhttp3/internal/http2/Http2Reader;->source:LoV;

    invoke-interface {p4}, LoV;->readInt()I

    move-result p4

    iget-object v0, p0, Lokhttp3/internal/http2/Http2Reader;->source:LoV;
    ...
    invoke-interface {v0, v1, v2}, LoV;->j0(J)LtZ;

    move-result-object v0

    :cond_0
    invoke-interface {p1, p4, p3, v0}, Lokhttp3/internal/http2/Http2Reader$Handler;->goAway(ILokhttp3/internal/http2/ErrorCode;LtZ;)V
...
.method private final readPing(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    iget-object p2, p0, Lokhttp3/internal/http2/Http2Reader;->source:LoV;

    invoke-interface {p2}, LoV;->readInt()I
...
.method private final readPriority(Lokhttp3/internal/http2/Http2Reader$Handler;I)V
    ...
    iget-object v3, p0, Lokhttp3/internal/http2/Http2Reader;->source:LoV;
...
.method private final readSettings(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    invoke-interface {v3}, LoV;->readShort()S
    ...
    iget-object v4, p0, Lokhttp3/internal/http2/Http2Reader;->source:LoV;
...
.method public final nextFrame(ZLokhttp3/internal/http2/Http2Reader$Handler;)Z
    ...
    invoke-interface {v0, v1, v2}, LoV;->b2(J)V
    :try_end_0
    .catch Ljava/io/EOFException; {:try_start_0 .. :try_end_0} :catch_0

    iget-object v0, p0, Lokhttp3/internal/http2/Http2Reader;->source:LoV;

    invoke-static {v0}, Lokhttp3/internal/Util;->readMedium(LoV;)I
    ...
    invoke-interface {p1}, LoV;->readByte()B
    ...
    invoke-interface {p1, v0, v1}, LoV;->skip(J)V
...
.method public final readConnectionPreface(Lokhttp3/internal/http2/Http2Reader$Handler;)V
    ...
    sget-object v0, Lokhttp3/internal/http2/Http2;->CONNECTION_PREFACE:LtZ;
    ...
    invoke-interface {p1, v2, v3}, LoV;->j0(J)LtZ;
    ...
    invoke-virtual {p1}, LtZ;->C()Ljava/lang/String;
