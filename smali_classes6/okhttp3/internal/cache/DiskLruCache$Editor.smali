...
.method public final newSink(I)LaS4;
    .locals 4
    ...
    invoke-interface {v2, v1}, Lokhttp3/internal/io/FileSystem;->sink(Ljava/io/File;)LaS4;
    ...
    invoke-direct {v2, v1, v3}, Lokhttp3/internal/cache/FaultHidingSink;-><init>(LaS4;Lkotlin/jvm/functions/Function1;)V
    :try_end_3
...
.method public final newSource(I)LO15;
    .locals 4
    ...
    invoke-interface {v1, p1}, Lokhttp3/internal/io/FileSystem;->source(Ljava/io/File;)LO15;
