...
.method public static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lsw0;-><init>(Ljava/lang/String;)V

    sput-object v0, Ltw0;->a:Ljava/security/Permission;
    ...
    sput-object v0, Ltw0;->b:Ljava/security/Permission;
    ...
    sput-object v0, Ltw0;->c:Ljava/security/Permission;

    new-instance v0, Ljava/lang/ThreadLocal;

    invoke-direct {v0}, Ljava/lang/ThreadLocal;-><init>()V

    sput-object v0, Ltw0;->d:Ljava/lang/ThreadLocal;
    ...
    sput-object v0, Ltw0;->e:Ljava/util/Map;

    new-instance v0, Ljava/lang/Object;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Ltw0;->f:Ljava/lang/Object;
    ...
    invoke-static {v6}, Lor1;->b(Ljava/lang/String;)[B

    move-result-object v6

    const/16 v7, 0x7b

    invoke-direct {v5, v6, v7}, LZy0;-><init>([BI)V

    invoke-direct {v0, v1, v2, v4, v5}, LUy0;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;LZy0;)V
    ...
    invoke-static {v7}, Lor1;->b(Ljava/lang/String;)[B

    move-result-object v7

    const/16 v8, 0x107

    invoke-direct {v6, v7, v8}, LZy0;-><init>([BI)V

    invoke-direct {v1, v2, v4, v5, v6}, LUy0;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;LZy0;)V
    ...
    invoke-static {v8}, Lor1;->b(Ljava/lang/String;)[B

    move-result-object v8

    const/16 v9, 0x5c

    invoke-direct {v7, v8, v9}, LZy0;-><init>([BI)V

    invoke-direct {v2, v4, v5, v6, v7}, LUy0;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;LZy0;)V
    ...
    invoke-direct {v3, v8, v9}, LZy0;-><init>([BI)V

    invoke-direct {v4, v5, v6, v7, v3}, LUy0;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;LZy0;)V

    sget-object v3, Ltw0$a;->e:Ltw0$a;

    const/4 v5, 0x4

    new-array v6, v5, [LUy0;
    ...
    invoke-static {v3, v6}, Ltw0;->e(Ltw0$a;[Ljava/lang/Object;)V

    sget-object v3, Ltw0$a;->d:Ltw0$a;

    new-array v5, v5, [Loy0;

    invoke-static {v0}, Ltw0;->h(LUy0;)Loy0;

    move-result-object v0

    aput-object v0, v5, v7

    invoke-static {v1}, Ltw0;->h(LUy0;)Loy0;

    move-result-object v0

    aput-object v0, v5, v8

    invoke-static {v2}, Ltw0;->h(LUy0;)Loy0;

    move-result-object v0

    aput-object v0, v5, v9

    invoke-static {v4}, Ltw0;->h(LUy0;)Loy0;

    move-result-object v0

    aput-object v0, v5, v10

    invoke-static {v3, v5}, Ltw0;->e(Ltw0$a;[Ljava/lang/Object;)V
...
.method public static b()Ljava/security/SecureRandom;
    ...
    sget-object v0, Ltw0;->f:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    sget-object v1, Ltw0;->g:Ljava/security/SecureRandom;
    ...
    :try_start_1
    sget-object v2, Ltw0;->g:Ljava/security/SecureRandom;

    if-nez v2, :cond_1

    sput-object v1, Ltw0;->g:Ljava/security/SecureRandom;
...
.method public static d(Ltw0$a;I)Ljava/lang/Object;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-static {p0}, Ltw0;->g(Ltw0$a;)[Ljava/lang/Object;
    ...
    :cond_0
    invoke-static {p0}, Ltw0$a;->b(Ltw0$a;)Ljava/lang/Class;
...
.method public static varargs e(Ltw0$a;[Ljava/lang/Object;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-static {p0, p1}, Ltw0;->f(Ltw0$a;[Ljava/lang/Object;)V

    sget-object v0, Ltw0;->e:Ljava/util/Map;

    invoke-static {p0}, Ltw0$a;->a(Ltw0$a;)Ljava/lang/String;
...
.method public static f(Ltw0$a;[Ljava/lang/Object;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    sget-object v0, Ltw0;->d:Ljava/lang/ThreadLocal;
...
.method public static g(Ltw0$a;)[Ljava/lang/Object;
    .locals 2
...
.method public static h(LUy0;)Loy0;
    .locals 9
    ...
    invoke-virtual {p0}, LUy0;->d()LZy0;

    move-result-object v1

    invoke-virtual {v1}, LZy0;->b()[B
    ...
    invoke-virtual {p0}, LZy0;->a()I

    move-result p0

    invoke-direct {v8, v1, p0}, Lxy0;-><init>([BI)V
    ...
    invoke-direct/range {v1 .. v8}, Loy0;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;IILjava/math/BigInteger;Lxy0;)V
