...
.method public engineGeneratePrivate(Ljava/security/spec/KeySpec;)Ljava/security/PrivateKey;
    ...
    invoke-direct {v0, p1}, LDq;-><init>(LQG3;)V
    ...
    invoke-virtual {p0, p1}, LOG3;->generatePrivate(LXq3;)Ljava/security/PrivateKey;
...
.method public engineGeneratePublic(Ljava/security/spec/KeySpec;)Ljava/security/PublicKey;
    ...
    invoke-direct {v0, p1}, LEq;-><init>(LSG3;)V
    ...
    invoke-virtual {p0, p1}, LOG3;->generatePublic(LL65;)Ljava/security/PublicKey;
...
.method public final engineGetKeySpec(Ljava/security/Key;Ljava/lang/Class;)Ljava/security/spec/KeySpec;
    ...
    invoke-direct/range {v0 .. v6}, LQG3;-><init>([[S[S[[S[S[I[LpT1;)V
    ...
    invoke-direct {p2, v0, v1, v2, p1}, LSG3;-><init>(I[[S[[S[S)V
...
.method public generatePrivate(LXq3;)Ljava/security/PrivateKey;
    ...
    invoke-static {p1}, LPG3;->t(Ljava/lang/Object;)LPG3;

    move-result-object p1

    new-instance v7, LDq;

    invoke-virtual {p1}, LPG3;->v()[[S

    move-result-object v1

    invoke-virtual {p1}, LPG3;->r()[S

    move-result-object v2

    invoke-virtual {p1}, LPG3;->w()[[S

    move-result-object v3

    invoke-virtual {p1}, LPG3;->s()[S

    move-result-object v4

    invoke-virtual {p1}, LPG3;->y()[I

    move-result-object v5

    invoke-virtual {p1}, LPG3;->x()[LpT1;
...
.method public generatePublic(LL65;)Ljava/security/PublicKey;
    ...
    invoke-static {p1}, LRG3;->w(Ljava/lang/Object;)LRG3;

    move-result-object p1

    new-instance v0, LEq;

    invoke-virtual {p1}, LRG3;->v()I

    move-result v1

    invoke-virtual {p1}, LRG3;->r()[[S

    move-result-object v2

    invoke-virtual {p1}, LRG3;->t()[[S

    move-result-object v3

    invoke-virtual {p1}, LRG3;->s()[S

    move-result-object p1

    invoke-direct {v0, v1, v2, v3, p1}, LEq;-><init>(I[[S[[S[S)V
