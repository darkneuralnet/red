...
.method public constructor <init>(LtP1;)V
    ...
    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/keystore/util/JKSKeyStoreSpi;->helper:LtP1;

    return-void
.end method

.method private addPassword(LtK0;[C)V
    .locals 3
    ...
    invoke-interface {p1, v2}, LtK0;->update(B)V
    ...
    invoke-static {p2}, Le65;->f(Ljava/lang/String;)[B

    move-result-object p2

    const/16 v1, 0x10

    invoke-interface {p1, p2, v0, v1}, LtK0;->update([BII)V
...
.method private createCertFactory(Ljava/lang/String;)Ljava/security/cert/CertificateFactory;
    ...
    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/keystore/util/JKSKeyStoreSpi;->helper:LtP1;

    if-eqz v0, :cond_0

    :try_start_0
    invoke-interface {v0, p1}, LtP1;->d(Ljava/lang/String;)Ljava/security/cert/CertificateFactory;
...
.method private validateStream(Ljava/io/InputStream;[C)Lorg/bouncycastle/jcajce/provider/keystore/util/JKSKeyStoreSpi$ErasableByteStream;
    ...
    invoke-direct {p0, v0, p2}, Lorg/bouncycastle/jcajce/provider/keystore/util/JKSKeyStoreSpi;->addPassword(LtK0;[C)V
    ...
    invoke-interface {v0, p1, v1, p2}, LtK0;->update([BII)V
    ...
    invoke-interface {v0, v2, v1}, LtK0;->doFinal([BI)I
    ...
    :cond_0
    invoke-static {p1, v1}, LUk;->y([BB)V
