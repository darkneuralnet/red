...
.method public constructor <init>(I)V
    ...
    iput-object v0, p0, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi;->helper:LtP1;
...
.method private decodeCertificate(Ljava/io/DataInputStream;)Ljava/security/cert/Certificate;
    ...
    :try_start_0
    iget-object p1, p0, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi;->helper:LtP1;

    invoke-interface {p1, v0}, LtP1;->d(Ljava/lang/String;)Ljava/security/cert/CertificateFactory;
...
.method private decodeKey(Ljava/io/DataInputStream;)Ljava/security/Key;
    ...
    :try_start_0
    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi;->helper:LtP1;

    invoke-interface {v0, v2}, LtP1;->e(Ljava/lang/String;)Ljavax/crypto/SecretKeyFactory;
    ...
    :cond_7
    invoke-static {v3}, LXq3;->s(Ljava/lang/Object;)LXq3;
...
.method public engineLoad(Ljava/io/InputStream;[C)V
    ...
    invoke-direct {v5}, Lsv4;-><init>()V

    invoke-direct {v4, v5}, Lel1;-><init>(LtK0;)V
    ...
    invoke-direct {v6}, Lsv4;-><init>()V

    invoke-direct {v5, v6}, Ls33;-><init>(LtK0;)V

    invoke-virtual {v5, p2, v2, v3}, LU23;->init([B[BI)V

    if-eq p1, v1, :cond_3

    invoke-virtual {v4}, Lel1;->getMacSize()I
    ...
    :goto_1
    invoke-virtual {v5, p1}, LU23;->generateDerivedMacParameters(I)Lvb0;

    move-result-object p1

    const/4 v1, 0x0

    invoke-static {p2, v1}, LUk;->y([BB)V

    invoke-virtual {v4, p1}, Lel1;->init(Lvb0;)V

    new-instance p1, LK82;

    invoke-direct {p1, v0, v4}, LK82;-><init>(Ljava/io/InputStream;LH82;)V
    ...
    invoke-virtual {v4, p1, v1}, Lel1;->doFinal([BI)I
...
.method public engineStore(Ljava/io/OutputStream;[C)V
    ...
    invoke-direct {v3}, Lsv4;-><init>()V

    invoke-direct {p1, v3}, Lel1;-><init>(LtK0;)V

    new-instance v3, LL82;

    invoke-direct {v3, p1}, LL82;-><init>(LH82;)V
    ...
    invoke-direct {v4, v5}, Ls33;-><init>(LtK0;)V

    invoke-static {p2}, LU23;->PKCS12PasswordToBytes([C)[B

    move-result-object p2

    invoke-virtual {v4, p2, v1, v2}, LU23;->init([B[BI)V
    ...
    invoke-virtual {p1}, Lel1;->getMacSize()I
    ...
    :goto_0
    invoke-virtual {v4, v1}, LU23;->generateDerivedMacParameters(I)Lvb0;

    move-result-object v1

    invoke-virtual {p1, v1}, Lel1;->init(Lvb0;)V
    ...
    invoke-direct {p2, v0, v3}, LHd5;-><init>(Ljava/io/OutputStream;Ljava/io/OutputStream;)V
    ...
    invoke-virtual {p1, p2, v1}, Lel1;->doFinal([BI)I
...
.method public makePBECipher(Ljava/lang/String;I[C[BI)Ljavax/crypto/Cipher;
    ...
    iget-object p3, p0, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi;->helper:LtP1;

    invoke-interface {p3, p1}, LtP1;->e(Ljava/lang/String;)Ljavax/crypto/SecretKeyFactory;
    ...
    iget-object p4, p0, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi;->helper:LtP1;

    invoke-interface {p4, p1}, LtP1;->a(Ljava/lang/String;)Ljavax/crypto/Cipher;
