...
.method public constructor <init>(Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi;Ljava/lang/String;Ljava/security/Key;[C[Ljava/security/cert/Certificate;)V
    ...
    new-instance p4, Lub0;

    invoke-direct {p4, v6, p2}, Lub0;-><init>(Ljava/io/OutputStream;Ljavax/crypto/Cipher;)V
...
.method public getObject([C)Ljava/lang/Object;
    ...
    invoke-direct {v3, v2, v1}, Lsb0;-><init>(Ljava/io/InputStream;Ljavax/crypto/Cipher;)V
    :try_end_0
    ...
    invoke-direct {v4, v2, v3}, Lsb0;-><init>(Ljava/io/InputStream;Ljavax/crypto/Cipher;)V
    :try_end_2
    ...
    invoke-direct {v3, v9, p1}, Lub0;-><init>(Ljava/io/OutputStream;Ljavax/crypto/Cipher;)V
