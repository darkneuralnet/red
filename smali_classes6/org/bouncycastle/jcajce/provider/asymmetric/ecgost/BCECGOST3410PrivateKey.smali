...
.method public constructor <init>(LXq3;)V
    ...
    invoke-direct {p0, p1}, Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost/BCECGOST3410PrivateKey;->populateFromPrivKeyInfo(LXq3;)V
...
.method public constructor <init>(Ljava/lang/String;LzQ0;Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost/BCECGOST3410PublicKey;Ljava/security/spec/ECParameterSpec;)V
    .locals 2
    ...
    invoke-virtual {p3}, Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost/BCECGOST3410PublicKey;->getGostParams()LS;

    move-result-object p1

    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost/BCECGOST3410PrivateKey;->gostParams:LS;

    invoke-direct {p0, p3}, Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost/BCECGOST3410PrivateKey;->getPublicKeyDetails(Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost/BCECGOST3410PublicKey;)Lwx0;

    move-result-object p1

    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost/BCECGOST3410PrivateKey;->publicKey:Lwx0;

    return-void
.end method

.method public constructor <init>(Ljava/lang/String;LzQ0;Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost/BCECGOST3410PublicKey;LtQ0;)V
    .locals 2
...
.method public constructor <init>(Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost/BCECGOST3410PrivateKey;)V
    ...
    iget-object v0, p1, Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost/BCECGOST3410PrivateKey;->publicKey:Lwx0;

    iput-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost/BCECGOST3410PrivateKey;->publicKey:Lwx0;

    iget-object p1, p1, Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost/BCECGOST3410PrivateKey;->gostParams:LS;
...
.method private getPublicKeyDetails(Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost/BCECGOST3410PublicKey;)Lwx0;
    .locals 0
...
.method private populateFromPrivKeyInfo(LXq3;)V
    ...
    iput-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost/BCECGOST3410PrivateKey;->gostParams:LS;
    ...
    invoke-static {v1}, LYP0;->a(Ljava/lang/String;)LpQ0;
...
.method public equals(Ljava/lang/Object;)Z
    ...
    invoke-virtual {p0}, Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost/BCECGOST3410PrivateKey;->engineGetSpec()LtQ0;

    move-result-object v0

    invoke-virtual {p1}, Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost/BCECGOST3410PrivateKey;->engineGetSpec()LtQ0;
...
.method public getEncoded()[B
    ...
    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost/BCECGOST3410PrivateKey;->gostParams:LS;
    ...
    sget-object v5, Lqw0;->m:Lb0;

    iget-object v6, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost/BCECGOST3410PrivateKey;->gostParams:LS;

    invoke-direct {v4, v5, v6}, Ln8;-><init>(Lb0;LS;)V

    new-instance v5, LFx0;

    invoke-direct {v5, v0}, LFx0;-><init>([B)V

    invoke-direct {v3, v4, v5}, LXq3;-><init>(Ln8;LS;)V

    invoke-virtual {v3, v1}, La0;->o(Ljava/lang/String;)[B
    ...
    invoke-virtual {v3}, LqQ0;->c()Ljava/lang/String;

    move-result-object v3

    invoke-direct {v0, v3}, Lb0;-><init>(Ljava/lang/String;)V

    :cond_1
    new-instance v3, LjO5;

    invoke-direct {v3, v0}, LjO5;-><init>(Lb0;)V
    ...
    invoke-direct {v3, v0}, LjO5;-><init>(LZ;)V
    ...
    invoke-static {v4, v3}, Lorg/bouncycastle/jcajce/provider/asymmetric/util/EC5Util;->convertPoint(LKP0;Ljava/security/spec/ECPoint;)LvQ0;

    move-result-object v3

    iget-boolean v6, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost/BCECGOST3410PrivateKey;->withCompression:Z

    invoke-direct {v5, v3, v6}, LnO5;-><init>(LvQ0;Z)V
    ...
    invoke-direct {v3, v0}, LjO5;-><init>(LlO5;)V
    ...
    :goto_1
    iget-object v4, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost/BCECGOST3410PrivateKey;->publicKey:Lwx0;
    ...
    iget-object v6, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost/BCECGOST3410PrivateKey;->publicKey:Lwx0;

    invoke-direct {v4, v0, v5, v6, v3}, LyQ0;-><init>(ILjava/math/BigInteger;Lwx0;LS;)V
    ...
    invoke-direct {v4, v0, v5, v3}, LyQ0;-><init>(ILjava/math/BigInteger;LS;)V
    ...
    sget-object v6, Lqw0;->m:Lb0;

    invoke-virtual {v3}, LjO5;->g()Lf0;

    move-result-object v3

    invoke-direct {v5, v6, v3}, Ln8;-><init>(Lb0;LS;)V

    invoke-virtual {v4}, LyQ0;->g()Lf0;

    move-result-object v3

    invoke-direct {v0, v5, v3}, LXq3;-><init>(Ln8;LS;)V
