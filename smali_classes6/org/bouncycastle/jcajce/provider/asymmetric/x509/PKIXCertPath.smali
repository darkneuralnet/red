...
.method public constructor <init>(Ljava/io/InputStream;Ljava/lang/String;)V
    ...
    iput-object v1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/PKIXCertPath;->helper:LtP1;
    ...
    invoke-virtual {p2}, LX;->k()Lf0;

    move-result-object p1

    instance-of p2, p1, Lh0;
    ...
    invoke-interface {v1, v0}, LtP1;->d(Ljava/lang/String;)Ljava/security/cert/CertificateFactory;
...
.method public constructor <init>(Ljava/util/List;)V
    ...
    iput-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/PKIXCertPath;->helper:LtP1;
...
.method private toASN1Object(Ljava/security/cert/X509Certificate;)Lf0;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
...
.method private toDEREncoded(LS;)[B
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/cert/CertificateEncodingException;
...
.method public getEncoded(Ljava/lang/String;)[B
    ...
    invoke-direct {p0, v1}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/PKIXCertPath;->toASN1Object(Ljava/security/cert/X509Certificate;)Lf0;
    ...
    invoke-direct {v0, p1}, LJx0;-><init>(LT;)V

    invoke-direct {p0, v0}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/PKIXCertPath;->toDEREncoded(LS;)[B
    ...
    invoke-direct {v5, p1, v0}, Lwp0;-><init>(Lb0;LS;)V
    ...
    invoke-direct {p0, v0}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/PKIXCertPath;->toASN1Object(Ljava/security/cert/X509Certificate;)Lf0;

    move-result-object v0

    invoke-virtual {p1, v0}, LT;->a(LS;)V
    ...
    invoke-direct {v3, v1, v2}, LY;-><init>(J)V

    new-instance v4, LKx0;

    invoke-direct {v4}, LKx0;-><init>()V

    new-instance v6, LKx0;

    invoke-direct {v6, p1}, LKx0;-><init>(LT;)V

    const/4 v7, 0x0

    new-instance v8, LKx0;

    invoke-direct {v8}, LKx0;-><init>()V

    move-object v2, v0

    invoke-direct/range {v2 .. v8}, LtQ4;-><init>(LY;Lj0;Lwp0;Lj0;Lj0;Lj0;)V

    new-instance p1, Lwp0;

    sget-object v1, Ly33;->K0:Lb0;

    invoke-direct {p1, v1, v0}, Lwp0;-><init>(Lb0;LS;)V

    invoke-direct {p0, p1}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/PKIXCertPath;->toDEREncoded(LS;)[B
    ...
    invoke-direct {v0, v2}, Lpe3;-><init>(Ljava/io/Writer;)V
    ...
    invoke-direct {v2, v3, v4}, Lne3;-><init>(Ljava/lang/String;[B)V

    invoke-virtual {v0, v2}, Lpe3;->b(Loe3;)V
