...
# instance fields
.field private c:LEa5$b;

.field private certificateIssuer:LGN5;
...
# direct methods
.method public constructor <init>(LEa5$b;)V
    .locals 0

    invoke-direct {p0}, Ljava/security/cert/X509CRLEntry;-><init>()V

    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CRLEntryObject;->c:LEa5$b;

    const/4 p1, 0x0

    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CRLEntryObject;->certificateIssuer:LGN5;

    return-void
.end method

.method public constructor <init>(LEa5$b;ZLGN5;)V
    .locals 0
    ...
    invoke-direct {p0, p2, p3}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CRLEntryObject;->loadCertificateIssuer(ZLGN5;)LGN5;
...
.method private getExtension(Lb0;)LIY0;
    .locals 1

    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CRLEntryObject;->c:LEa5$b;

    invoke-virtual {v0}, LEa5$b;->r()LLY0;

    move-result-object v0

    if-eqz v0, :cond_0

    invoke-virtual {v0, p1}, LLY0;->r(Lb0;)LIY0;
...
.method private loadCertificateIssuer(ZLGN5;)LGN5;
    .locals 3
    ...
    :cond_0
    sget-object p1, LIY0;->q:Lb0;

    invoke-direct {p0, p1}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CRLEntryObject;->getExtension(Lb0;)LIY0;
    ...
    :cond_1
    :try_start_0
    invoke-virtual {p1}, LIY0;->w()LS;

    move-result-object p1

    invoke-static {p1}, Lni1;->t(Ljava/lang/Object;)Lni1;
...
.method public equals(Ljava/lang/Object;)Z
    ...
    iget-object p1, p1, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CRLEntryObject;->c:LEa5$b;
...
.method public getCertificateIssuer()Ljavax/security/auth/x500/X500Principal;
    ...
    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CRLEntryObject;->certificateIssuer:LGN5;
    ...
    iget-object v2, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CRLEntryObject;->certificateIssuer:LGN5;
...
.method public getExtensionValue(Ljava/lang/String;)[B
    ...
    invoke-direct {p0, v0}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CRLEntryObject;->getExtension(Lb0;)LIY0;
...
.method public getRevocationDate()Ljava/util/Date;
    ...
    invoke-virtual {v0}, LEa5$b;->t()LRh5;
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v3, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CRLEntryObject;->c:LEa5$b;
    ...
    invoke-static {v6}, LU;->D(Ljava/lang/Object;)LU;

    move-result-object v6

    invoke-static {v6}, LRZ;->r(Ljava/lang/Object;)LRZ;
    ...
    invoke-static {v6}, Lni1;->t(Ljava/lang/Object;)Lni1;
