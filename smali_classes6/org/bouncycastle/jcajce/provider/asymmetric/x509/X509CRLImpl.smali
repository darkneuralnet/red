...
# direct methods
.method public constructor <init>(LtP1;Lm70;Ljava/lang/String;[BZ)V
    .locals 0

    invoke-direct {p0}, Ljava/security/cert/X509CRL;-><init>()V

    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CRLImpl;->bcHelper:LtP1;

    iput-object p2, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CRLImpl;->c:Lm70;
...
.method private checkSignature(Ljava/security/PublicKey;Ljava/security/Signature;LS;[B)V
    ...
    iget-object p3, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CRLImpl;->c:Lm70;

    invoke-virtual {p3}, Lm70;->y()LEa5;
...
.method private doVerify(Ljava/security/PublicKey;Lorg/bouncycastle/jcajce/provider/asymmetric/x509/SignatureCreator;)V
    ...
    invoke-static {v0}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509SignatureUtil;->isCompositeAlgorithm(Ln8;)Z
    ...
    invoke-direct {p0, v9, v8, v7, v10}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CRLImpl;->checkSignature(Ljava/security/PublicKey;Ljava/security/Signature;LS;[B)V
    :try_end_0
    ...
    invoke-direct {p0, p1, v8, v7, v9}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CRLImpl;->checkSignature(Ljava/security/PublicKey;Ljava/security/Signature;LS;[B)V
    :try_end_1
    ...
    invoke-direct {p0, p1, p2, v2, v0}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CRLImpl;->checkSignature(Ljava/security/PublicKey;Ljava/security/Signature;LS;[B)V
    ...
    invoke-direct {p0, p1, p2, v0, v1}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CRLImpl;->checkSignature(Ljava/security/PublicKey;Ljava/security/Signature;LS;[B)V
    :try_end_2
...
.method private getExtensionOIDs(Z)Ljava/util/Set;
    ...
    invoke-virtual {v0}, Lm70;->y()LEa5;

    move-result-object v0

    invoke-virtual {v0}, LEa5;->r()LLY0;
...
.method public static getExtensionOctets(Lm70;Ljava/lang/String;)[B
    .locals 0

    invoke-static {p0, p1}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CRLImpl;->getExtensionValue(Lm70;Ljava/lang/String;)Lc0;
...
.method public static getExtensionValue(Lm70;Ljava/lang/String;)Lc0;
    .locals 1

    invoke-virtual {p0}, Lm70;->y()LEa5;

    move-result-object p0

    invoke-virtual {p0}, LEa5;->r()LLY0;
...
.method private loadCRLEntries()Ljava/util/Set;
    ...
    invoke-virtual {v1}, Lm70;->v()Ljava/util/Enumeration;
    ...
    invoke-direct {v4, v3, v5, v2}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CRLEntryObject;-><init>(LEa5$b;ZLGN5;)V
    ...
    invoke-virtual {v3}, LEa5$b;->w()Z

    move-result v4

    if-eqz v4, :cond_0

    invoke-virtual {v3}, LEa5$b;->r()LLY0;

    move-result-object v3

    sget-object v4, LIY0;->q:Lb0;

    invoke-virtual {v3, v4}, LLY0;->r(Lb0;)LIY0;

    move-result-object v3

    if-eqz v3, :cond_0

    invoke-virtual {v3}, LIY0;->w()LS;
    ...
    invoke-static {v2}, LGN5;->t(Ljava/lang/Object;)LGN5;
...
.method public getExtensionValue(Ljava/lang/String;)[B
    ...
    invoke-static {v0, p1}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CRLImpl;->getExtensionValue(Lm70;Ljava/lang/String;)Lc0;
...
.method public getIssuerDN()Ljava/security/Principal;
    ...
    invoke-virtual {v1}, Lm70;->s()LGN5;

    move-result-object v1

    invoke-virtual {v1}, LGN5;->g()Lf0;
...
.method public getRevokedCertificate(Ljava/math/BigInteger;)Ljava/security/cert/X509CRLEntry;
    ...
    invoke-virtual {v0}, Lm70;->v()Ljava/util/Enumeration;
    ...
    invoke-virtual {v3}, LEa5$b;->v()LY;

    move-result-object v4

    invoke-virtual {v4, p1}, LY;->H(Ljava/math/BigInteger;)Z
    ...
    invoke-direct {p1, v3, v0, v2}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CRLEntryObject;-><init>(LEa5$b;ZLGN5;)V
...
.method public isRevoked(Ljava/security/cert/Certificate;)Z
    ...
    invoke-static {v5}, LEa5$b;->s(Ljava/lang/Object;)LEa5$b;
    ...
    invoke-virtual {v5}, LEa5$b;->w()Z

    move-result v6

    if-eqz v6, :cond_1

    invoke-virtual {v5}, LEa5$b;->r()LLY0;

    move-result-object v6

    sget-object v7, LIY0;->q:Lb0;

    invoke-virtual {v6, v7}, LLY0;->r(Lb0;)LIY0;

    move-result-object v6

    if-eqz v6, :cond_1

    invoke-virtual {v6}, LIY0;->w()LS;
    ...
    :cond_1
    invoke-virtual {v5}, LEa5$b;->v()LY;

    move-result-object v5

    invoke-virtual {v5, v4}, LY;->H(Ljava/math/BigInteger;)Z
    ...
    :goto_0
    invoke-virtual {v1, p1}, LGN5;->equals(Ljava/lang/Object;)Z
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v3, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CRLImpl;->c:Lm70;

    invoke-virtual {v3}, Lm70;->y()LEa5;

    move-result-object v3

    invoke-virtual {v3}, LEa5;->r()LLY0;
    ...
    invoke-virtual {v7}, LY;->D()Ljava/math/BigInteger;

    move-result-object v7

    invoke-direct {v6, v7}, LQZ;-><init>(Ljava/math/BigInteger;)V
    ...
    invoke-static {v8}, LY;->C(Ljava/lang/Object;)LY;

    move-result-object v8

    invoke-virtual {v8}, LY;->D()Ljava/math/BigInteger;

    move-result-object v8

    invoke-direct {v7, v8}, LQZ;-><init>(Ljava/math/BigInteger;)V
    ...
    invoke-static {v6}, LeK1;->v(Ljava/lang/Object;)LeK1;
    ...
    invoke-static {v6}, LPZ;->s(Ljava/lang/Object;)LPZ;
