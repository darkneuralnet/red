...
.method public engineGetEncoded()[B
    ...
    iget-object v1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/elgamal/AlgorithmParametersSpi;->currentSpec:LXR0;

    invoke-virtual {v1}, LXR0;->b()Ljava/math/BigInteger;

    move-result-object v1

    iget-object v2, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/elgamal/AlgorithmParametersSpi;->currentSpec:LXR0;

    invoke-virtual {v2}, LXR0;->a()Ljava/math/BigInteger;

    move-result-object v2

    invoke-direct {v0, v1, v2}, LWR0;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;)V
...
.method public engineInit(Ljava/security/spec/AlgorithmParameterSpec;)V
    ...
    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/elgamal/AlgorithmParametersSpi;->currentSpec:LXR0;
    ...
    iput-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/elgamal/AlgorithmParametersSpi;->currentSpec:LXR0;
...
.method public engineInit([B)V
    ...
    invoke-static {p1}, LWR0;->s(Ljava/lang/Object;)LWR0;

    move-result-object p1

    new-instance v1, LXR0;

    invoke-virtual {p1}, LWR0;->t()Ljava/math/BigInteger;

    move-result-object v2

    invoke-virtual {p1}, LWR0;->r()Ljava/math/BigInteger;

    move-result-object p1

    invoke-direct {v1, v2, p1}, LXR0;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;)V

    iput-object v1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/elgamal/AlgorithmParametersSpi;->currentSpec:LXR0;
    :try_end_0
...
.method public localEngineGetParameterSpec(Ljava/lang/Class;)Ljava/security/spec/AlgorithmParameterSpec;
    ...
    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/elgamal/AlgorithmParametersSpi;->currentSpec:LXR0;
    ...
    invoke-virtual {v1}, LXR0;->a()Ljava/math/BigInteger;
    ...
    :cond_2
    :goto_0
    iget-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/elgamal/AlgorithmParametersSpi;->currentSpec:LXR0;
