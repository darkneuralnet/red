...
.method public configure(Lorg/bouncycastle/jcajce/provider/config/ConfigurableProvider;)V
    ...
    invoke-interface {p1, v1, v0, v2}, Lorg/bouncycastle/jcajce/provider/config/ConfigurableProvider;->addAlgorithm(Ljava/lang/String;Lb0;Ljava/lang/String;)V

    sget-object v2, LmR0;->d:Lb0;

    const-string v3, "ED25519"

    invoke-interface {p1, v1, v2, v3}, Lorg/bouncycastle/jcajce/provider/config/ConfigurableProvider;->addAlgorithm(Ljava/lang/String;Lb0;Ljava/lang/String;)V
    ...
    invoke-interface {p1, v1, v0, v3}, Lorg/bouncycastle/jcajce/provider/config/ConfigurableProvider;->addAlgorithm(Ljava/lang/String;Lb0;Ljava/lang/String;)V

    invoke-interface {p1, v1, v2, v4}, Lorg/bouncycastle/jcajce/provider/config/ConfigurableProvider;->addAlgorithm(Ljava/lang/String;Lb0;Ljava/lang/String;)V
    ...
    sget-object v3, LmR0;->c:Lb0;

    const-string v6, "KeyAgreement"

    invoke-interface {p1, v6, v3, v4}, Lorg/bouncycastle/jcajce/provider/config/ConfigurableProvider;->addAlgorithm(Ljava/lang/String;Lb0;Ljava/lang/String;)V

    sget-object v4, LmR0;->b:Lb0;

    invoke-interface {p1, v6, v4, v5}, Lorg/bouncycastle/jcajce/provider/config/ConfigurableProvider;->addAlgorithm(Ljava/lang/String;Lb0;Ljava/lang/String;)V
    ...
    invoke-interface {p1, v1, v3, v6}, Lorg/bouncycastle/jcajce/provider/config/ConfigurableProvider;->addAlgorithm(Ljava/lang/String;Lb0;Ljava/lang/String;)V

    invoke-interface {p1, v1, v4, v7}, Lorg/bouncycastle/jcajce/provider/config/ConfigurableProvider;->addAlgorithm(Ljava/lang/String;Lb0;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p1, v3, v5, v1}, Lorg/bouncycastle/jcajce/provider/util/AsymmetricAlgorithmProvider;->registerOid(Lorg/bouncycastle/jcajce/provider/config/ConfigurableProvider;Lb0;Ljava/lang/String;Lorg/bouncycastle/jcajce/provider/util/AsymmetricKeyInfoConverter;)V
    ...
    invoke-virtual {p0, p1, v4, v5, v1}, Lorg/bouncycastle/jcajce/provider/util/AsymmetricAlgorithmProvider;->registerOid(Lorg/bouncycastle/jcajce/provider/config/ConfigurableProvider;Lb0;Ljava/lang/String;Lorg/bouncycastle/jcajce/provider/util/AsymmetricKeyInfoConverter;)V
    ...
    invoke-virtual {p0, p1, v0, v3, v1}, Lorg/bouncycastle/jcajce/provider/util/AsymmetricAlgorithmProvider;->registerOid(Lorg/bouncycastle/jcajce/provider/config/ConfigurableProvider;Lb0;Ljava/lang/String;Lorg/bouncycastle/jcajce/provider/util/AsymmetricKeyInfoConverter;)V
    ...
    invoke-virtual {p0, p1, v2, v3, v0}, Lorg/bouncycastle/jcajce/provider/util/AsymmetricAlgorithmProvider;->registerOid(Lorg/bouncycastle/jcajce/provider/config/ConfigurableProvider;Lb0;Ljava/lang/String;Lorg/bouncycastle/jcajce/provider/util/AsymmetricKeyInfoConverter;)V
