...
.method public constructor <init>(LEQ0;Lorg/bouncycastle/jcajce/provider/config/ProviderConfiguration;)V
    ...
    iput-object v1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost12/BCECGOST3410_2012PublicKey;->ecPublicKey:LDQ0;
...
.method public constructor <init>(LL65;)V
    ...
    invoke-direct {p0, p1}, Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost12/BCECGOST3410_2012PublicKey;->populateFromPubKeyInfo(LL65;)V
...
.method public constructor <init>(Ljava/lang/String;LDQ0;)V
    ...
    iput-object p2, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost12/BCECGOST3410_2012PublicKey;->ecPublicKey:LDQ0;
...
.method public constructor <init>(Ljava/lang/String;LDQ0;Ljava/security/spec/ECParameterSpec;)V
    ...
    invoke-virtual {p1}, LaQ0;->m()Lb0;

    move-result-object v1

    invoke-virtual {p1}, LaQ0;->k()Lb0;

    move-result-object v2

    invoke-virtual {p1}, LaQ0;->l()Lb0;

    move-result-object p1

    invoke-direct {p2, v1, v2, p1}, LJh1;-><init>(Lb0;Lb0;Lb0;)V

    iput-object p2, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost12/BCECGOST3410_2012PublicKey;->gostParams:LJh1;
    ...
    invoke-direct {p0, p1, v0}, Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost12/BCECGOST3410_2012PublicKey;->createSpec(Ljava/security/spec/EllipticCurve;LVP0;)Ljava/security/spec/ECParameterSpec;
...
.method public constructor <init>(Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost12/BCECGOST3410_2012PublicKey;)V
    ...
    iget-object v0, p1, Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost12/BCECGOST3410_2012PublicKey;->ecPublicKey:LDQ0;

    iput-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost12/BCECGOST3410_2012PublicKey;->ecPublicKey:LDQ0;
    ...
    iget-object p1, p1, Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost12/BCECGOST3410_2012PublicKey;->gostParams:LJh1;

    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost12/BCECGOST3410_2012PublicKey;->gostParams:LJh1;
...
.method private populateFromPubKeyInfo(LL65;)V
    ...
    invoke-virtual {v0, v3}, LKP0;->j([B)LvQ0;

    move-result-object v0

    const/4 v2, 0x0

    invoke-static {v2, p1}, Lorg/bouncycastle/jcajce/provider/asymmetric/util/ECUtil;->getDomainParameters(Lorg/bouncycastle/jcajce/provider/config/ProviderConfiguration;LtQ0;)LVP0;

    move-result-object v2

    invoke-direct {v1, v0, v2}, LDQ0;-><init>(LvQ0;LVP0;)V

    iput-object v1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost12/BCECGOST3410_2012PublicKey;->ecPublicKey:LDQ0;

    new-instance v0, LqQ0;

    iget-object v1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost12/BCECGOST3410_2012PublicKey;->gostParams:LJh1;
...
.method public engineGetKeyParameters()LDQ0;
    ...
    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost12/BCECGOST3410_2012PublicKey;->ecPublicKey:LDQ0;
...
.method public equals(Ljava/lang/Object;)Z
    ...
    iget-object v2, p1, Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost12/BCECGOST3410_2012PublicKey;->ecPublicKey:LDQ0;
    ...
    invoke-virtual {p0}, Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost12/BCECGOST3410_2012PublicKey;->engineGetSpec()LtQ0;

    move-result-object v0

    invoke-virtual {p1}, Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost12/BCECGOST3410_2012PublicKey;->engineGetSpec()LtQ0;
...
.method public getEncoded()[B
    ...
    iget-object v1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost12/BCECGOST3410_2012PublicKey;->ecPublicKey:LDQ0;

    invoke-virtual {v1}, LDQ0;->c()LvQ0;

    move-result-object v1

    invoke-virtual {v1}, LvQ0;->g()LXP0;
    ...
    :goto_0
    invoke-virtual {p0}, Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost12/BCECGOST3410_2012PublicKey;->getGostParams()LJh1;
    ...
    invoke-virtual {v4}, LqQ0;->c()Ljava/lang/String;

    move-result-object v4

    invoke-static {v4}, LZP0;->i(Ljava/lang/String;)Lb0;

    move-result-object v4

    if-eqz v2, :cond_1

    sget-object v6, Lor4;->d:Lb0;

    invoke-direct {v5, v4, v6}, LJh1;-><init>(Lb0;Lb0;)V

    goto :goto_1

    :cond_1
    sget-object v6, Lor4;->c:Lb0;
    ...
    invoke-static {v4}, Lorg/bouncycastle/jcajce/provider/asymmetric/util/EC5Util;->convertCurve(Ljava/security/spec/EllipticCurve;)LKP0;
    ...
    invoke-static {v6, v5}, Lorg/bouncycastle/jcajce/provider/asymmetric/util/EC5Util;->convertPoint(LKP0;Ljava/security/spec/ECPoint;)LvQ0;

    move-result-object v5

    iget-boolean v8, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost12/BCECGOST3410_2012PublicKey;->withCompression:Z

    invoke-direct {v7, v5, v8}, LnO5;-><init>(LvQ0;Z)V
    ...
    invoke-direct {v5, v4}, LjO5;-><init>(LlO5;)V
    ...
    invoke-direct {v1, v6, v4}, Ln8;-><init>(Lb0;LS;)V

    new-instance v2, LFx0;

    invoke-direct {v2, v7}, LFx0;-><init>([B)V
...
.method public getGostParams()LJh1;
    .locals 3

    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost12/BCECGOST3410_2012PublicKey;->gostParams:LJh1;

    if-nez v0, :cond_2

    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost12/BCECGOST3410_2012PublicKey;->ecSpec:Ljava/security/spec/ECParameterSpec;

    instance-of v0, v0, LqQ0;
    ...
    invoke-static {v1}, LZP0;->i(Ljava/lang/String;)Lb0;

    move-result-object v1

    sget-object v2, Lor4;->d:Lb0;

    invoke-direct {v0, v1, v2}, LJh1;-><init>(Lb0;Lb0;)V
    ...
    sget-object v2, Lor4;->c:Lb0;

    invoke-direct {v0, v1, v2}, LJh1;-><init>(Lb0;Lb0;)V

    :goto_1
    iput-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost12/BCECGOST3410_2012PublicKey;->gostParams:LJh1;
