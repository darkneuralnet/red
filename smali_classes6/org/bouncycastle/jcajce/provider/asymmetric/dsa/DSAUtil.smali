...
# static fields
.field public static final dsaOids:[Lb0;
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lorg/bouncycastle/jcajce/provider/asymmetric/dsa/DSAUtil;->dsaOids:[Lb0;
...
.method public static generateKeyFingerprint(Ljava/math/BigInteger;Ljava/security/interfaces/DSAParams;)Ljava/lang/String;
    ...
    invoke-static {p0, v1, v2, p1}, LUk;->r([B[B[B[B)[B
...
.method public static generatePrivateKeyParameter(Ljava/security/PrivateKey;)Lxl;
    ...
    invoke-direct {v2, v3, v4, p0}, LUy0;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;)V

    invoke-direct {v0, v1, v2}, LWy0;-><init>(Ljava/math/BigInteger;LUy0;)V
...
.method public static generatePublicKeyParameter(Ljava/security/PublicKey;)Lxl;
    ...
    invoke-virtual {p0}, Lorg/bouncycastle/jcajce/provider/asymmetric/dsa/BCDSAPublicKey;->engineGetKeyParameters()LXy0;
    ...
    invoke-virtual {v0}, Lorg/bouncycastle/jcajce/provider/asymmetric/dsa/BCDSAPublicKey;->engineGetKeyParameters()LXy0;
    ...
    invoke-direct {v1, v0}, Lorg/bouncycastle/jcajce/provider/asymmetric/dsa/BCDSAPublicKey;-><init>(LL65;)V

    invoke-virtual {v1}, Lorg/bouncycastle/jcajce/provider/asymmetric/dsa/BCDSAPublicKey;->engineGetKeyParameters()LXy0;
...
.method public static isDsaOid(Lb0;)Z
    .locals 4
    ...
    :goto_0
    sget-object v2, Lorg/bouncycastle/jcajce/provider/asymmetric/dsa/DSAUtil;->dsaOids:[Lb0;
...
.method public static toDSAParameters(Ljava/security/interfaces/DSAParams;)LUy0;
    .locals 3
    ...
    invoke-direct {v0, v1, v2, p0}, LUy0;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;)V
