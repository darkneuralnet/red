...
# instance fields
.field private contentDigest:LtK0;
...
.field private key:LhG3;

.field private mgfDigest:LtK0;
...
.field private pss:LL33;

.field private random:Ljava/security/SecureRandom;

.field private saltLength:I

.field private signer:Lul;

.field private trailer:B


# direct methods
.method public constructor <init>(Lul;Ljava/security/spec/PSSParameterSpec;)V
    .locals 1

    const/4 v0, 0x0

    invoke-direct {p0, p1, p2, v0}, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/PSSSignatureSpi;-><init>(Lul;Ljava/security/spec/PSSParameterSpec;Z)V

    return-void
.end method

.method public constructor <init>(Lul;Ljava/security/spec/PSSParameterSpec;Z)V
    .locals 1
    ...
    iput-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/PSSSignatureSpi;->helper:LtP1;

    const/4 v0, 0x1

    iput-boolean v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/PSSSignatureSpi;->isInitState:Z

    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/PSSSignatureSpi;->signer:Lul;
    ...
    :goto_1
    invoke-static {p1}, Lorg/bouncycastle/jcajce/provider/util/DigestFactory;->getDigest(Ljava/lang/String;)LtK0;

    move-result-object p1

    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/PSSSignatureSpi;->mgfDigest:LtK0;
...
.method private setupContentDigest()V
    ...
    iget-object v1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/PSSSignatureSpi;->mgfDigest:LtK0;

    invoke-direct {v0, p0, v1}, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/PSSSignatureSpi$NullPssDigest;-><init>(Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/PSSSignatureSpi;LtK0;)V
    ...
    invoke-static {v0}, Lorg/bouncycastle/jcajce/provider/util/DigestFactory;->getDigest(Ljava/lang/String;)LtK0;

    move-result-object v0

    :goto_0
    iput-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/PSSSignatureSpi;->contentDigest:LtK0;
...
.method public engineGetParameters()Ljava/security/AlgorithmParameters;
    ...
    :cond_0
    :try_start_0
    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/PSSSignatureSpi;->helper:LtP1;
...
.method public engineInitSign(Ljava/security/PrivateKey;)V
    ...
    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/PSSSignatureSpi;->key:LhG3;

    new-instance p1, LL33;

    iget-object v1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/PSSSignatureSpi;->signer:Lul;

    iget-object v2, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/PSSSignatureSpi;->contentDigest:LtK0;

    iget-object v3, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/PSSSignatureSpi;->mgfDigest:LtK0;
    ...
    invoke-direct/range {v0 .. v5}, LL33;-><init>(Lul;LtK0;LtK0;IB)V

    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/PSSSignatureSpi;->pss:LL33;
    ...
    iget-object v3, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/PSSSignatureSpi;->key:LhG3;

    invoke-direct {v2, v3, v0}, LN43;-><init>(Lvb0;Ljava/security/SecureRandom;)V

    invoke-virtual {p1, v1, v2}, LL33;->init(ZLvb0;)V

    goto :goto_0

    :cond_0
    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/PSSSignatureSpi;->key:LhG3;

    invoke-virtual {p1, v1, v0}, LL33;->init(ZLvb0;)V
...
.method public engineInitVerify(Ljava/security/PublicKey;)V
    ...
    iget-object v1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/PSSSignatureSpi;->key:LhG3;

    invoke-virtual {p1, v0, v1}, LL33;->init(ZLvb0;)V
...
.method public engineSetParameter(Ljava/security/spec/AlgorithmParameterSpec;)V
    ...
    iput-object v4, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/PSSSignatureSpi;->mgfDigest:LtK0;
    ...
    iget-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/PSSSignatureSpi;->key:LhG3;

    if-eqz p1, :cond_9

    new-instance p1, LL33;

    iget-object v2, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/PSSSignatureSpi;->signer:Lul;

    iget-object v3, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/PSSSignatureSpi;->contentDigest:LtK0;
    ...
    invoke-direct/range {v1 .. v6}, LL33;-><init>(Lul;LtK0;LtK0;IB)V
    ...
    iget-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/PSSSignatureSpi;->pss:LL33;
...
.method public engineSign()[B
    ...
    :try_start_0
    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/PSSSignatureSpi;->pss:LL33;

    invoke-virtual {v0}, LL33;->b()[B
...
.method public engineUpdate(B)V
    ...
    invoke-virtual {v0, p1}, LL33;->update(B)V
...
.method public engineUpdate([BII)V
    ...
    invoke-virtual {v0, p1, p2, p3}, LL33;->update([BII)V
...
.method public engineVerify([B)Z
    ...
    invoke-virtual {v0, p1}, LL33;->a([B)Z
