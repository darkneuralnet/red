...
# instance fields
.field private transient dhPublicKey:Lsy0;

.field private transient dhSpec:Ljavax/crypto/spec/DHParameterSpec;

.field private transient info:LL65;
...
.method public constructor <init>(LL65;)V
    ...
    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/dh/BCDHPublicKey;->info:LL65;
    ...
    invoke-virtual {p1, v1}, Lf0;->w(Lf0;)Z

    move-result v1

    if-nez v1, :cond_3

    invoke-direct {p0, v0}, Lorg/bouncycastle/jcajce/provider/asymmetric/dh/BCDHPublicKey;->isPKCSParam(Lh0;)Z
    ...
    invoke-virtual {v0}, LKu5;->t()[B

    move-result-object p1

    invoke-virtual {v0}, LKu5;->s()Ljava/math/BigInteger;
    ...
    invoke-direct {v8, p1, v0}, Lxy0;-><init>([BI)V

    move-object v3, v9

    invoke-direct/range {v3 .. v8}, Loy0;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Lxy0;)V

    invoke-direct {v1, v2, v9}, Lsy0;-><init>(Ljava/math/BigInteger;Loy0;)V

    iput-object v1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/dh/BCDHPublicKey;->dhPublicKey:Lsy0;
    ...
    invoke-direct {v0, v1, v8}, Lsy0;-><init>(Ljava/math/BigInteger;Loy0;)V

    iput-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/dh/BCDHPublicKey;->dhPublicKey:Lsy0;

    :goto_0
    new-instance p1, Lay0;

    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/dh/BCDHPublicKey;->dhPublicKey:Lsy0;

    invoke-virtual {v0}, Lky0;->b()Loy0;

    move-result-object v0

    invoke-direct {p1, v0}, Lay0;-><init>(Loy0;)V
    ...
    invoke-direct {v1, v2, v3, v4, v5}, Loy0;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;I)V
    ...
    :goto_2
    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/dh/BCDHPublicKey;->dhPublicKey:Lsy0;
...
.method public constructor <init>(Ljava/math/BigInteger;Ljavax/crypto/spec/DHParameterSpec;)V
    ...
    invoke-direct {v0, p1, p2}, Lsy0;-><init>(Ljava/math/BigInteger;Loy0;)V
    ...
    invoke-direct {v1, v2, p2}, Loy0;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;)V

    invoke-direct {v0, p1, v1}, Lsy0;-><init>(Ljava/math/BigInteger;Loy0;)V
...
.method public constructor <init>(Ljavax/crypto/interfaces/DHPublicKey;)V
    ...
    invoke-virtual {p1}, Lay0;->a()Loy0;

    move-result-object p1

    invoke-direct {v0, v1, p1}, Lsy0;-><init>(Ljava/math/BigInteger;Loy0;)V
...
.method public constructor <init>(Ljavax/crypto/spec/DHPublicKeySpec;)V
    ...
    invoke-virtual {v0}, Ldy0;->a()Ljavax/crypto/spec/DHParameterSpec;
    ...
    invoke-direct {p1, v1, v0}, Lsy0;-><init>(Ljava/math/BigInteger;Loy0;)V
    ...
    invoke-direct {v0, v1, v2}, Lsy0;-><init>(Ljava/math/BigInteger;Loy0;)V
...
.method public constructor <init>(Lsy0;)V
    ...
    invoke-direct {v0, v1}, Lay0;-><init>(Loy0;)V
...
.method private isPKCSParam(Lh0;)Z
    .locals 5
...
# virtual methods
.method public engineGetKeyParameters()Lsy0;
    .locals 1
...
.method public getEncoded()[B
    ...
    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/dh/BCDHPublicKey;->info:LL65;
    ...
    invoke-virtual {v0}, Lay0;->b()Ljava/math/BigInteger;
    ...
    invoke-virtual {v1}, Lxy0;->b()[B

    move-result-object v3

    invoke-virtual {v1}, Lxy0;->a()I

    move-result v1

    invoke-direct {v2, v3, v1}, LKu5;-><init>([BI)V
    ...
    invoke-virtual {v0}, Loy0;->c()Ljava/math/BigInteger;

    move-result-object v8

    move-object v4, v3

    invoke-direct/range {v4 .. v9}, LwM0;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;LKu5;)V

    invoke-virtual {v3}, LwM0;->g()Lf0;
    ...
    invoke-direct {v2, v3, v4, v5}, Lny0;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;I)V

    invoke-virtual {v2}, Lny0;->g()Lf0;
...
.method public toString()Ljava/lang/String;
    ...
    invoke-static {v2, v0, v1}, Lorg/bouncycastle/jcajce/provider/asymmetric/dh/DHUtil;->publicKeyToString(Ljava/lang/String;Ljava/math/BigInteger;Loy0;)Ljava/lang/String;
