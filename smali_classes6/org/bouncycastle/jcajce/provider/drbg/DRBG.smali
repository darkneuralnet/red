...
.method private static createBaseRandom(Z)Ljava/security/SecureRandom;
    ...
    invoke-static {}, Lorg/bouncycastle/jcajce/provider/drbg/DRBG;->createEntropySource()LDV0;

    move-result-object v0

    const/16 v1, 0x80

    invoke-interface {v0, v1}, LDV0;->get(I)LCV0;

    move-result-object v1

    invoke-interface {v1}, LCV0;->getEntropy()[B
    ...
    invoke-direct {v3, v0}, LNv4;-><init>(LDV0;)V

    invoke-virtual {v3, v2}, LNv4;->e([B)LNv4;
    ...
    invoke-static {v3, v1}, LUk;->p([B[B)[B

    move-result-object v1

    invoke-virtual {v0, v2, v1, p0}, LNv4;->c(LtK0;[BZ)LMv4;
    ...
    invoke-direct {v2, v0, v3}, LNv4;-><init>(Ljava/security/SecureRandom;Z)V

    invoke-virtual {v2, v1}, LNv4;->e([B)LNv4;
    ...
    invoke-virtual {v1, v2, v0, p0}, LNv4;->c(LtK0;[BZ)LMv4;
...
.method private static createEntropySource()LDV0;
    .locals 2
...
.method private static generateDefaultPersonalizationString([B)[B
    ...
    invoke-static {v1, v2}, LN33;->u(J)[B
    ...
    invoke-static {v2, v3}, LN33;->u(J)[B

    move-result-object v2

    invoke-static {v0, p0, v1, v2}, LUk;->r([B[B[B[B)[B
...
.method private static generateNonceIVPersonalizationString([B)[B
    ...
    invoke-static {v1, v2}, LN33;->y(J)[B
    ...
    invoke-static {v2, v3}, LN33;->y(J)[B
