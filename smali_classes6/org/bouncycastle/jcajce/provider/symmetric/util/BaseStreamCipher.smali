...
.method public constructor <init>(Lr55;I)V
    ...
    invoke-direct {p0, p1, p2, v0, v0}, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseStreamCipher;-><init>(Lr55;III)V

    return-void
.end method

.method public constructor <init>(Lr55;II)V
    .locals 1

    const/4 v0, -0x1

    invoke-direct {p0, p1, p2, p3, v0}, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseStreamCipher;-><init>(Lr55;III)V

    return-void
.end method

.method public constructor <init>(Lr55;III)V
    .locals 4
    ...
    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseStreamCipher;->cipher:Lr55;
...
.method public engineDoFinal([BII[BI)I
    ...
    iget-object v2, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseStreamCipher;->cipher:Lr55;
    ...
    invoke-interface/range {v2 .. v7}, Lr55;->processBytes([BII[BI)I

    :cond_0
    iget-object p1, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseStreamCipher;->cipher:Lr55;

    invoke-interface {p1}, Lr55;->reset()V
...
.method public engineDoFinal([BII)[B
    ...
    iget-object p2, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseStreamCipher;->cipher:Lr55;

    invoke-interface {p2}, Lr55;->reset()V
...
.method public engineGetIV()[B
    ...
    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseStreamCipher;->ivParam:LM43;
...
.method public engineGetParameters()Ljava/security/AlgorithmParameters;
    ...
    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseStreamCipher;->cipher:Lr55;

    invoke-interface {v0}, Lr55;->getAlgorithmName()Ljava/lang/String;
    ...
    iget-object v2, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseStreamCipher;->ivParam:LM43;
...
.method public engineInit(ILjava/security/Key;Ljava/security/spec/AlgorithmParameterSpec;Ljava/security/SecureRandom;)V
    ...
    invoke-virtual {v0}, Lq33;->getSalt()[B

    move-result-object v1

    invoke-virtual {v0}, Lq33;->getIterationCount()I
    ...
    :cond_0
    invoke-virtual {p2}, Lp33;->getEncoded()[B
    ...
    invoke-interface {p2}, Lr55;->getAlgorithmName()Ljava/lang/String;

    move-result-object v8

    invoke-static/range {v2 .. v8}, Lorg/bouncycastle/jcajce/provider/symmetric/util/PBE$Util;->makePBEParameters([BIIIILjava/security/spec/AlgorithmParameterSpec;Ljava/lang/String;)Lvb0;
    ...
    invoke-virtual {p2}, Lorg/bouncycastle/jcajce/provider/symmetric/util/BCPBEKey;->getOID()Lb0;
    ...
    invoke-virtual {p2}, Lorg/bouncycastle/jcajce/provider/symmetric/util/BCPBEKey;->getParam()Lvb0;
    ...
    invoke-static {p2, p3, v0}, Lorg/bouncycastle/jcajce/provider/symmetric/util/PBE$Util;->makePBEParameters(Lorg/bouncycastle/jcajce/provider/symmetric/util/BCPBEKey;Ljava/security/spec/AlgorithmParameterSpec;Ljava/lang/String;)Lvb0;
    ...
    iput-object p2, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseStreamCipher;->ivParam:LM43;
    ...
    invoke-direct {p3, p2}, LXR1;-><init>([B)V
    ...
    invoke-direct {v1, p2}, LXR1;-><init>([B)V
    ...
    iput-object v0, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseStreamCipher;->ivParam:LM43;
    ...
    new-instance p4, LM43;

    invoke-direct {p4, p2, p3}, LM43;-><init>(Lvb0;[B)V

    iput-object p4, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseStreamCipher;->ivParam:LM43;
    ...
    invoke-interface {p1, p3, p2}, Lr55;->init(ZLvb0;)V
    ...
    invoke-interface {p1, v1, p2}, Lr55;->init(ZLvb0;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public engineUpdate([BII)[B
    ...
    invoke-interface/range {v0 .. v5}, Lr55;->processBytes([BII[BI)I
