...
.method private static convertPassword(ILjavax/crypto/spec/PBEKeySpec;)[B
    ...
    invoke-static {p0}, LU23;->PKCS12PasswordToBytes([C)[B
    ...
    invoke-static {p0}, LU23;->PKCS5PasswordToBytes([C)[B
    ...
    invoke-static {p0}, LU23;->PKCS5PasswordToUTF8Bytes([C)[B
...
.method private static makePBEGenerator(II)LU23;
    ...
    invoke-direct {p0, p1}, Lw33;-><init>(LtK0;)V
...
.method public static makePBEMacParameters(Ljavax/crypto/SecretKey;IIILjavax/crypto/spec/PBEParameterSpec;)Lvb0;
    .locals 1

    invoke-static {p1, p2}, Lorg/bouncycastle/jcajce/provider/symmetric/util/PBE$Util;->makePBEGenerator(II)LU23;
    ...
    invoke-virtual {p1, p0, v0, p4}, LU23;->init([B[BI)V

    invoke-virtual {p1, p3}, LU23;->generateDerivedMacParameters(I)Lvb0;
...
.method public static makePBEMacParameters(Ljavax/crypto/spec/PBEKeySpec;III)Lvb0;
    .locals 1
    ...
    invoke-virtual {p2, p1, v0, p0}, LU23;->init([B[BI)V

    invoke-virtual {p2, p3}, LU23;->generateDerivedMacParameters(I)Lvb0;
...
.method public static makePBEMacParameters(Lorg/bouncycastle/jcajce/provider/symmetric/util/BCPBEKey;Ljava/security/spec/AlgorithmParameterSpec;)Lvb0;
    .locals 3
    ...
    invoke-static {v0, v1}, Lorg/bouncycastle/jcajce/provider/symmetric/util/PBE$Util;->makePBEGenerator(II)LU23;
    ...
    invoke-virtual {v0, v1, v2, p1}, LU23;->init([B[BI)V

    invoke-virtual {p0}, Lorg/bouncycastle/jcajce/provider/symmetric/util/BCPBEKey;->getKeySize()I

    move-result p0

    invoke-virtual {v0, p0}, LU23;->generateDerivedMacParameters(I)Lvb0;
...
.method public static makePBEParameters(Ljavax/crypto/spec/PBEKeySpec;IIII)Lvb0;
    .locals 1
    ...
    invoke-virtual {p2, p3, p4}, LU23;->generateDerivedParameters(II)Lvb0;
    ...
    :cond_0
    invoke-virtual {p2, p3}, LU23;->generateDerivedParameters(I)Lvb0;
...
.method public static makePBEParameters(Lorg/bouncycastle/jcajce/provider/symmetric/util/BCPBEKey;Ljava/security/spec/AlgorithmParameterSpec;Ljava/lang/String;)Lvb0;
    .locals 3
    ...
    invoke-virtual {v0, p1, p0}, LU23;->generateDerivedParameters(II)Lvb0;
    ...
    invoke-virtual {v0, p0}, LU23;->generateDerivedParameters(I)Lvb0;
...
.method public static makePBEParameters([BIIIILjava/security/spec/AlgorithmParameterSpec;Ljava/lang/String;)Lvb0;
    .locals 1
    ...
    invoke-virtual {p1, p0, p2, p5}, LU23;->init([B[BI)V

    if-eqz p4, :cond_0

    invoke-virtual {p1, p3, p4}, LU23;->generateDerivedParameters(II)Lvb0;
    ...
    :cond_0
    invoke-virtual {p1, p3}, LU23;->generateDerivedParameters(I)Lvb0;
