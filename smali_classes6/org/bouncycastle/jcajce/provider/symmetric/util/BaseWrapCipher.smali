...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseWrapCipher;->wrapEngine:LgN5;
    ...
    iput-object v0, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseWrapCipher;->helper:LtP1;
...
.method public constructor <init>(LgN5;)V
    ...
    invoke-direct {p0, p1, v0}, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseWrapCipher;-><init>(LgN5;I)V
...
.method public constructor <init>(LgN5;I)V
    ...
    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseWrapCipher;->wrapEngine:LgN5;
...
.method public final createParametersInstance(Ljava/lang/String;)Ljava/security/AlgorithmParameters;
    ...
    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseWrapCipher;->helper:LtP1;
...
.method public engineDoFinal([BII[BI)I
    ...
    :try_start_1
    iget-object p1, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseWrapCipher;->wrapEngine:LgN5;
    ...
    invoke-interface {p1, p3, p2, v0}, LgN5;->a([BII)[B
    ...
    invoke-interface {p1, p3, p2, v0}, LgN5;->b([BII)[B
...
.method public engineGetParameters()Ljava/security/AlgorithmParameters;
    ...
    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseWrapCipher;->wrapEngine:LgN5;

    invoke-interface {v0}, LgN5;->getAlgorithmName()Ljava/lang/String;
...
.method public engineInit(ILjava/security/Key;Ljava/security/spec/AlgorithmParameterSpec;Ljava/security/SecureRandom;)V
    ...
    invoke-direct {v0, p2}, LXR1;-><init>([B)V
    ...
    invoke-direct {v1, p2, v0}, LM43;-><init>(Lvb0;[B)V

    move-object p2, v1

    :cond_3
    instance-of v0, p3, Lth1;

    if-eqz v0, :cond_5

    check-cast p3, Lth1;

    invoke-virtual {p3}, Lth1;->a()[B
    ...
    invoke-direct {v1, p2, v0}, LO43;-><init>(Lvb0;[B)V
    ...
    invoke-virtual {p3}, Lth1;->b()[B

    move-result-object p3

    invoke-direct {v0, p2, p3}, LP43;-><init>(Lvb0;[B)V

    move-object p2, v0

    :cond_5
    instance-of p3, p2, LXR1;
    ...
    invoke-direct {p3, p2, v2}, LM43;-><init>(Lvb0;[B)V
    ...
    invoke-interface {p1, p4, p2}, LgN5;->init(ZLvb0;)V
    ...
    invoke-interface {p1, v1, p2}, LgN5;->init(ZLvb0;)V
...
.method public engineUnwrap([BLjava/lang/String;I)Ljava/security/Key;
    ...
    :try_start_0
    iget-object v1, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseWrapCipher;->wrapEngine:LgN5;
    ...
    :cond_3
    :try_start_2
    iget-object v1, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseWrapCipher;->helper:LtP1;
