...
.method public engineGetEncoded(Ljava/lang/String;)[B
    ...
    invoke-direct {p1, v0, v1}, LBZ;-><init>([BI)V
...
.method public engineInit([BLjava/lang/String;)V
    ...
    invoke-direct {p2, p1}, LX;-><init>([B)V

    invoke-virtual {p2}, LX;->k()Lf0;

    move-result-object p1

    invoke-static {p1}, LBZ;->s(Ljava/lang/Object;)LBZ;

    move-result-object p1

    invoke-virtual {p1}, LBZ;->t()I

    move-result p2

    iput p2, p0, Lorg/bouncycastle/jcajce/provider/symmetric/CAST5$AlgParams;->keyLength:I

    invoke-virtual {p1}, LBZ;->r()[B
