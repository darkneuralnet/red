...
.method private readDERCrossCertificatePair(Ljava/io/InputStream;)LSN5;
    .locals 1
    ...
    invoke-static {p1}, Ln70;->s(Ljava/lang/Object;)Ln70;

    move-result-object p1

    new-instance v0, LSN5;

    invoke-direct {v0, p1}, LSN5;-><init>(Ln70;)V
...
.method public engineRead()Ljava/lang/Object;
    ...
    invoke-direct {p0, v0}, Lorg/bouncycastle/jce/provider/X509CertPairParser;->readDERCrossCertificatePair(Ljava/io/InputStream;)LSN5;
