...
.method private build(LMN5;Ljava/security/cert/X509Certificate;LG33;Ljava/util/List;)Ljava/security/cert/CertPathBuilderResult;
    .locals 6
    ...
    :cond_0
    invoke-virtual {p3}, LG33;->b()Ljava/util/Set;
    ...
    invoke-virtual {v3}, LH33;->w()Ljava/lang/String;
    ...
    invoke-virtual {v3}, LH33;->r()Ljava/util/List;
    ...
    :cond_4
    invoke-direct {p0, p1, v1, p3, p4}, Lorg/bouncycastle/jce/provider/PKIXAttrCertPathBuilderSpi;->build(LMN5;Ljava/security/cert/X509Certificate;LG33;Ljava/util/List;)Ljava/security/cert/CertPathBuilderResult;
...
.method public static findCertificates(LLN5;Ljava/util/List;)Ljava/util/Collection;
    .locals 3
    ...
    :try_start_0
    invoke-interface {v1, p0}, Li55;->getMatches(LsI4;)Ljava/util/Collection;
...
.method public engineBuild(Ljava/security/cert/CertPathParameters;)Ljava/security/cert/CertPathBuilderResult;
    ...
    invoke-direct {v0, v2}, LG33$b;-><init>(Ljava/security/cert/PKIXBuilderParameters;)V
    ...
    invoke-virtual {v0, v1}, LG33$b;->d(Ljava/util/Set;)LG33$b;

    invoke-virtual {p1}, LGY0;->p()I

    move-result v1

    invoke-virtual {v0, v1}, LG33$b;->f(I)LG33$b;

    invoke-virtual {p1}, LHY0;->e()Ljava/util/List;

    move-result-object v1

    :cond_2
    invoke-virtual {v0}, LG33$b;->e()LG33;
    ...
    invoke-virtual {p1}, LG33;->a()LH33;

    move-result-object v2

    invoke-virtual {v2}, LH33;->x()LF33;

    move-result-object v3

    instance-of v4, v3, LLN5;
    ...
    invoke-static {v3, v1}, Lorg/bouncycastle/jce/provider/PKIXAttrCertPathBuilderSpi;->findCertificates(LLN5;Ljava/util/List;)Ljava/util/Collection;
    ...
    invoke-direct {v5}, LQN5;-><init>()V

    invoke-interface {v4}, LMN5;->c()LZl;

    move-result-object v6

    invoke-virtual {v6}, LZl;->b()[Ljava/security/Principal;
    ...
    :cond_5
    new-instance v9, LF33$b;

    invoke-direct {v9, v5}, LF33$b;-><init>(Ljava/security/cert/CertSelector;)V

    invoke-virtual {v9}, LF33$b;->a()LF33;

    move-result-object v9

    invoke-virtual {v2}, LH33;->q()Ljava/util/List;

    move-result-object v10

    invoke-static {v7, v9, v10}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->findCertificates(Ljava/util/LinkedHashSet;LF33;Ljava/util/List;)V
    ...
    invoke-direct {p0, v4, v3, p1, v0}, Lorg/bouncycastle/jce/provider/PKIXAttrCertPathBuilderSpi;->build(LMN5;Ljava/security/cert/X509Certificate;LG33;Ljava/util/List;)Ljava/security/cert/CertPathBuilderResult;
