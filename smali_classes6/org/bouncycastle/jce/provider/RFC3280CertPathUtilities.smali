...
.method private static checkCRL(LD33;LSL0;LH33;Ljava/util/Date;Ljava/util/Date;Ljava/security/cert/X509Certificate;Ljava/security/cert/X509Certificate;Ljava/security/PublicKey;Lorg/bouncycastle/jce/provider/CertStatus;Lorg/bouncycastle/jce/provider/ReasonsMask;Ljava/util/List;LtP1;)V
    .locals 21
    ...
    invoke-static {v0, v1, v11, v9, v10}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->getCompleteCRLs(LD33;LSL0;Ljava/lang/Object;LH33;Ljava/util/Date;)Ljava/util/Set;
    ...
    :try_start_2
    invoke-static {v10, v15, v3, v4, v5}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->getDeltaCRLs(Ljava/util/Date;Ljava/security/cert/X509CRL;Ljava/util/List;Ljava/util/List;LtP1;)Ljava/util/Set;
    ...
    :cond_3
    :goto_2
    invoke-static {v1, v11, v15}, Lorg/bouncycastle/jce/provider/RFC3280CertPathUtilities;->processCRLB1(LSL0;Ljava/lang/Object;Ljava/security/cert/X509CRL;)V

    invoke-static {v1, v11, v15}, Lorg/bouncycastle/jce/provider/RFC3280CertPathUtilities;->processCRLB2(LSL0;Ljava/lang/Object;Ljava/security/cert/X509CRL;)V

    invoke-static {v2, v15, v9}, Lorg/bouncycastle/jce/provider/RFC3280CertPathUtilities;->processCRLC(Ljava/security/cert/X509CRL;Ljava/security/cert/X509CRL;LH33;)V

    invoke-static {v10, v2, v11, v12, v9}, Lorg/bouncycastle/jce/provider/RFC3280CertPathUtilities;->processCRLI(Ljava/util/Date;Ljava/security/cert/X509CRL;Ljava/lang/Object;Lorg/bouncycastle/jce/provider/CertStatus;LH33;)V
...
.method public static checkCRLs(LD33;LH33;Ljava/util/Date;Ljava/util/Date;Ljava/security/cert/X509Certificate;Ljava/security/cert/X509Certificate;Ljava/security/PublicKey;Ljava/util/List;LtP1;)V
    .locals 23
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/bouncycastle/jce/provider/AnnotatedException;,
    ...
    invoke-static {v13, v0}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->getExtensionValue(Ljava/security/cert/X509Extension;Ljava/lang/String;)Lf0;
    ...
    new-instance v1, LH33$b;

    move-object/from16 v14, p1

    invoke-direct {v1, v14}, LH33$b;-><init>(LH33;)V
    ...
    invoke-static {v0, v2, v15, v12}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->getAdditionalStoresFromCRLDistributionPoint(LPZ;Ljava/util/Map;Ljava/util/Date;LtP1;)Ljava/util/List;
    ...
    invoke-virtual {v1, v3}, LH33$b;->m(LA33;)LH33$b;
    :try_end_1
    ...
    invoke-virtual {v1}, LH33$b;->o()LH33;
    ...
    :try_start_4
    invoke-static/range {v1 .. v12}, Lorg/bouncycastle/jce/provider/RFC3280CertPathUtilities;->checkCRL(LD33;LSL0;LH33;Ljava/util/Date;Ljava/util/Date;Ljava/security/cert/X509Certificate;Ljava/security/cert/X509Certificate;Ljava/security/PublicKey;Lorg/bouncycastle/jce/provider/CertStatus;Lorg/bouncycastle/jce/provider/ReasonsMask;Ljava/util/List;LtP1;)V
    :try_end_4
    ...
    :try_start_5
    invoke-static/range {p4 .. p4}, Lorg/bouncycastle/jce/provider/PrincipalUtils;->getIssuerPrincipal(Ljava/security/cert/X509Certificate;)LGN5;
    ...
    invoke-virtual/range {p1 .. p1}, LH33;->clone()Ljava/lang/Object;
...
.method public static prepareCertB(Ljava/security/cert/CertPath;I[Ljava/util/List;Lorg/bouncycastle/jce/provider/PKIXPolicyNode;I)Lorg/bouncycastle/jce/provider/PKIXPolicyNode;
    ...
    invoke-static {v4, v5}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->getExtensionValue(Ljava/security/cert/X509Extension;Ljava/lang/String;)Lf0;
    ...
    invoke-virtual {v5, v7}, Lh0;->D(I)LS;

    move-result-object v8

    check-cast v8, Lh0;

    invoke-virtual {v8, v14}, Lh0;->D(I)LS;

    move-result-object v9

    check-cast v9, Lb0;

    invoke-virtual {v9}, Lb0;->G()Ljava/lang/String;

    move-result-object v9

    invoke-virtual {v8, v15}, Lh0;->D(I)LS;
    ...
    invoke-static {v4, v7}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->getExtensionValue(Ljava/security/cert/X509Extension;Ljava/lang/String;)Lf0;
    ...
    invoke-virtual {v7}, Lh0;->F()Ljava/util/Enumeration;
    ...
    invoke-static {v9}, Lmk3;->r(Ljava/lang/Object;)Lmk3;

    move-result-object v9
    :try_end_2
    .catch Ljava/lang/Exception; {:try_start_2 .. :try_end_2} :catch_1

    invoke-virtual {v9}, Lmk3;->s()Lb0;

    move-result-object v10

    invoke-virtual {v10}, Lb0;->G()Ljava/lang/String;
    ...
    :try_start_3
    invoke-virtual {v9}, Lmk3;->t()Lh0;

    move-result-object v5

    invoke-static {v5}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->getQualifierSet(Lh0;)Ljava/util/Set;
...
.method public static prepareNextCertA(Ljava/security/cert/CertPath;I)V
    ...
    invoke-static {v0, v1}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->getExtensionValue(Ljava/security/cert/X509Extension;Ljava/lang/String;)Lf0;
    ...
    invoke-virtual {v3, v1}, Lh0;->D(I)LS;

    move-result-object v4

    invoke-static {v4}, Lb0;->I(Ljava/lang/Object;)Lb0;

    move-result-object v4

    const/4 v5, 0x1

    invoke-virtual {v3, v5}, Lh0;->D(I)LS;
...
.method public static prepareNextCertG(Ljava/security/cert/CertPath;ILorg/bouncycastle/jce/provider/PKIXNameConstraintValidator;)V
    ...
    invoke-static {v0}, LEr2;->v(Ljava/lang/Object;)LEr2;
    ...
    :try_start_1
    invoke-virtual {p2, v1}, Lorg/bouncycastle/jce/provider/PKIXNameConstraintValidator;->intersectPermittedSubtree([Loi1;)V
    :try_end_1
    .catch Ljava/lang/Exception; {:try_start_1 .. :try_end_1} :catch_0
    ...
    invoke-virtual {p2, v2}, Lorg/bouncycastle/jce/provider/PKIXNameConstraintValidator;->addExcludedSubtree(Loi1;)V
    :try_end_2
    .catch Ljava/lang/Exception; {:try_start_2 .. :try_end_2} :catch_1
...
.method public static prepareNextCertK(Ljava/security/cert/CertPath;I)V
    ...
    invoke-static {v0}, LDz;->r(Ljava/lang/Object;)LDz;
...
.method public static prepareNextCertM(Ljava/security/cert/CertPath;II)I
    ...
    invoke-virtual {p0}, LDz;->s()Ljava/math/BigInteger;
...
.method public static processCRLB1(LSL0;Ljava/lang/Object;Ljava/security/cert/X509CRL;)V
    .locals 5
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/bouncycastle/jce/provider/AnnotatedException;
    ...
    invoke-static {p2, v0}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->getExtensionValue(Ljava/security/cert/X509Extension;Ljava/lang/String;)Lf0;
    ...
    invoke-static {v0}, LeK1;->v(Ljava/lang/Object;)LeK1;

    move-result-object v0

    invoke-virtual {v0}, LeK1;->x()Z
    ...
    :goto_0
    :try_start_0
    invoke-static {p2}, Lorg/bouncycastle/jce/provider/PrincipalUtils;->getIssuerPrincipal(Ljava/security/cert/X509CRL;)LGN5;
    ...
    invoke-static {p2, v3}, LUk;->c([B[B)Z
    ...
    invoke-static {p1}, Lorg/bouncycastle/jce/provider/PrincipalUtils;->getEncodedIssuerPrincipal(Ljava/lang/Object;)LGN5;
...
.method public static processCRLB2(LSL0;Ljava/lang/Object;Ljava/security/cert/X509CRL;)V
    .locals 9
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/bouncycastle/jce/provider/AnnotatedException;
    ...
    invoke-static {p2}, Lh0;->C(Ljava/lang/Object;)Lh0;
    ...
    invoke-virtual {v3, v6}, LT;->a(LS;)V
    :try_end_1
    .catch Ljava/lang/Exception; {:try_start_1 .. :try_end_1} :catch_0
    ...
    invoke-virtual {v3, p2}, LT;->a(LS;)V
    ...
    invoke-direct {p2, v1}, Lmi1;-><init>(LGN5;)V
    ...
    invoke-virtual {p2}, LTL0;->w()I

    move-result v6

    if-nez v6, :cond_3

    invoke-virtual {p2}, LTL0;->v()LS;
    ...
    invoke-direct {v3, v6}, Lmi1;-><init>(LGN5;)V
    ...
    invoke-static {v6}, Lh0;->C(Ljava/lang/Object;)Lh0;

    move-result-object v6

    invoke-virtual {v6}, Lh0;->F()Ljava/util/Enumeration;
    ...
    invoke-virtual {v7, v8}, LT;->a(LS;)V
    ...
    invoke-virtual {v7, v6}, LT;->a(LS;)V

    new-instance v6, Lmi1;

    new-instance v8, LJx0;

    invoke-direct {v8, v7}, LJx0;-><init>(LT;)V

    invoke-static {v8}, LGN5;->t(Ljava/lang/Object;)LGN5;

    move-result-object v7

    invoke-direct {v6, v7}, Lmi1;-><init>(LGN5;)V
    ...
    invoke-static {p0, p2}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->getExtensionValue(Ljava/security/cert/X509Extension;Ljava/lang/String;)Lf0;
...
.method public static processCRLC(Ljava/security/cert/X509CRL;Ljava/security/cert/X509CRL;LH33;)V
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/bouncycastle/jce/provider/AnnotatedException;
    ...
    invoke-static {p1, v0}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->getExtensionValue(Ljava/security/cert/X509Extension;Ljava/lang/String;)Lf0;

    move-result-object v1

    invoke-static {v1}, LeK1;->v(Ljava/lang/Object;)LeK1;

    move-result-object v1
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_3

    invoke-virtual {p2}, LH33;->F()Z

    move-result p2

    if-eqz p2, :cond_8

    invoke-static {p0}, Lorg/bouncycastle/jce/provider/PrincipalUtils;->getIssuerPrincipal(Ljava/security/cert/X509CRL;)LGN5;
    ...
    invoke-virtual {p2, v2}, LGN5;->equals(Ljava/lang/Object;)Z
    ...
    :try_start_1
    invoke-static {p0, v0}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->getExtensionValue(Ljava/security/cert/X509Extension;Ljava/lang/String;)Lf0;

    move-result-object p2

    invoke-static {p2}, LeK1;->v(Ljava/lang/Object;)LeK1;
    ...
    :cond_1
    invoke-virtual {v1, p2}, La0;->equals(Ljava/lang/Object;)Z
    ...
    invoke-static {p1, p2}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->getExtensionValue(Ljava/security/cert/X509Extension;Ljava/lang/String;)Lf0;
    ...
    invoke-virtual {p1, p0}, Lf0;->w(Lf0;)Z
...
.method public static processCRLD(Ljava/security/cert/X509CRL;LSL0;)Lorg/bouncycastle/jce/provider/ReasonsMask;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/bouncycastle/jce/provider/AnnotatedException;
    ...
    invoke-virtual {p0}, LeK1;->w()LsM3;

    move-result-object v0

    if-eqz v0, :cond_0

    invoke-virtual {p1}, LSL0;->w()LsM3;
    ...
    invoke-direct {v0, p1}, Lorg/bouncycastle/jce/provider/ReasonsMask;-><init>(LsM3;)V
    ...
    invoke-direct {p1, p0}, Lorg/bouncycastle/jce/provider/ReasonsMask;-><init>(LsM3;)V
    ...
    invoke-direct {v0, p0}, Lorg/bouncycastle/jce/provider/ReasonsMask;-><init>(LsM3;)V
...
.method public static processCRLF(Ljava/security/cert/X509CRL;Ljava/lang/Object;Ljava/security/cert/X509Certificate;Ljava/security/PublicKey;LH33;Ljava/util/List;LtP1;)Ljava/util/Set;
    .locals 8
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/bouncycastle/jce/provider/AnnotatedException;
    ...
    invoke-direct {p0, p1}, LF33$b;-><init>(Ljava/security/cert/CertSelector;)V
    ...
    :try_start_1
    invoke-virtual {p4}, LH33;->r()Ljava/util/List;

    move-result-object v0

    invoke-static {p1, p0, v0}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->findCertificates(Ljava/util/LinkedHashSet;LF33;Ljava/util/List;)V

    invoke-virtual {p4}, LH33;->q()Ljava/util/List;
    ...
    new-instance v6, LH33$b;

    invoke-direct {v6, p4}, LH33$b;-><init>(LH33;)V

    new-instance v7, LF33$b;

    invoke-direct {v7, v5}, LF33$b;-><init>(Ljava/security/cert/CertSelector;)V

    invoke-virtual {v7}, LF33$b;->a()LF33;

    move-result-object v5

    invoke-virtual {v6, v5}, LH33$b;->q(LF33;)LH33$b;
    ...
    invoke-virtual {v5, v2}, LH33$b;->p(Z)V

    goto :goto_2

    :cond_2
    invoke-virtual {v5, v4}, LH33$b;->p(Z)V
    ...
    invoke-static {v3, v2, p6}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->getNextWorkingKey(Ljava/util/List;ILtP1;)Ljava/security/PublicKey;
...
.method public static processCRLI(Ljava/util/Date;Ljava/security/cert/X509CRL;Ljava/lang/Object;Lorg/bouncycastle/jce/provider/CertStatus;LH33;)V
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/bouncycastle/jce/provider/AnnotatedException;
...
.method public static processCertA(Ljava/security/cert/CertPath;LH33;Ljava/util/Date;LC33;ILjava/security/PublicKey;ZLGN5;Ljava/security/cert/X509Certificate;)V
    .locals 13
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/cert/CertPathValidatorException;
    ...
    :try_start_0
    invoke-virtual {p1}, LH33;->w()Ljava/lang/String;
    ...
    invoke-direct/range {v1 .. v7}, LD33;-><init>(LH33;Ljava/util/Date;Ljava/security/cert/CertPath;ILjava/security/cert/X509Certificate;Ljava/security/PublicKey;)V

    invoke-interface {v0, v12}, LC33;->initialize(LD33;)V

    invoke-interface {v0, v11}, LC33;->check(Ljava/security/cert/Certificate;)V

    :cond_1
    invoke-static {v11}, Lorg/bouncycastle/jce/provider/PrincipalUtils;->getIssuerPrincipal(Ljava/security/cert/X509Certificate;)LGN5;

    move-result-object v0

    invoke-virtual {v0, v10}, LGN5;->equals(Ljava/lang/Object;)Z
...
.method public static processCertBC(Ljava/security/cert/CertPath;ILorg/bouncycastle/jce/provider/PKIXNameConstraintValidator;Z)V
    ...
    :cond_0
    invoke-static {v1}, Lorg/bouncycastle/jce/provider/PrincipalUtils;->getSubjectPrincipal(Ljava/security/cert/X509Certificate;)LGN5;

    move-result-object p3

    :try_start_0
    invoke-static {p3}, Lh0;->C(Ljava/lang/Object;)Lh0;
    ...
    :try_start_1
    invoke-virtual {p2, p3}, Lorg/bouncycastle/jce/provider/PKIXNameConstraintValidator;->checkPermittedDN(Lh0;)V

    invoke-virtual {p2, p3}, Lorg/bouncycastle/jce/provider/PKIXNameConstraintValidator;->checkExcludedDN(Lh0;)V
    :try_end_1
    ...
    invoke-static {v1, v0}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->getExtensionValue(Ljava/security/cert/X509Extension;Ljava/lang/String;)Lf0;
    ...
    invoke-static {p3}, LGN5;->t(Ljava/lang/Object;)LGN5;

    move-result-object p3

    sget-object v1, LIq;->I:Lb0;

    invoke-virtual {p3, v1}, LGN5;->w(Lb0;)[LOF3;
    ...
    invoke-interface {v3}, Lm0;->j()Ljava/lang/String;
    ...
    invoke-direct {v4, v5, v3}, Lmi1;-><init>(ILjava/lang/String;)V

    :try_start_3
    invoke-virtual {p2, v4}, Lorg/bouncycastle/jce/provider/PKIXNameConstraintValidator;->checkPermitted(Lmi1;)V

    invoke-virtual {p2, v4}, Lorg/bouncycastle/jce/provider/PKIXNameConstraintValidator;->checkExcluded(Lmi1;)V
    :try_end_3
    ...
    invoke-virtual {p2, v0}, Lorg/bouncycastle/jce/provider/PKIXNameConstraintValidator;->checkPermitted(Lmi1;)V

    aget-object v0, p3, v1

    invoke-virtual {p2, v0}, Lorg/bouncycastle/jce/provider/PKIXNameConstraintValidator;->checkExcluded(Lmi1;)V
    :try_end_5
...
.method public static processCertD(Ljava/security/cert/CertPath;ILjava/util/Set;Lorg/bouncycastle/jce/provider/PKIXPolicyNode;[Ljava/util/List;IZ)Lorg/bouncycastle/jce/provider/PKIXPolicyNode;
    ...
    invoke-static {v5, v6}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->getExtensionValue(Ljava/security/cert/X509Extension;Ljava/lang/String;)Lf0;
    ...
    invoke-static {v9}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->getQualifierSet(Lh0;)Ljava/util/Set;

    move-result-object v9
    :try_end_1
    .catch Ljava/security/cert/CertPathValidatorException; {:try_start_1 .. :try_end_1} :catch_0

    invoke-static {v14, v3, v11, v9}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->processCertD1i(I[Ljava/util/List;Lb0;Ljava/util/Set;)Z

    move-result v10

    if-nez v10, :cond_0

    invoke-static {v14, v3, v11, v9}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->processCertD1ii(I[Ljava/util/List;Lb0;Ljava/util/Set;)V
    ...
    invoke-static {v2}, Lmk3;->r(Ljava/lang/Object;)Lmk3;

    move-result-object v2

    invoke-virtual {v2}, Lmk3;->s()Lb0;
    ...
    invoke-virtual {v2}, Lmk3;->t()Lh0;

    move-result-object v1

    invoke-static {v1}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->getQualifierSet(Lh0;)Ljava/util/Set;
...
.method public static wrapupCertG(Ljava/security/cert/CertPath;LH33;Ljava/util/Set;I[Ljava/util/List;Lorg/bouncycastle/jce/provider/PKIXPolicyNode;Ljava/util/Set;)Lorg/bouncycastle/jce/provider/PKIXPolicyNode;
    .locals 6
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/cert/CertPathValidatorException;
