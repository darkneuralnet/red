...
.method public constructor <init>(Z)V
    ...
    iput-object v0, p0, Lorg/bouncycastle/jce/provider/PKIXCertPathValidatorSpi_8;->helper:LtP1;
...
.method public static checkCertificate(Ljava/security/cert/X509Certificate;)V
    ...
    invoke-interface {p0}, LJq;->getTBSCertificateNative()LFa5;
    ...
    invoke-static {p0}, LFa5;->t(Ljava/lang/Object;)LFa5;
    :try_end_1
...
.method public engineGetRevocationChecker()Ljava/security/cert/PKIXCertPathChecker;
    ...
    iget-object v1, p0, Lorg/bouncycastle/jce/provider/PKIXCertPathValidatorSpi_8;->helper:LtP1;
...
.method public engineValidate(Ljava/security/cert/CertPath;Ljava/security/cert/CertPathParameters;)Ljava/security/cert/CertPathValidatorResult;
    ...
    invoke-direct {v2, v3}, LH33$b;-><init>(Ljava/security/cert/PKIXParameters;)V

    instance-of v3, v0, LHY0;

    if-eqz v3, :cond_0

    check-cast v0, LHY0;

    invoke-virtual {v0}, LHY0;->h()Z

    move-result v3

    invoke-virtual {v2, v3}, LH33$b;->s(Z)LH33$b;

    invoke-virtual {v0}, LHY0;->g()I

    move-result v0

    invoke-virtual {v2, v0}, LH33$b;->t(I)LH33$b;
    ...
    :cond_1
    instance-of v2, v0, LG33;

    if-eqz v2, :cond_2

    check-cast v0, LG33;

    invoke-virtual {v0}, LG33;->a()LH33;
    ...
    :goto_0
    invoke-virtual {v0}, LH33;->y()Ljava/util/Set;
    ...
    invoke-static {v0, v2}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->getValidityDate(LH33;Ljava/util/Date;)Ljava/util/Date;

    move-result-object v15

    invoke-virtual {v0}, LH33;->s()Ljava/util/Set;
    ...
    invoke-virtual {v0}, LH33;->w()Ljava/lang/String;
    ...
    invoke-direct {v2, v0}, LH33$b;-><init>(LH33;)V

    invoke-virtual {v2, v9}, LH33$b;->r(Ljava/security/cert/TrustAnchor;)LH33$b;
    ...
    invoke-virtual {v0}, LH33;->p()Ljava/util/List;
    ...
    iget-object v2, v1, Lorg/bouncycastle/jce/provider/PKIXCertPathValidatorSpi_8;->helper:LtP1;

    invoke-direct {v4, v2}, Lorg/bouncycastle/jce/provider/ProvRevocationChecker;-><init>(LtP1;)V
    ...
    :try_start_1
    invoke-static/range {v21 .. v21}, Lorg/bouncycastle/jce/provider/PrincipalUtils;->getSubjectPrincipal(Ljava/security/cert/X509Certificate;)LGN5;
    ...
    :cond_c
    invoke-static {v9}, Lorg/bouncycastle/jce/provider/PrincipalUtils;->getCA(Ljava/security/cert/TrustAnchor;)LGN5;
    ...
    :goto_5
    :try_start_2
    invoke-static/range {v23 .. v23}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->getAlgorithmIdentifier(Ljava/security/PublicKey;)Ln8;
    ...
    invoke-virtual {v3}, Ln8;->v()LS;

    invoke-virtual {v0}, LH33;->x()LF33;
    ...
    invoke-virtual {v3, v10}, LF33;->match(Ljava/security/cert/Certificate;)Z
    ...
    invoke-static/range {v2 .. v10}, Lorg/bouncycastle/jce/provider/RFC3280CertPathUtilities;->processCertA(Ljava/security/cert/CertPath;LH33;Ljava/util/Date;LC33;ILjava/security/PublicKey;ZLGN5;Ljava/security/cert/X509Certificate;)V
    ...
    invoke-static {v13}, Lorg/bouncycastle/jce/provider/PrincipalUtils;->getSubjectPrincipal(Ljava/security/cert/X509Certificate;)LGN5;
    ...
    iget-object v14, v1, Lorg/bouncycastle/jce/provider/PKIXCertPathValidatorSpi_8;->helper:LtP1;

    invoke-static {v8, v9, v14}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->getNextWorkingKey(Ljava/util/List;ILtP1;)Ljava/security/PublicKey;

    move-result-object v8
    :try_end_4
    .catch Ljava/security/cert/CertPathValidatorException; {:try_start_4 .. :try_end_4} :catch_0

    invoke-static {v8}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->getAlgorithmIdentifier(Ljava/security/PublicKey;)Ln8;

    move-result-object v14

    invoke-virtual {v14}, Ln8;->r()Lb0;

    invoke-virtual {v14}, Ln8;->v()LS;
    ...
    invoke-static/range {v2 .. v8}, Lorg/bouncycastle/jce/provider/RFC3280CertPathUtilities;->wrapupCertG(Ljava/security/cert/CertPath;LH33;Ljava/util/Set;I[Ljava/util/List;Lorg/bouncycastle/jce/provider/PKIXPolicyNode;Ljava/util/Set;)Lorg/bouncycastle/jce/provider/PKIXPolicyNode;
