...
.method private static getAsymmetricKeyInfoConverter(Lb0;)Lorg/bouncycastle/jcajce/provider/util/AsymmetricKeyInfoConverter;
    .locals 1
...
.method public static getPrivateKey(LXq3;)Ljava/security/PrivateKey;
    .locals 1
    ...
    invoke-static {v0}, Lorg/bouncycastle/jce/provider/BouncyCastleProvider;->getAsymmetricKeyInfoConverter(Lb0;)Lorg/bouncycastle/jcajce/provider/util/AsymmetricKeyInfoConverter;
    ...
    :cond_0
    invoke-interface {v0, p0}, Lorg/bouncycastle/jcajce/provider/util/AsymmetricKeyInfoConverter;->generatePrivate(LXq3;)Ljava/security/PrivateKey;
...
.method public static getPublicKey(LL65;)Ljava/security/PublicKey;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    :cond_0
    invoke-interface {v0, p0}, Lorg/bouncycastle/jcajce/provider/util/AsymmetricKeyInfoConverter;->generatePublic(LL65;)Ljava/security/PublicKey;
...
.method private loadPQCKeys()V
    ...
    invoke-virtual {p0, v0, v1}, Lorg/bouncycastle/jce/provider/BouncyCastleProvider;->addKeyInfoConverter(Lb0;Lorg/bouncycastle/jcajce/provider/util/AsymmetricKeyInfoConverter;)V
    ...
    sget-object v0, LK33;->w:Lb0;

    new-instance v1, LDO5;

    invoke-direct {v1}, LDO5;-><init>()V
...
# virtual methods
.method public addAlgorithm(Ljava/lang/String;Lb0;Ljava/lang/String;)V
    .locals 2
...
.method public addKeyInfoConverter(Lb0;Lorg/bouncycastle/jcajce/provider/util/AsymmetricKeyInfoConverter;)V
    .locals 1
...
.method public getKeyInfoConverter(Lb0;)Lorg/bouncycastle/jcajce/provider/util/AsymmetricKeyInfoConverter;
    .locals 1
