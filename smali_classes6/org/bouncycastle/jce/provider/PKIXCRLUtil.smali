...
.method public static findCRLs(LB33;Ljava/util/Date;Ljava/util/List;Ljava/util/List;)Ljava/util/Set;
    .locals 3
    ...
    :try_start_0
    invoke-static {v0, p0, p3}, Lorg/bouncycastle/jce/provider/PKIXCRLUtil;->findCRLs(Ljava/util/HashSet;LB33;Ljava/util/List;)V

    invoke-static {v0, p0, p2}, Lorg/bouncycastle/jce/provider/PKIXCRLUtil;->findCRLs(Ljava/util/HashSet;LB33;Ljava/util/List;)V
    :try_end_0
    ...
    :cond_1
    invoke-virtual {p0}, LB33;->c()Ljava/security/cert/X509Certificate;
...
.method private static findCRLs(Ljava/util/HashSet;LB33;Ljava/util/List;)V
    .locals 6
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/bouncycastle/jce/provider/AnnotatedException;
    ...
    :try_start_0
    invoke-interface {v2, p1}, Li55;->getMatches(LsI4;)Ljava/util/Collection;
    ...
    :try_start_1
    invoke-static {p1, v2}, LB33;->b(LB33;Ljava/security/cert/CertStore;)Ljava/util/Collection;
