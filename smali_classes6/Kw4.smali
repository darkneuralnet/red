...
.method public a()V
    ...
    :try_start_0
    iget-object v4, p0, LKw4;->a:LIG2;

    sget-object v5, LeT0;->a:LeT0;

    invoke-interface {v4, v5}, LIG2;->onSubscribe(LuL0;)V
    :try_end_0
    ...
    invoke-interface {v4, v0}, LIG2;->onError(Ljava/lang/Throwable;)V
    :try_end_1
    ...
    invoke-static {v5}, Leu4;->u(Ljava/lang/Throwable;)V
...
.method public b()V
    ...
    invoke-interface {v4, v1}, LIG2;->onError(Ljava/lang/Throwable;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public onError(Ljava/lang/Throwable;)V
    ...
    :try_start_0
    iget-object v5, p0, LKw4;->a:LIG2;

    sget-object v6, LeT0;->a:LeT0;

    invoke-interface {v5, v6}, LIG2;->onSubscribe(LuL0;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_1
    ...
    invoke-interface {v5, v6}, LIG2;->onError(Ljava/lang/Throwable;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    invoke-static {v6}, Leu4;->u(Ljava/lang/Throwable;)V
    ...
    :cond_2
    :try_start_2
    iget-object v1, p0, LKw4;->a:LIG2;

    invoke-interface {v1, p1}, LIG2;->onError(Ljava/lang/Throwable;)V
    :try_end_2
    ...
    invoke-static {v4}, Leu4;->u(Ljava/lang/Throwable;)V
...
.method public onNext(Ljava/lang/Object;)V
    ...
    :try_start_0
    iget-object v3, p0, LKw4;->b:LuL0;

    invoke-interface {v3}, LuL0;->dispose()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    invoke-virtual {p0, p1}, LKw4;->onError(Ljava/lang/Throwable;)V
    ...
    invoke-virtual {p0, v4}, LKw4;->onError(Ljava/lang/Throwable;)V

    return-void

    :cond_2
    :try_start_1
    iget-object v3, p0, LKw4;->a:LIG2;

    invoke-interface {v3, p1}, LIG2;->onNext(Ljava/lang/Object;)V
    :try_end_1
