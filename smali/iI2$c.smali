...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = LiI2;->setCurrentLocation(Lco/bird/android/model/wire/WireLocation;D)V
.end annotation
...
# direct methods
.method public constructor <init>(Lco/bird/android/model/wire/WireLocation;LiI2;D)V
    .locals 0

    iput-object p1, p0, LiI2$c;->a:Lco/bird/android/model/wire/WireLocation;

    iput-object p2, p0, LiI2$c;->b:LiI2;

    iput-wide p3, p0, LiI2$c;->c:D
...
.method public bridge synthetic invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, LiI2$c;->invoke(LEj1;)V
...
.method public final invoke(LEj1;)V
    ...
    iget-object v1, p0, LiI2$c;->a:Lco/bird/android/model/wire/WireLocation;

    invoke-virtual {v1}, Lco/bird/android/model/wire/WireLocation;->getLatitude()D

    move-result-wide v1

    iget-object v3, p0, LiI2$c;->a:Lco/bird/android/model/wire/WireLocation;
    ...
    iget-object v1, p0, LiI2$c;->b:LiI2;

    invoke-static {v1}, LiI2;->access$getCircleMarker$p(LiI2;)Lwb0;
    ...
    iget-object v3, p0, LiI2$c;->b:LiI2;
    ...
    invoke-static {v1, v2}, LiI2;->access$setLocationMarker$p(LiI2;LQf2;)V
    ...
    iget-object v2, p0, LiI2$c;->b:LiI2;
    ...
    invoke-static {v1, v0}, LiI2;->access$setCircleMarker$p(LiI2;Lwb0;)V
    ...
    invoke-static {v1}, LiI2;->access$getLocationMarker$p(LiI2;)LQf2;
    ...
    :goto_1
    iget-object v0, p0, LiI2$c;->b:LiI2;

    invoke-static {v0}, LiI2;->access$getBinding$p(LiI2;)LHI2;

    move-result-object v0

    iget-object v0, v0, LHI2;->c:Landroid/widget/LinearLayout;
