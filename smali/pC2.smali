...
.method public constructor <init>(Landroid/app/NotificationChannelGroup;)V
    ...
    invoke-direct {p0, p1, v0}, LpC2;-><init>(Landroid/app/NotificationChannelGroup;Ljava/util/List;)V
...
.method public constructor <init>(Landroid/app/NotificationChannelGroup;Ljava/util/List;)V
    ...
    invoke-direct {p0, v0}, LpC2;-><init>(Ljava/lang/String;)V

    invoke-virtual {p1}, Landroid/app/NotificationChannelGroup;->getName()Ljava/lang/CharSequence;

    move-result-object v0

    iput-object v0, p0, LpC2;->b:Ljava/lang/CharSequence;
    ...
    iput-object v2, p0, LpC2;->c:Ljava/lang/String;
    ...
    iput-boolean p2, p0, LpC2;->d:Z

    invoke-virtual {p1}, Landroid/app/NotificationChannelGroup;->getChannels()Ljava/util/List;

    move-result-object p1

    invoke-virtual {p0, p1}, LpC2;->a(Ljava/util/List;)Ljava/util/List;

    move-result-object p1

    iput-object p1, p0, LpC2;->e:Ljava/util/List;

    goto :goto_0

    :cond_1
    invoke-virtual {p0, p2}, LpC2;->a(Ljava/util/List;)Ljava/util/List;
...
.method public final a(Ljava/util/List;)Ljava/util/List;
    ...
    iget-object v2, p0, LpC2;->a:Ljava/lang/String;
    ...
    invoke-direct {v2, v1}, LoC2;-><init>(Landroid/app/NotificationChannel;)V
...
.method public b()Landroid/app/NotificationChannelGroup;
    ...
    iget-object v3, p0, LpC2;->b:Ljava/lang/CharSequence;
    ...
    iget-object v0, p0, LpC2;->c:Ljava/lang/String;
