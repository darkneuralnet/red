...
.method public constructor <init>(Landroid/widget/CheckedTextView;)V
    ...
    iput-object v0, p0, Lyd;->b:Landroid/content/res/ColorStateList;

    iput-object v0, p0, Lyd;->c:Landroid/graphics/PorterDuff$Mode;

    const/4 v0, 0x0

    iput-boolean v0, p0, Lyd;->d:Z

    iput-boolean v0, p0, Lyd;->e:Z

    iput-object p1, p0, Lyd;->a:Landroid/widget/CheckedTextView;
...
.method public a()V
    ...
    iget-object v0, p0, Lyd;->a:Landroid/widget/CheckedTextView;

    invoke-static {v0}, LDa0;->a(Landroid/widget/CheckedTextView;)Landroid/graphics/drawable/Drawable;

    move-result-object v0

    if-eqz v0, :cond_4

    iget-boolean v1, p0, Lyd;->d:Z
    ...
    iget-object v1, p0, Lyd;->b:Landroid/content/res/ColorStateList;
    ...
    iget-object v1, p0, Lyd;->c:Landroid/graphics/PorterDuff$Mode;
    ...
    iget-object v1, p0, Lyd;->a:Landroid/widget/CheckedTextView;
...
.method public b(Landroid/util/AttributeSet;I)V
    ...
    sget-object v3, LDF3;->CheckedTextView:[I
    ...
    :try_start_0
    sget p1, LDF3;->CheckedTextView_checkMarkCompat:I
    ...
    :try_start_1
    iget-object p2, p0, Lyd;->a:Landroid/widget/CheckedTextView;
    ...
    :try_start_2
    sget p1, LDF3;->CheckedTextView_android_checkMark:I
    ...
    :cond_1
    sget p1, LDF3;->CheckedTextView_checkMarkTint:I
    ...
    invoke-static {p2, p1}, LDa0;->b(Landroid/widget/CheckedTextView;Landroid/content/res/ColorStateList;)V

    :cond_2
    sget p1, LDF3;->CheckedTextView_checkMarkTintMode:I
    ...
    invoke-static {p2, p1}, LDa0;->c(Landroid/widget/CheckedTextView;Landroid/graphics/PorterDuff$Mode;)V
    :try_end_2
...
.method public d(Landroid/content/res/ColorStateList;)V
    ...
    iput-object p1, p0, Lyd;->b:Landroid/content/res/ColorStateList;

    const/4 p1, 0x1

    iput-boolean p1, p0, Lyd;->d:Z
...
.method public e(Landroid/graphics/PorterDuff$Mode;)V
    ...
    iput-object p1, p0, Lyd;->c:Landroid/graphics/PorterDuff$Mode;

    const/4 p1, 0x1

    iput-boolean p1, p0, Lyd;->e:Z
