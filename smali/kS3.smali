...
# static fields
.field public static final h:LkS3$a;
...
.method public static constructor <clinit>()V
    ...
    new-instance v0, LkS3$a;

    const/4 v1, 0x0

    invoke-direct {v0, v1}, LkS3$a;-><init>(Lkotlin/jvm/internal/DefaultConstructorMarker;)V

    sput-object v0, LkS3;->h:LkS3$a;
    ...
    sput-object v0, LkS3;->i:Lorg/joda/time/format/DateTimeFormatter;
    ...
    sput-object v0, LkS3;->j:Lorg/joda/time/format/DateTimeFormatter;
...
.method public static final synthetic access$getDATE_FORMATTER$cp()Lorg/joda/time/format/DateTimeFormatter;
    ...
    sget-object v0, LkS3;->j:Lorg/joda/time/format/DateTimeFormatter;
...
.method public static final synthetic access$getTIME_FORMATTER$cp()Lorg/joda/time/format/DateTimeFormatter;
    ...
    sget-object v0, LkS3;->i:Lorg/joda/time/format/DateTimeFormatter;
...
# virtual methods
.method public C(LXG0;)Ljava/lang/String;
    .locals 1
...
.method public bridge synthetic getId(Ljava/lang/Object;)Ljava/lang/String;
    ...
    invoke-virtual {p0, p1}, LkS3;->C(LXG0;)Ljava/lang/String;
...
.method public onCreateViewHolder(Landroid/view/ViewGroup;I)Landroidx/recyclerview/widget/RecyclerView$C;
    ...
    new-instance p2, LkS3$b;

    invoke-virtual {p0}, LaN3;->n()Landroid/content/Context;

    move-result-object v0

    sget v1, LaD3;->item_rental_date:I
    ...
    invoke-direct {p2, p0, p1, p0}, LkS3$b;-><init>(LkS3;Landroid/view/View;LkS3;)V
