...
# direct methods
.method public constructor <init>(LqC2$e;)V
    .locals 13
    ...
    iput-object v0, p0, LrC2;->f:Ljava/util/List;

    new-instance v0, Landroid/os/Bundle;

    invoke-direct {v0}, Landroid/os/Bundle;-><init>()V

    iput-object v0, p0, LrC2;->g:Landroid/os/Bundle;

    iput-object p1, p0, LrC2;->c:LqC2$e;

    iget-object v0, p1, LqC2$e;->a:Landroid/content/Context;

    iput-object v0, p0, LrC2;->a:Landroid/content/Context;
    ...
    iget-object v3, p1, LqC2$e;->a:Landroid/content/Context;

    iget-object v4, p1, LqC2$e;->L:Ljava/lang/String;

    invoke-direct {v2, v3, v4}, Landroid/app/Notification$Builder;-><init>(Landroid/content/Context;Ljava/lang/String;)V

    iput-object v2, p0, LrC2;->b:Landroid/app/Notification$Builder;
    ...
    :goto_0
    iget-object v2, p1, LqC2$e;->T:Landroid/app/Notification;

    iget-object v3, p0, LrC2;->b:Landroid/app/Notification$Builder;
    ...
    iget-object v5, p1, LqC2$e;->i:Landroid/widget/RemoteViews;
    ...
    iget-object v4, p1, LqC2$e;->e:Ljava/lang/CharSequence;

    invoke-virtual {v3, v4}, Landroid/app/Notification$Builder;->setContentTitle(Ljava/lang/CharSequence;)Landroid/app/Notification$Builder;

    move-result-object v3

    iget-object v4, p1, LqC2$e;->f:Ljava/lang/CharSequence;

    invoke-virtual {v3, v4}, Landroid/app/Notification$Builder;->setContentText(Ljava/lang/CharSequence;)Landroid/app/Notification$Builder;

    move-result-object v3

    iget-object v4, p1, LqC2$e;->k:Ljava/lang/CharSequence;

    invoke-virtual {v3, v4}, Landroid/app/Notification$Builder;->setContentInfo(Ljava/lang/CharSequence;)Landroid/app/Notification$Builder;

    move-result-object v3

    iget-object v4, p1, LqC2$e;->g:Landroid/app/PendingIntent;
    ...
    iget-object v4, p1, LqC2$e;->h:Landroid/app/PendingIntent;
    ...
    iget-object v4, p1, LqC2$e;->j:Landroid/graphics/Bitmap;
    ...
    iget v4, p1, LqC2$e;->l:I

    invoke-virtual {v3, v4}, Landroid/app/Notification$Builder;->setNumber(I)Landroid/app/Notification$Builder;

    move-result-object v3

    iget v4, p1, LqC2$e;->u:I

    iget v9, p1, LqC2$e;->v:I

    iget-boolean v10, p1, LqC2$e;->w:Z
    ...
    iget-object v4, p0, LrC2;->b:Landroid/app/Notification$Builder;
    ...
    iget-object v0, p0, LrC2;->b:Landroid/app/Notification$Builder;

    iget-object v8, p1, LqC2$e;->r:Ljava/lang/CharSequence;
    ...
    check-cast v8, LqC2$a;

    invoke-virtual {p0, v8}, LrC2;->b(LqC2$a;)V

    goto :goto_5

    :cond_6
    iget-object v0, p1, LqC2$e;->E:Landroid/os/Bundle;

    if-eqz v0, :cond_7

    iget-object v8, p0, LrC2;->g:Landroid/os/Bundle;
    ...
    iget-boolean v0, p1, LqC2$e;->A:Z

    if-eqz v0, :cond_8

    iget-object v0, p0, LrC2;->g:Landroid/os/Bundle;
    ...
    :cond_8
    iget-object v0, p1, LqC2$e;->x:Ljava/lang/String;
    ...
    :cond_a
    :goto_6
    iget-object v0, p1, LqC2$e;->z:Ljava/lang/String;
    ...
    :cond_b
    iget-object v0, p1, LqC2$e;->I:Landroid/widget/RemoteViews;

    iput-object v0, p0, LrC2;->d:Landroid/widget/RemoteViews;

    iget-object v0, p1, LqC2$e;->J:Landroid/widget/RemoteViews;

    iput-object v0, p0, LrC2;->e:Landroid/widget/RemoteViews;
    ...
    iget-object v8, p0, LrC2;->b:Landroid/app/Notification$Builder;

    iget-boolean v9, p1, LqC2$e;->n:Z
    ...
    iget-object v8, p1, LqC2$e;->c:Ljava/util/ArrayList;

    invoke-static {v8}, LrC2;->g(Ljava/util/List;)Ljava/util/List;

    move-result-object v8

    iget-object v9, p1, LqC2$e;->W:Ljava/util/ArrayList;

    invoke-static {v8, v9}, LrC2;->e(Ljava/util/List;Ljava/util/List;)Ljava/util/List;
    ...
    iget-object v9, p0, LrC2;->g:Landroid/os/Bundle;
    ...
    iget-object v0, p1, LqC2$e;->c:Ljava/util/ArrayList;

    invoke-static {v0}, LrC2;->g(Ljava/util/List;)Ljava/util/List;

    move-result-object v0

    iget-object v3, p1, LqC2$e;->W:Ljava/util/ArrayList;

    invoke-static {v0, v3}, LrC2;->e(Ljava/util/List;Ljava/util/List;)Ljava/util/List;
    ...
    :cond_10
    iget-object v0, p1, LqC2$e;->W:Ljava/util/ArrayList;
    ...
    :cond_11
    iget-object v0, p1, LqC2$e;->K:Landroid/widget/RemoteViews;

    iput-object v0, p0, LrC2;->i:Landroid/widget/RemoteViews;

    iget-object v0, p1, LqC2$e;->d:Ljava/util/ArrayList;
    ...
    invoke-virtual {p1}, LqC2$e;->g()Landroid/os/Bundle;
    ...
    :goto_9
    iget-object v11, p1, LqC2$e;->d:Ljava/util/ArrayList;
    ...
    iget-object v12, p1, LqC2$e;->d:Ljava/util/ArrayList;

    invoke-virtual {v12, v10}, Ljava/util/ArrayList;->get(I)Ljava/lang/Object;

    move-result-object v12

    check-cast v12, LqC2$a;

    invoke-static {v12}, LsC2;->b(LqC2$a;)Landroid/os/Bundle;
    ...
    iget-object v3, p1, LqC2$e;->V:Landroid/graphics/drawable/Icon;
    ...
    iget-object v3, p1, LqC2$e;->I:Landroid/widget/RemoteViews;
    ...
    :cond_16
    iget-object v3, p1, LqC2$e;->J:Landroid/widget/RemoteViews;
    ...
    :cond_17
    iget-object v3, p1, LqC2$e;->K:Landroid/widget/RemoteViews;
    ...
    iget-object v7, p0, LrC2;->b:Landroid/app/Notification$Builder;

    invoke-virtual {v4}, Lfg3;->h()Landroid/app/Person;
    ...
    iget-object v7, p1, LqC2$e;->S:LqC2$d;

    invoke-static {v7}, LqC2$d;->a(LqC2$d;)Landroid/app/Notification$BubbleMetadata;
    ...
    :cond_1d
    iget-boolean p1, p1, LqC2$e;->U:Z

    if-eqz p1, :cond_20

    iget-object p1, p0, LrC2;->c:LqC2$e;

    iget-boolean p1, p1, LqC2$e;->y:Z
    ...
    :goto_b
    iget-object p1, p0, LrC2;->b:Landroid/app/Notification$Builder;
    ...
    iget-object v2, p0, LrC2;->b:Landroid/app/Notification$Builder;
    ...
    iget-object p1, p1, LqC2$e;->x:Ljava/lang/String;
...
.method public static e(Ljava/util/List;Ljava/util/List;)Ljava/util/List;
    ...
    invoke-virtual {v0, p0}, LSk;->addAll(Ljava/util/Collection;)Z
...
.method public static g(Ljava/util/List;)Ljava/util/List;
    ...
    invoke-virtual {v1}, Lfg3;->g()Ljava/lang/String;
...
.method public final b(LqC2$a;)V
    .locals 5
    ...
    :goto_0
    invoke-virtual {p1}, LqC2$a;->i()Ljava/lang/CharSequence;

    move-result-object v2

    invoke-virtual {p1}, LqC2$a;->a()Landroid/app/PendingIntent;
    ...
    :goto_2
    invoke-virtual {p1}, LqC2$a;->f()[LIR3;
    ...
    invoke-static {v1}, LIR3;->b([LIR3;)[Landroid/app/RemoteInput;
    ...
    :cond_3
    invoke-virtual {p1}, LqC2$a;->d()Landroid/os/Bundle;
    ...
    iget-object v0, p0, LrC2;->f:Ljava/util/List;

    iget-object v1, p0, LrC2;->b:Landroid/app/Notification$Builder;

    invoke-static {v1, p1}, LsC2;->f(Landroid/app/Notification$Builder;LqC2$a;)Landroid/os/Bundle;
...
.method public c()Landroid/app/Notification;
    ...
    iget-object v0, p0, LrC2;->c:LqC2$e;

    iget-object v0, v0, LqC2$e;->q:LqC2$h;

    if-eqz v0, :cond_0

    invoke-virtual {v0, p0}, LqC2$h;->apply(LnC2;)V

    :cond_0
    if-eqz v0, :cond_1

    invoke-virtual {v0, p0}, LqC2$h;->makeContentView(LnC2;)Landroid/widget/RemoteViews;
    ...
    :goto_0
    invoke-virtual {p0}, LrC2;->d()Landroid/app/Notification;
    ...
    :cond_2
    iget-object v1, p0, LrC2;->c:LqC2$e;

    iget-object v1, v1, LqC2$e;->I:Landroid/widget/RemoteViews;
    ...
    invoke-virtual {v0, p0}, LqC2$h;->makeBigContentView(LnC2;)Landroid/widget/RemoteViews;
    ...
    iget-object v4, p0, LrC2;->c:LqC2$e;

    iget-object v4, v4, LqC2$e;->q:LqC2$h;

    invoke-virtual {v4, p0}, LqC2$h;->makeHeadsUpContentView(LnC2;)Landroid/widget/RemoteViews;
    ...
    invoke-static {v2}, LqC2;->a(Landroid/app/Notification;)Landroid/os/Bundle;

    move-result-object v1

    if-eqz v1, :cond_6

    invoke-virtual {v0, v1}, LqC2$h;->addCompatExtras(Landroid/os/Bundle;)V
...
.method public d()Landroid/app/Notification;
    ...
    invoke-virtual {p0, v0}, LrC2;->h(Landroid/app/Notification;)V
    ...
    iget-object v1, p0, LrC2;->g:Landroid/os/Bundle;
    ...
    iget-object v1, p0, LrC2;->d:Landroid/widget/RemoteViews;
    ...
    :cond_4
    iget-object v1, p0, LrC2;->e:Landroid/widget/RemoteViews;
    ...
    :cond_5
    iget-object v1, p0, LrC2;->i:Landroid/widget/RemoteViews;
    ...
    invoke-static {v0}, LsC2;->a(Ljava/util/List;)Landroid/util/SparseArray;
    ...
    invoke-static {v0}, LqC2;->a(Landroid/app/Notification;)Landroid/os/Bundle;

    move-result-object v1

    new-instance v3, Landroid/os/Bundle;

    iget-object v4, p0, LrC2;->g:Landroid/os/Bundle;
    ...
    iget-object v1, p0, LrC2;->f:Ljava/util/List;

    invoke-static {v1}, LsC2;->a(Ljava/util/List;)Landroid/util/SparseArray;
...
.method public f()Landroid/content/Context;
    ...
    iget-object v0, p0, LrC2;->a:Landroid/content/Context;
