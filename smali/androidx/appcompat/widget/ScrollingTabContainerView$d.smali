...
.method public constructor <init>(Landroidx/appcompat/widget/ScrollingTabContainerView;Landroid/content/Context;Landroidx/appcompat/app/ActionBar$b;Z)V
    ...
    sget p1, Ljz3;->actionBarTabStyle:I
    ...
    invoke-static {p2, v0, v1, p1, v3}, LEi5;->v(Landroid/content/Context;Landroid/util/AttributeSet;[III)LEi5;

    move-result-object p1

    invoke-virtual {p1, v3}, LEi5;->s(I)Z

    move-result p2

    if-eqz p2, :cond_0

    invoke-virtual {p1, v3}, LEi5;->g(I)Landroid/graphics/drawable/Drawable;
...
.method public c()V
    ...
    sget v9, Ljz3;->actionBarTabTextStyle:I
    ...
    :goto_2
    invoke-static {p0, v3}, Lnj5;->a(Landroid/view/View;Ljava/lang/CharSequence;)V
