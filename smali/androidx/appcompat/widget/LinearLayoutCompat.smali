...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    sget-object v6, LDF3;->LinearLayoutCompat:[I

    invoke-static {p1, p2, v6, p3, v2}, LEi5;->v(Landroid/content/Context;Landroid/util/AttributeSet;[III)LEi5;

    move-result-object v3

    invoke-virtual {v3}, LEi5;->r()Landroid/content/res/TypedArray;
    ...
    sget p1, LDF3;->LinearLayoutCompat_android_orientation:I

    invoke-virtual {v3, p1, v1}, LEi5;->k(II)I
    ...
    :cond_0
    sget p1, LDF3;->LinearLayoutCompat_android_gravity:I
    ...
    :cond_1
    sget p1, LDF3;->LinearLayoutCompat_android_baselineAligned:I

    invoke-virtual {v3, p1, v0}, LEi5;->a(IZ)Z
    ...
    :cond_2
    sget p1, LDF3;->LinearLayoutCompat_android_weightSum:I

    const/high16 p2, -0x40800000    # -1.0f

    invoke-virtual {v3, p1, p2}, LEi5;->i(IF)F

    move-result p1

    iput p1, p0, Landroidx/appcompat/widget/LinearLayoutCompat;->mWeightSum:F

    sget p1, LDF3;->LinearLayoutCompat_android_baselineAlignedChildIndex:I
    ...
    sget p1, LDF3;->LinearLayoutCompat_measureWithLargestChild:I

    invoke-virtual {v3, p1, v2}, LEi5;->a(IZ)Z

    move-result p1

    iput-boolean p1, p0, Landroidx/appcompat/widget/LinearLayoutCompat;->mUseLargestChild:Z

    sget p1, LDF3;->LinearLayoutCompat_divider:I

    invoke-virtual {v3, p1}, LEi5;->g(I)Landroid/graphics/drawable/Drawable;

    move-result-object p1

    invoke-virtual {p0, p1}, Landroidx/appcompat/widget/LinearLayoutCompat;->setDividerDrawable(Landroid/graphics/drawable/Drawable;)V

    sget p1, LDF3;->LinearLayoutCompat_showDividers:I

    invoke-virtual {v3, p1, v2}, LEi5;->k(II)I

    move-result p1

    iput p1, p0, Landroidx/appcompat/widget/LinearLayoutCompat;->mShowDividers:I

    sget p1, LDF3;->LinearLayoutCompat_dividerPadding:I

    invoke-virtual {v3, p1, v2}, LEi5;->f(II)I

    move-result p1

    iput p1, p0, Landroidx/appcompat/widget/LinearLayoutCompat;->mDividerPadding:I

    invoke-virtual {v3}, LEi5;->w()V
...
.method public layoutHorizontal(IIII)V
    ...
    invoke-static {v2, v1}, LCk1;->b(II)I
...
.method public layoutVertical(IIII)V
    ...
    invoke-static {v1, v2}, LCk1;->b(II)I
