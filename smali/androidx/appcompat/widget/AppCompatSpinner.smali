...
.field private mForwardingListener:LZd1;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;IILandroid/content/res/Resources$Theme;)V
    ...
    invoke-static {p0, v0}, LWg5;->a(Landroid/view/View;Landroid/content/Context;)V

    sget-object v0, LDF3;->Spinner:[I
    ...
    invoke-direct {v2, p1, p5}, LWp0;-><init>(Landroid/content/Context;Landroid/content/res/Resources$Theme;)V
    ...
    :cond_0
    sget p5, LDF3;->Spinner_popupTheme:I

    invoke-virtual {v0, p5, v1}, LEi5;->n(II)I
    ...
    invoke-direct {v2, p1, p5}, LWp0;-><init>(Landroid/content/Context;I)V
    ...
    sget-object v4, LDF3;->Spinner:[I

    invoke-static {v3, p2, v4, p3, v1}, LEi5;->v(Landroid/content/Context;Landroid/util/AttributeSet;[III)LEi5;

    move-result-object v1

    sget v3, LDF3;->Spinner_android_dropDownWidth:I

    const/4 v4, -0x2

    invoke-virtual {v1, v3, v4}, LEi5;->m(II)I

    move-result v3

    iput v3, p0, Landroidx/appcompat/widget/AppCompatSpinner;->mDropDownWidth:I

    sget v3, LDF3;->Spinner_android_popupBackground:I

    invoke-virtual {v1, v3}, LEi5;->g(I)Landroid/graphics/drawable/Drawable;

    move-result-object v3

    invoke-virtual {p4, v3}, Landroidx/appcompat/widget/ListPopupWindow;->a(Landroid/graphics/drawable/Drawable;)V

    sget v3, LDF3;->Spinner_android_prompt:I

    invoke-virtual {v0, v3}, LEi5;->o(I)Ljava/lang/String;

    move-result-object v3

    invoke-virtual {p4, v3}, Landroidx/appcompat/widget/AppCompatSpinner$e;->o(Ljava/lang/CharSequence;)V
    ...
    iput-object v1, p0, Landroidx/appcompat/widget/AppCompatSpinner;->mForwardingListener:LZd1;
    ...
    sget v1, LDF3;->Spinner_android_prompt:I

    invoke-virtual {v0, v1}, LEi5;->o(I)Ljava/lang/String;

    move-result-object v1

    invoke-interface {p4, v1}, Landroidx/appcompat/widget/AppCompatSpinner$f;->o(Ljava/lang/CharSequence;)V

    :goto_5
    sget p4, LDF3;->Spinner_android_entries:I

    invoke-virtual {v0, p4}, LEi5;->q(I)[Ljava/lang/CharSequence;
    ...
    sget p1, LYD3;->support_simple_spinner_dropdown_item:I
...
.method public getPopupBackground()Landroid/graphics/drawable/Drawable;
    ...
    invoke-interface {v0}, Landroidx/appcompat/widget/AppCompatSpinner$f;->e()Landroid/graphics/drawable/Drawable;
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/AppCompatSpinner;->mForwardingListener:LZd1;

    if-eqz v0, :cond_0

    invoke-virtual {v0, p0, p1}, LZd1;->onTouch(Landroid/view/View;Landroid/view/MotionEvent;)Z
...
.method public setPrompt(Ljava/lang/CharSequence;)V
    ...
    invoke-interface {v0, p1}, Landroidx/appcompat/widget/AppCompatSpinner$f;->o(Ljava/lang/CharSequence;)V
...
.method public showPopup()V
    ...
    invoke-interface {v0, v1, v2}, Landroidx/appcompat/widget/AppCompatSpinner$f;->h(II)V
    ...
    invoke-interface {v0, v1, v1}, Landroidx/appcompat/widget/AppCompatSpinner$f;->h(II)V
