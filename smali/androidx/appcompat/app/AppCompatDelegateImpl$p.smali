...
.method public constructor <init>(Landroidx/appcompat/app/AppCompatDelegateImpl;Landroid/view/Window$Callback;)V
    ...
    invoke-direct {p0, p2}, LRI5;-><init>(Landroid/view/Window$Callback;)V
...
.method public final c(Landroid/view/ActionMode$Callback;)Landroid/view/ActionMode;
    ...
    invoke-direct {v0, v1, p1}, Ll85$a;-><init>(Landroid/content/Context;Landroid/view/ActionMode$Callback;)V

    iget-object p1, p0, Landroidx/appcompat/app/AppCompatDelegateImpl$p;->c:Landroidx/appcompat/app/AppCompatDelegateImpl;

    invoke-virtual {p1, v0}, Landroidx/appcompat/app/AppCompatDelegateImpl;->N(Lo2$a;)Lo2;

    move-result-object p1

    if-eqz p1, :cond_0

    invoke-virtual {v0, p1}, Ll85$a;->e(Lo2;)Landroid/view/ActionMode;
...
.method public dispatchKeyEvent(Landroid/view/KeyEvent;)Z
    ...
    invoke-virtual {v0, p1}, Landroidx/appcompat/app/AppCompatDelegateImpl;->a0(Landroid/view/KeyEvent;)Z

    move-result v0

    if-nez v0, :cond_1

    invoke-super {p0, p1}, LRI5;->dispatchKeyEvent(Landroid/view/KeyEvent;)Z
...
.method public dispatchKeyShortcutEvent(Landroid/view/KeyEvent;)Z
    ...
    invoke-super {p0, p1}, LRI5;->dispatchKeyShortcutEvent(Landroid/view/KeyEvent;)Z
    ...
    invoke-virtual {v0, v1, p1}, Landroidx/appcompat/app/AppCompatDelegateImpl;->y0(ILandroid/view/KeyEvent;)Z
...
.method public onCreatePanelMenu(ILandroid/view/Menu;)Z
    ...
    :cond_0
    invoke-super {p0, p1, p2}, LRI5;->onCreatePanelMenu(ILandroid/view/Menu;)Z
...
.method public onCreatePanelView(I)Landroid/view/View;
    ...
    :cond_0
    invoke-super {p0, p1}, LRI5;->onCreatePanelView(I)Landroid/view/View;
...
.method public onMenuOpened(ILandroid/view/Menu;)Z
    ...
    invoke-super {p0, p1, p2}, LRI5;->onMenuOpened(ILandroid/view/Menu;)Z
...
.method public onPanelClosed(ILandroid/view/Menu;)V
    ...
    invoke-super {p0, p1, p2}, LRI5;->onPanelClosed(ILandroid/view/Menu;)V

    iget-object p2, p0, Landroidx/appcompat/app/AppCompatDelegateImpl$p;->c:Landroidx/appcompat/app/AppCompatDelegateImpl;

    invoke-virtual {p2, p1}, Landroidx/appcompat/app/AppCompatDelegateImpl;->C0(I)V
...
.method public onPreparePanel(ILandroid/view/View;Landroid/view/Menu;)Z
    ...
    invoke-super {p0, p1, p2, p3}, LRI5;->onPreparePanel(ILandroid/view/View;Landroid/view/Menu;)Z
...
.method public onProvideKeyboardShortcuts(Ljava/util/List;Landroid/view/Menu;I)V
    ...
    invoke-super {p0, p1, v0, p3}, LRI5;->onProvideKeyboardShortcuts(Ljava/util/List;Landroid/view/Menu;I)V

    goto :goto_0

    :cond_0
    invoke-super {p0, p1, p2, p3}, LRI5;->onProvideKeyboardShortcuts(Ljava/util/List;Landroid/view/Menu;I)V
...
.method public onWindowStartingActionMode(Landroid/view/ActionMode$Callback;)Landroid/view/ActionMode;
    ...
    :cond_1
    invoke-super {p0, p1}, LRI5;->onWindowStartingActionMode(Landroid/view/ActionMode$Callback;)Landroid/view/ActionMode;
...
.method public onWindowStartingActionMode(Landroid/view/ActionMode$Callback;I)Landroid/view/ActionMode;
    ...
    :cond_1
    :goto_0
    invoke-super {p0, p1, p2}, LRI5;->onWindowStartingActionMode(Landroid/view/ActionMode$Callback;I)Landroid/view/ActionMode;
