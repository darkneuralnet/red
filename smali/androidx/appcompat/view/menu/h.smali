...
.method public final a()LXj2;
    ...
    sget v2, LRz3;->abc_cascading_menus_min_smallest_width:I
    ...
    invoke-virtual {v0, v1}, LXj2;->n(Landroidx/appcompat/view/menu/e;)V

    iget-object v1, p0, Landroidx/appcompat/view/menu/h;->l:Landroid/widget/PopupWindow$OnDismissListener;

    invoke-virtual {v0, v1}, LXj2;->w(Landroid/widget/PopupWindow$OnDismissListener;)V

    iget-object v1, p0, Landroidx/appcompat/view/menu/h;->f:Landroid/view/View;

    invoke-virtual {v0, v1}, LXj2;->r(Landroid/view/View;)V
    ...
    invoke-virtual {v0, v1}, LXj2;->t(Z)V

    iget v1, p0, Landroidx/appcompat/view/menu/h;->g:I

    invoke-virtual {v0, v1}, LXj2;->u(I)V
...
.method public b()V
    ...
    iget-object v0, p0, Landroidx/appcompat/view/menu/h;->j:LXj2;
...
.method public c()LXj2;
    ...
    invoke-virtual {p0}, Landroidx/appcompat/view/menu/h;->a()LXj2;

    move-result-object v0

    iput-object v0, p0, Landroidx/appcompat/view/menu/h;->j:LXj2;
...
.method public g(Z)V
    ...
    invoke-virtual {v0, p1}, LXj2;->t(Z)V
...
.method public j(Landroidx/appcompat/view/menu/i$a;)V
    ...
    invoke-interface {v0, p1}, Landroidx/appcompat/view/menu/i;->j(Landroidx/appcompat/view/menu/i$a;)V
...
.method public final l(IIZZ)V
    ...
    invoke-virtual {p0}, Landroidx/appcompat/view/menu/h;->c()LXj2;

    move-result-object v0

    invoke-virtual {v0, p4}, LXj2;->x(Z)V
    ...
    invoke-static {p4}, LyA5;->G(Landroid/view/View;)I

    move-result p4

    invoke-static {p3, p4}, LCk1;->b(II)I
    ...
    :cond_0
    invoke-virtual {v0, p1}, LXj2;->v(I)V

    invoke-virtual {v0, p2}, LXj2;->y(I)V
    ...
    invoke-virtual {v0, p4}, LXj2;->s(Landroid/graphics/Rect;)V

    :cond_1
    invoke-interface {v0}, LhQ4;->b()V
