...
.method public constructor <init>(Landroid/content/Context;ILandroidx/work/impl/background/systemalarm/d;)V
    ...
    invoke-virtual {p3}, Landroidx/work/impl/background/systemalarm/d;->f()LFb5;
    ...
    invoke-direct {p3, p1, p2, v0}, LmJ5;-><init>(Landroid/content/Context;LFb5;LlJ5;)V

    iput-object p3, p0, Landroidx/work/impl/background/systemalarm/b;->d:LmJ5;
...
.method public a()V
    ...
    invoke-interface {v0}, LQM5;->i()Ljava/util/List;
    ...
    iget-object v1, p0, Landroidx/work/impl/background/systemalarm/b;->d:LmJ5;
    ...
    iget-object v5, v4, LPM5;->a:Ljava/lang/String;

    invoke-virtual {v4}, LPM5;->a()J
    ...
    invoke-virtual {v4}, LPM5;->b()Z

    move-result v6

    if-eqz v6, :cond_1

    iget-object v6, p0, Landroidx/work/impl/background/systemalarm/b;->d:LmJ5;

    invoke-virtual {v6, v5}, LmJ5;->c(Ljava/lang/String;)Z
    ...
    iget-object v1, v1, LPM5;->a:Ljava/lang/String;
    ...
    invoke-virtual {v3, v4, v1, v5}, LY12;->a(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Throwable;)V
    ...
    :cond_3
    iget-object v0, p0, Landroidx/work/impl/background/systemalarm/b;->d:LmJ5;

    invoke-virtual {v0}, LmJ5;->e()V
