...
.field public static final V4:Landroid/util/Property;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Landroid/util/Property<",
            "Landroidx/transition/ChangeBounds$k;",
...
.field public static final X4:Landroid/util/Property;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Landroid/util/Property<",
            "Landroid/view/View;",
...
.field public static final Y4:Landroid/util/Property;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Landroid/util/Property<",
            "Landroid/view/View;",
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/transition/ChangeBounds;->S4:[Ljava/lang/String;
    ...
    sput-object v0, Landroidx/transition/ChangeBounds;->T4:Landroid/util/Property;
    ...
    sput-object v0, Landroidx/transition/ChangeBounds;->U4:Landroid/util/Property;
    ...
    sput-object v0, Landroidx/transition/ChangeBounds;->V4:Landroid/util/Property;
    ...
    sput-object v0, Landroidx/transition/ChangeBounds;->W4:Landroid/util/Property;
    ...
    sput-object v0, Landroidx/transition/ChangeBounds;->X4:Landroid/util/Property;
    ...
    sput-object v0, Landroidx/transition/ChangeBounds;->Y4:Landroid/util/Property;

    new-instance v0, LOM3;

    invoke-direct {v0}, LOM3;-><init>()V

    sput-object v0, Landroidx/transition/ChangeBounds;->Z4:LOM3;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroidx/transition/ChangeBounds;->P4:[I

    const/4 v0, 0x0

    iput-boolean v0, p0, Landroidx/transition/ChangeBounds;->Q4:Z

    iput-boolean v0, p0, Landroidx/transition/ChangeBounds;->R4:Z
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-virtual {p0, p2}, Landroidx/transition/ChangeBounds;->A0(Z)V
...
.method public A0(Z)V
    ...
    iput-boolean p1, p0, Landroidx/transition/ChangeBounds;->Q4:Z
...
.method public M()[Ljava/lang/String;
    ...
    sget-object v0, Landroidx/transition/ChangeBounds;->S4:[Ljava/lang/String;
...
.method public g(LKm5;)V
    ...
    invoke-virtual {p0, p1}, Landroidx/transition/ChangeBounds;->x0(LKm5;)V
...
.method public r(Landroid/view/ViewGroup;LKm5;LKm5;)Landroid/animation/Animator;
    ...
    :cond_0
    iget-object v3, v0, LKm5;->a:Ljava/util/Map;

    iget-object v4, v1, LKm5;->a:Ljava/util/Map;
    ...
    :cond_1
    iget-object v9, v1, LKm5;->b:Landroid/view/View;

    invoke-virtual {v8, v3, v4}, Landroidx/transition/ChangeBounds;->z0(Landroid/view/View;Landroid/view/View;)Z
    ...
    iget-object v6, v1, LKm5;->a:Ljava/util/Map;
    ...
    iget-object v0, v0, LKm5;->a:Ljava/util/Map;
    ...
    iget-object v1, v1, LKm5;->a:Ljava/util/Map;
    ...
    iget-boolean v9, v8, Landroidx/transition/ChangeBounds;->Q4:Z
    ...
    invoke-static {v9, v6, v11, v13, v3}, LlD5;->g(Landroid/view/View;IIII)V
    ...
    sget-object v1, Landroidx/transition/ChangeBounds;->Y4:Landroid/util/Property;

    invoke-static {v9, v1, v0}, LcD2;->a(Ljava/lang/Object;Landroid/util/Property;Landroid/graphics/Path;)Landroid/animation/ObjectAnimator;
    ...
    sget-object v4, Landroidx/transition/ChangeBounds;->U4:Landroid/util/Property;

    invoke-static {v1, v4, v2}, LcD2;->a(Ljava/lang/Object;Landroid/util/Property;Landroid/graphics/Path;)Landroid/animation/ObjectAnimator;
    ...
    sget-object v4, Landroidx/transition/ChangeBounds;->V4:Landroid/util/Property;

    invoke-static {v1, v4, v3}, LcD2;->a(Ljava/lang/Object;Landroid/util/Property;Landroid/graphics/Path;)Landroid/animation/ObjectAnimator;
    ...
    sget-object v1, Landroidx/transition/ChangeBounds;->W4:Landroid/util/Property;
    ...
    sget-object v1, Landroidx/transition/ChangeBounds;->X4:Landroid/util/Property;
    ...
    invoke-static {v9, v6, v11, v1, v3}, LlD5;->g(Landroid/view/View;IIII)V
    ...
    sget-object v3, Landroidx/transition/ChangeBounds;->Y4:Landroid/util/Property;

    invoke-static {v9, v3, v1}, LcD2;->a(Ljava/lang/Object;Landroid/util/Property;Landroid/graphics/Path;)Landroid/animation/ObjectAnimator;
    ...
    invoke-static {v9, v1}, LyA5;->G0(Landroid/view/View;Landroid/graphics/Rect;)V

    sget-object v4, Landroidx/transition/ChangeBounds;->Z4:LOM3;
    ...
    :goto_8
    invoke-static {v11, v2}, Landroidx/transition/e;->c(Landroid/animation/Animator;Landroid/animation/Animator;)Landroid/animation/Animator;
    ...
    invoke-static {v1, v2}, LYA5;->d(Landroid/view/ViewGroup;Z)V
    ...
    :cond_17
    iget-object v2, v0, LKm5;->a:Ljava/util/Map;
    ...
    iget-object v5, v1, LKm5;->a:Ljava/util/Map;
    ...
    :cond_19
    :goto_a
    iget-object v4, v8, Landroidx/transition/ChangeBounds;->P4:[I
    ...
    invoke-static {v9}, LlD5;->c(Landroid/view/View;)F

    move-result v7

    const/4 v4, 0x0

    invoke-static {v9, v4}, LlD5;->h(Landroid/view/View;F)V

    invoke-static/range {p1 .. p1}, LlD5;->b(Landroid/view/View;)LUB5;

    move-result-object v4

    invoke-interface {v4, v6}, LUB5;->b(Landroid/graphics/drawable/Drawable;)V

    invoke-virtual/range {p0 .. p0}, Landroidx/transition/Transition;->C()Landroidx/transition/PathMotion;

    move-result-object v4

    iget-object v10, v8, Landroidx/transition/ChangeBounds;->P4:[I
    ...
    sget-object v1, Landroidx/transition/ChangeBounds;->T4:Landroid/util/Property;

    invoke-static {v1, v0}, LPt3;->a(Landroid/util/Property;Landroid/graphics/Path;)Landroid/animation/PropertyValuesHolder;
...
.method public final x0(LKm5;)V
    ...
    iget-boolean v1, p0, Landroidx/transition/ChangeBounds;->R4:Z

    if-eqz v1, :cond_1

    iget-object v1, p1, LKm5;->b:Landroid/view/View;

    iget-object v2, p0, Landroidx/transition/ChangeBounds;->P4:[I
    ...
    :cond_1
    iget-boolean v1, p0, Landroidx/transition/ChangeBounds;->Q4:Z
...
.method public final z0(Landroid/view/View;Landroid/view/View;)Z
    ...
    iget-boolean v0, p0, Landroidx/transition/ChangeBounds;->R4:Z
    ...
    :cond_1
    iget-object p1, v0, LKm5;->b:Landroid/view/View;
