...
.method public final a()V
    ...
    invoke-virtual {v2, v3}, Landroidx/constraintlayout/widget/ConstraintHelper;->w(Landroidx/constraintlayout/widget/ConstraintLayout;)V
...
.method public final b(LEo0;LPz$a;)V
    .locals 17
    ...
    :cond_0
    invoke-virtual/range {p1 .. p1}, LEo0;->T()I
    ...
    invoke-virtual/range {p1 .. p1}, LEo0;->d0()Z

    move-result v3

    if-nez v3, :cond_1

    iput v5, v2, LPz$a;->e:I

    iput v5, v2, LPz$a;->f:I

    iput v5, v2, LPz$a;->g:I

    return-void

    :cond_1
    invoke-virtual/range {p1 .. p1}, LEo0;->L()LEo0;
    ...
    :cond_2
    iget-object v3, v2, LPz$a;->a:LEo0$b;

    iget-object v4, v2, LPz$a;->b:LEo0$b;

    iget v6, v2, LPz$a;->c:I

    iget v7, v2, LPz$a;->d:I
    ...
    invoke-virtual/range {p1 .. p1}, LEo0;->t()Ljava/lang/Object;
    ...
    invoke-virtual/range {p1 .. p1}, LEo0;->h0()Z
    ...
    invoke-virtual/range {p1 .. p1}, LEo0;->C()I
    ...
    invoke-virtual/range {p1 .. p1}, LEo0;->i0()Z
    ...
    invoke-virtual/range {p1 .. p1}, LEo0;->S()I
    ...
    invoke-static {v9, v11}, LoY2;->b(II)Z
    ...
    invoke-virtual/range {p1 .. p1}, LEo0;->q()I

    move-result v9

    if-ne v8, v9, :cond_1a

    invoke-virtual/range {p1 .. p1}, LEo0;->g0()Z

    move-result v8

    if-nez v8, :cond_1a

    invoke-virtual/range {p1 .. p1}, LEo0;->D()I
    ...
    invoke-virtual/range {p1 .. p1}, LEo0;->E()I
    ...
    iput v3, v2, LPz$a;->e:I

    invoke-virtual/range {p1 .. p1}, LEo0;->y()I

    move-result v3

    iput v3, v2, LPz$a;->f:I

    invoke-virtual/range {p1 .. p1}, LEo0;->q()I

    move-result v1

    iput v1, v2, LPz$a;->g:I
    ...
    :goto_c
    sget-object v11, LEo0$b;->d:LEo0$b;

    if-eq v4, v11, :cond_1e

    sget-object v12, LEo0$b;->a:LEo0$b;
    ...
    invoke-virtual {v9, v8, v6, v7}, Landroidx/constraintlayout/widget/VirtualLayout;->B(LED5;II)V
    ...
    :goto_14
    invoke-virtual {v1, v6, v7}, LEo0;->J0(II)V
    ...
    invoke-static {v6, v0}, LoY2;->b(II)Z
    ...
    :goto_1c
    iget v3, v2, LPz$a;->c:I

    if-ne v15, v3, :cond_33

    iget v3, v2, LPz$a;->d:I
    ...
    iput-boolean v1, v2, LPz$a;->i:Z

    :cond_35
    iput v15, v2, LPz$a;->e:I

    iput v5, v2, LPz$a;->f:I

    iput-boolean v0, v2, LPz$a;->h:Z

    iput v14, v2, LPz$a;->g:I
