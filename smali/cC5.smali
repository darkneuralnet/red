...
.method public static a(Landroid/graphics/Rect;ZLandroid/util/Rational;IIILjava/util/Map;)Ljava/util/Map;
    ...
    check-cast p6, Landroidx/camera/core/r;
    ...
    invoke-static/range {v2 .. v7}, LcC5;->g(Landroid/graphics/RectF;Landroid/util/Rational;IZII)Landroid/graphics/RectF;
    ...
    check-cast p5, Landroidx/camera/core/r;
...
.method public static b(ZILandroid/graphics/RectF;Landroid/graphics/RectF;)Landroid/graphics/RectF;
    ...
    invoke-static {p3, p0}, LcC5;->d(Landroid/graphics/RectF;F)Landroid/graphics/RectF;
    ...
    invoke-static {p0, p1}, LcC5;->c(Landroid/graphics/RectF;F)Landroid/graphics/RectF;
    ...
    invoke-static {p3, p0}, LcC5;->c(Landroid/graphics/RectF;F)Landroid/graphics/RectF;
...
.method public static c(Landroid/graphics/RectF;F)Landroid/graphics/RectF;
    ...
    invoke-static {v1, p1}, LcC5;->e(FF)F
    ...
    invoke-static {v3, p1}, LcC5;->e(FF)F
...
.method public static d(Landroid/graphics/RectF;F)Landroid/graphics/RectF;
    ...
    invoke-static {v2, p1}, LcC5;->f(FF)F
    ...
    invoke-static {p0, p1}, LcC5;->f(FF)F
...
.method public static g(Landroid/graphics/RectF;Landroid/util/Rational;IZII)Landroid/graphics/RectF;
    ...
    invoke-static {p3, p4}, LcC5;->h(ZI)Z

    move-result p2

    invoke-static {p2, p5, p0, p1}, LcC5;->b(ZILandroid/graphics/RectF;Landroid/graphics/RectF;)Landroid/graphics/RectF;
