...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/Object;)V
    ...
    iput-object p1, p0, Ls30;->a:Landroid/hardware/camera2/CameraManager;
...
.method public static f(Landroid/content/Context;Landroid/os/Handler;)Ls30;
    .locals 2
    ...
    invoke-direct {v1, p1}, Ls30$a;-><init>(Landroid/os/Handler;)V

    invoke-direct {v0, p0, v1}, Ls30;-><init>(Landroid/content/Context;Ljava/lang/Object;)V
...
.method public a(Ljava/util/concurrent/Executor;Landroid/hardware/camera2/CameraManager$AvailabilityCallback;)V
    ...
    iget-object v2, v1, Ls30$a;->a:Ljava/util/Map;

    monitor-enter v2

    :try_start_0
    iget-object v0, v1, Ls30$a;->a:Ljava/util/Map;
    ...
    invoke-direct {v0, p1, p2}, Lo30$a;-><init>(Ljava/util/concurrent/Executor;Landroid/hardware/camera2/CameraManager$AvailabilityCallback;)V

    iget-object p1, v1, Ls30$a;->a:Ljava/util/Map;
    ...
    :cond_1
    :goto_0
    iget-object p1, p0, Ls30;->a:Landroid/hardware/camera2/CameraManager;

    iget-object p2, v1, Ls30$a;->b:Landroid/os/Handler;
...
.method public b(Ljava/lang/String;Ljava/util/concurrent/Executor;Landroid/hardware/camera2/CameraDevice$StateCallback;)V
    ...
    invoke-direct {v0, p2, p3}, LK20$b;-><init>(Ljava/util/concurrent/Executor;Landroid/hardware/camera2/CameraDevice$StateCallback;)V

    iget-object p2, p0, Ls30;->b:Ljava/lang/Object;

    check-cast p2, Ls30$a;

    :try_start_0
    iget-object p3, p0, Ls30;->a:Landroid/hardware/camera2/CameraManager;

    iget-object p2, p2, Ls30$a;->b:Landroid/os/Handler;
...
.method public c(Ljava/lang/String;)Landroid/hardware/camera2/CameraCharacteristics;
    ...
    :try_start_0
    iget-object v0, p0, Ls30;->a:Landroid/hardware/camera2/CameraManager;
...
.method public e(Landroid/hardware/camera2/CameraManager$AvailabilityCallback;)V
    ...
    iget-object v1, v0, Ls30$a;->a:Ljava/util/Map;

    monitor-enter v1

    :try_start_0
    iget-object v0, v0, Ls30$a;->a:Ljava/util/Map;
