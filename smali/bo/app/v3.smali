...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lbo/app/v3;->f:Ljava/lang/String;

    return-void
.end method

.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;Lbo/app/q1;)V
    .locals 2
    ...
    iput-object v0, p0, Lbo/app/v3;->d:Lbo/app/c;
    ...
    iput-object p3, p0, Lbo/app/v3;->e:Lbo/app/q1;
    ...
    sget-object p1, Lbo/app/v3$a;->d:Lbo/app/v3$a;

    invoke-virtual {p0, p1}, Lbo/app/v3;->a(Lbo/app/v3$a;)Ljava/util/Set;

    move-result-object p1

    iput-object p1, p0, Lbo/app/v3;->b:Ljava/util/Set;

    sget-object p1, Lbo/app/v3$a;->c:Lbo/app/v3$a;

    invoke-virtual {p0, p1}, Lbo/app/v3;->a(Lbo/app/v3$a;)Ljava/util/Set;

    move-result-object p1

    iput-object p1, p0, Lbo/app/v3;->c:Ljava/util/Set;

    invoke-virtual {p0, p2}, Lbo/app/v3;->a(Ljava/lang/String;)V
...
.method public a()Lcom/appboy/events/FeedUpdatedEvent;
    ...
    invoke-virtual/range {v3 .. v8}, Lbo/app/v3;->a(Lorg/json/JSONArray;Ljava/lang/String;ZJ)Lcom/appboy/events/FeedUpdatedEvent;
...
.method public a(Lorg/json/JSONArray;Ljava/lang/String;)Lcom/appboy/events/FeedUpdatedEvent;
    ...
    sget-object v0, Lbo/app/v3;->f:Ljava/lang/String;
    ...
    invoke-virtual {p0, p1, v6, v7}, Lbo/app/v3;->a(Lorg/json/JSONArray;J)V

    iget-object v0, p0, Lbo/app/v3;->b:Ljava/util/Set;

    invoke-static {p1}, Lbo/app/v3;->a(Lorg/json/JSONArray;)Ljava/util/Set;
    ...
    sget-object v1, Lbo/app/v3$a;->d:Lbo/app/v3$a;

    invoke-virtual {p0, v0, v1}, Lbo/app/v3;->a(Ljava/util/Set;Lbo/app/v3$a;)V

    iget-object v0, p0, Lbo/app/v3;->c:Ljava/util/Set;
    ...
    sget-object v1, Lbo/app/v3$a;->c:Lbo/app/v3$a;
    ...
    invoke-virtual/range {v2 .. v7}, Lbo/app/v3;->a(Lorg/json/JSONArray;Ljava/lang/String;ZJ)Lcom/appboy/events/FeedUpdatedEvent;
    ...
    :cond_1
    sget-object p1, Lbo/app/v3;->f:Ljava/lang/String;
...
.method public final a(Lorg/json/JSONArray;Ljava/lang/String;ZJ)Lcom/appboy/events/FeedUpdatedEvent;
    ...
    iget-object v1, p0, Lbo/app/v3;->e:Lbo/app/q1;

    iget-object v2, p0, Lbo/app/v3;->d:Lbo/app/c;

    invoke-static {p1, v0, v1, p0, v2}, Lbo/app/a2;->a(Lorg/json/JSONArray;Lcom/appboy/enums/CardKey$Provider;Lbo/app/q1;Lcom/appboy/storage/ICardStorageProvider;Lbo/app/c;)Ljava/util/List;
    ...
    iget-object v2, p0, Lbo/app/v3;->b:Ljava/util/Set;
    ...
    :cond_3
    iget-object v2, p0, Lbo/app/v3;->c:Ljava/util/Set;
...
.method public final a(Lbo/app/v3$a;)Ljava/util/Set;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p1}, Lbo/app/v3$a;->a()Ljava/lang/String;
    ...
    invoke-static {v1}, Lbo/app/v3;->b(Ljava/lang/String;)Ljava/util/Set;
    ...
    invoke-virtual {p0, v1, p1}, Lbo/app/v3;->a(Ljava/util/Set;Lbo/app/v3$a;)V

    return-object v1

    :cond_0
    invoke-virtual {p1}, Lbo/app/v3$a;->b()Ljava/lang/String;
...
.method public a(Ljava/util/Set;Lbo/app/v3$a;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p2}, Lbo/app/v3$a;->b()Ljava/lang/String;
...
.method public bridge synthetic getCachedCardsAsEvent()Ljava/lang/Object;
    ...
    invoke-virtual {p0}, Lbo/app/v3;->a()Lcom/appboy/events/FeedUpdatedEvent;
...
.method public markCardAsViewed(Ljava/lang/String;)V
    ...
    iget-object p1, p0, Lbo/app/v3;->b:Ljava/util/Set;

    sget-object v0, Lbo/app/v3$a;->d:Lbo/app/v3$a;

    invoke-virtual {p0, p1, v0}, Lbo/app/v3;->a(Ljava/util/Set;Lbo/app/v3$a;)V
...
.method public markCardAsVisuallyRead(Ljava/lang/String;)V
    ...
    iget-object p1, p0, Lbo/app/v3;->c:Ljava/util/Set;

    sget-object v0, Lbo/app/v3$a;->c:Lbo/app/v3$a;
