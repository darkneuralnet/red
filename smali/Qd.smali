...
.field public static final h:LwQ4;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "LwQ4<",
            "Ljava/lang/String;",
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, LQd;->b:[Ljava/lang/Class;
    ...
    sput-object v0, LQd;->g:[Ljava/lang/String;

    new-instance v0, LwQ4;

    invoke-direct {v0}, LwQ4;-><init>()V

    sput-object v0, LQd;->h:LwQ4;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, LQd;->a:[Ljava/lang/Object;
...
.method public static u(Landroid/content/Context;Landroid/util/AttributeSet;ZZ)Landroid/content/Context;
    ...
    sget p2, LDF3;->View_android_theme:I
    ...
    invoke-direct {p1, p0, p2}, LWp0;-><init>(Landroid/content/Context;I)V
...
.method public final a(Landroid/content/Context;Landroid/view/View;Landroid/util/AttributeSet;)V
    ...
    invoke-static {p2, v2}, LyA5;->z0(Landroid/view/View;Z)V

    :cond_1
    invoke-virtual {v0}, Landroid/content/res/TypedArray;->recycle()V

    sget-object v0, LQd;->e:[I
    ...
    invoke-static {p2, v2}, LyA5;->B0(Landroid/view/View;Ljava/lang/CharSequence;)V

    :cond_2
    invoke-virtual {v0}, Landroid/content/res/TypedArray;->recycle()V

    sget-object v0, LQd;->f:[I
    ...
    invoke-static {p2, p3}, LyA5;->X0(Landroid/view/View;Z)V
...
.method public final b(Landroid/view/View;Landroid/util/AttributeSet;)V
    ...
    invoke-static {p1}, LyA5;->W(Landroid/view/View;)Z
    ...
    invoke-direct {v1, p1, v0}, LQd$a;-><init>(Landroid/view/View;Ljava/lang/String;)V
...
.method public final r(Landroid/view/View;Ljava/lang/String;Landroid/content/Context;Landroid/util/AttributeSet;ZZZZ)Landroid/view/View;
    ...
    :cond_1
    invoke-static {p1, p4, p6, p7}, LQd;->u(Landroid/content/Context;Landroid/util/AttributeSet;ZZ)Landroid/content/Context;
    ...
    invoke-virtual {p0, p1, p2, p4}, LQd;->q(Landroid/content/Context;Ljava/lang/String;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    :pswitch_0
    invoke-virtual {p0, p1, p4}, LQd;->d(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatButton;

    move-result-object p5

    invoke-virtual {p0, p5, p2}, LQd;->v(Landroid/view/View;Ljava/lang/String;)V

    goto/16 :goto_2

    :pswitch_1
    invoke-virtual {p0, p1, p4}, LQd;->g(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatEditText;
    ...
    :pswitch_2
    invoke-virtual {p0, p1, p4}, LQd;->e(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatCheckBox;
    ...
    :pswitch_3
    invoke-virtual {p0, p1, p4}, LQd;->c(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatAutoCompleteTextView;
    ...
    :pswitch_4
    invoke-virtual {p0, p1, p4}, LQd;->i(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatImageView;
    ...
    :pswitch_5
    invoke-virtual {p0, p1, p4}, LQd;->p(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatToggleButton;
    ...
    :pswitch_6
    invoke-virtual {p0, p1, p4}, LQd;->k(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatRadioButton;
    ...
    :pswitch_7
    invoke-virtual {p0, p1, p4}, LQd;->n(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatSpinner;
    ...
    :pswitch_8
    invoke-virtual {p0, p1, p4}, LQd;->m(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatSeekBar;
    ...
    :pswitch_9
    invoke-virtual {p0, p1, p4}, LQd;->h(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatImageButton;
    ...
    :pswitch_a
    invoke-virtual {p0, p1, p4}, LQd;->o(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatTextView;
    ...
    :pswitch_b
    invoke-virtual {p0, p1, p4}, LQd;->j(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatMultiAutoCompleteTextView;
    ...
    :pswitch_c
    invoke-virtual {p0, p1, p4}, LQd;->f(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatCheckedTextView;
    ...
    :pswitch_d
    invoke-virtual {p0, p1, p4}, LQd;->l(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatRatingBar;
    ...
    invoke-virtual {p0, p1, p2, p4}, LQd;->t(Landroid/content/Context;Ljava/lang/String;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    invoke-virtual {p0, p5, p4}, LQd;->b(Landroid/view/View;Landroid/util/AttributeSet;)V

    invoke-virtual {p0, p1, p5, p4}, LQd;->a(Landroid/content/Context;Landroid/view/View;Landroid/util/AttributeSet;)V
...
.method public final s(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Landroid/view/View;
    ...
    sget-object v0, LQd;->h:LwQ4;

    invoke-virtual {v0, p2}, LwQ4;->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    sget-object p3, LQd;->b:[Ljava/lang/Class;

    invoke-virtual {p1, p3}, Ljava/lang/Class;->getConstructor([Ljava/lang/Class;)Ljava/lang/reflect/Constructor;

    move-result-object v1

    invoke-virtual {v0, p2, v1}, LwQ4;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object p1, p0, LQd;->a:[Ljava/lang/Object;
...
.method public final t(Landroid/content/Context;Ljava/lang/String;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    :try_start_0
    iget-object v3, p0, LQd;->a:[Ljava/lang/Object;
    ...
    :goto_0
    sget-object v3, LQd;->g:[Ljava/lang/String;
    ...
    invoke-virtual {p0, p1, p2, v3}, LQd;->s(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Landroid/view/View;
    ...
    :cond_3
    :try_start_1
    invoke-virtual {p0, p1, p2, v1}, LQd;->s(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Landroid/view/View;
    ...
    iget-object p2, p0, LQd;->a:[Ljava/lang/Object;
