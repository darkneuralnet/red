...
.method public constructor <init>(Lir4;)V
    ...
    iput-object p1, p0, LUM5;->a:Lir4;

    new-instance v0, LUM5$a;

    invoke-direct {v0, p0, p1}, LUM5$a;-><init>(LUM5;Lir4;)V

    iput-object v0, p0, LUM5;->b:LBV0;
...
# virtual methods
.method public a(LSM5;)V
    .locals 1

    iget-object v0, p0, LUM5;->a:Lir4;
    ...
    :try_start_0
    iget-object v0, p0, LUM5;->b:LBV0;

    invoke-virtual {v0, p1}, LBV0;->i(Ljava/lang/Object;)V

    iget-object p1, p0, LUM5;->a:Lir4;
