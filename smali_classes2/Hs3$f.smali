...
.method public b(Ld6;)Ljava/lang/String;
    ...
    sget v1, LdD3;->item_promo_center_header:I
    ...
    :cond_3
    sget v1, LdD3;->item_promo_center_coupon:I
    ...
    :cond_5
    invoke-virtual {v2}, Lco/bird/android/model/wire/WireCouponDisplayView;->getCouponId()Ljava/lang/String;
    ...
    :cond_6
    sget p1, LdD3;->item_promo_center_add_code:I

    if-ne v0, p1, :cond_7

    const-string v3, "add_code"

    goto :goto_0

    :cond_7
    sget p1, LdD3;->item_promo_center_free_ride:I

    if-ne v0, p1, :cond_8

    const-string v3, "free_ride"
