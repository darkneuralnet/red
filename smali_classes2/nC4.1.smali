...
.method public b(Ld6;)Ljava/lang/String;
    ...
    sget v1, LiD3;->item_scrap_header:I
    ...
    :cond_2
    sget v1, LiD3;->item_scrap_reason:I
    ...
    :cond_4
    invoke-virtual {v2}, LPE4;->d()Lco/bird/android/model/constant/ScrapRequestReason;
    ...
    :cond_7
    sget p1, LiD3;->item_scrap_image_upload_bar:I
    ...
    :cond_8
    sget p1, LiD3;->item_scrap_details:I
