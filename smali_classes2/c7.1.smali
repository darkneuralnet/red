...
.method public b(Ld6;)Ljava/lang/String;
    ...
    :cond_0
    check-cast v2, Lco/bird/android/model/wire/WireBatch;
    ...
    :cond_1
    invoke-virtual {v2}, Lco/bird/android/model/wire/WireBatch;->getId()Ljava/lang/String;
    ...
    const-string v3, "Create New Batch"

    goto :goto_0

    :cond_4
    sget v1, LjD3;->item_header:I
    ...
    :cond_7
    sget p1, LED3;->view_button_red:I
